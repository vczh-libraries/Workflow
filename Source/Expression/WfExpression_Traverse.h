...
namespace vl
{
	namespace workflow
	{
		...
		{
			/// <summary>A copy visitor, overriding all abstract methods with AST traversing code that looks into child nodes.</summary>
			...
			/// <summary>A copy visitor for the root node, overriding all abstract methods with AST traversing code that looks into child nodes.</summary>
			class ModuleVisitor
				: public TypeVisitor
