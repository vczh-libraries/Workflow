...
***********************************************************************/
	...
	::vl::vint __vwsnc5_Rpc_CollectionOblist_Interface_Nested_InByref_OutByref_rpcwrapper_RpcCollectionOblist__Interface__Nested__InByref__OutByref__IValue__RpcCollectionOblist_Interface_Nested_InByref_OutByref_IRpcWrapper_IValue::GetValue()
	{
		...
		return ::vl::__vwsn::Unbox<::vl::vint>(::vl::__vwsn::This(::vl::__vwsn::This(::vl::__vwsn::This(_lc)->GetDispatcher())->SendToClient_ObjectOps(_ref.clientId))->InvokeMethod(_ref, GLOBAL_NAME rpcmethod_RpcCollectionOblist__Interface__Nested__InByref__OutByref__IValue_GetValue, arguments));
	}
	...
	::vl::Ptr<::vl::reflection::description::IValueDictionary> __vwsnc6_Rpc_CollectionOblist_Interface_Nested_InByref_OutByref_rpcwrapper_RpcCollectionOblist__Interface__Nested__InByref__OutByref__IService__RpcCollectionOblist_Interface_Nested_InByref_OutByref_IRpcWrapper_IService::DoList(::vl::Ptr<::vl::reflection::description::IValueDictionary> xs)
	{
		...
		::vl::__vwsn::This(arguments.Obj())->Set(static_cast<::vl::vint>(0), ::vl::__vwsn::Box(::vl::rpc_controller::RpcBoxByref(::vl::Ptr<::vl::reflection::IDescriptable>(xs), _lc)));
