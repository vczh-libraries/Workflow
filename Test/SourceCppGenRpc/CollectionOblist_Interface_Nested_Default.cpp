...
***********************************************************************/
	...
	::vl::vint __vwsnc5_Rpc_CollectionOblist_Interface_Nested_Default_rpcwrapper_RpcCollectionOblist__Interface__Nested__Default__IValue__RpcCollectionOblist_Interface_Nested_Default_IRpcWrapper_IValue::GetValue()
	{
		...
		return ::vl::__vwsn::Unbox<::vl::vint>(::vl::__vwsn::This(::vl::__vwsn::This(::vl::__vwsn::This(_lc)->GetDispatcher())->SendToClient_ObjectOps(_ref.clientId))->InvokeMethod(_ref, GLOBAL_NAME rpcmethod_RpcCollectionOblist__Interface__Nested__Default__IValue_GetValue, arguments));
	}
