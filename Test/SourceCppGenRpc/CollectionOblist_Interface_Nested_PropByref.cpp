...
***********************************************************************/
	...
	::vl::reflection::description::Value __vwsnc5_Rpc_CollectionOblist_Interface_Nested_PropByref_rpcops_IRpcObjectOpsJson__vl_rpc_controller_IRpcObjectOps::InvokeMethod(::vl::rpc_controller::RpcObjectReference ref, ::vl::vint methodId, ::vl::Ptr<::vl::reflection::description::IValueArray> arguments)
	{
		{
	...
	void __vwsnc5_Rpc_CollectionOblist_Interface_Nested_PropByref_rpcops_IRpcObjectOpsJson__vl_rpc_controller_IRpcObjectOps::ObjectHold(::vl::rpc_controller::RpcObjectReference ref, ::vl::vint remoteClientId, bool hold)
	{
		if (hold)
		{
			::vl::__vwsn::This(_lc)->LocalObjectHold(ref, remoteClientId);
	...
	void __vwsnc5_Rpc_CollectionOblist_Interface_Nested_PropByref_rpcops_IRpcObjectOpsJson__vl_rpc_controller_IRpcObjectOps::RegisterService(::vl::vint typeId, ::vl::Ptr<::vl::reflection::IDescriptable> service)
	{
		{
			if (GLOBAL_NAME rpcwrapper_IsCtorInterfaceTypeId(typeId))
			{
	...
	void __vwsnc6_Rpc_CollectionOblist_Interface_Nested_PropByref_rpcops_IRpcObjectEventOpsJson__vl_rpc_controller_IRpcObjectEventOps::InvokeEvent(::vl::rpc_controller::RpcObjectReference ref, ::vl::vint eventId, ::vl::Ptr<::vl::reflection::description::IValueArray> arguments)
	{
		::vl::__vwsn::This(::vl::__vwsn::This(_lc)->GetController())->SetEventSuppressedFlag(ref, eventId, true);
		{
			auto __vwsnb_0 = [&]()
	...
	::vl::vint __vwsnc7_Rpc_CollectionOblist_Interface_Nested_PropByref_rpcops_IOps_Create__rpcops_IOps_Rpc_CollectionOblist_Interface_Nested_PropByref::InvokeMethod_RpcCollectionOblist__Interface__Nested__InByref__PropByref__IValue_GetValue(::vl::rpc_controller::RpcObjectReference ref)
	{
	...
	::vl::vint __vwsnc8_Rpc_CollectionOblist_Interface_Nested_PropByref_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_CollectionOblist_Interface_Nested_PropByref::InvokeMethod_RpcCollectionOblist__Interface__Nested__InByref__PropByref__IValue_GetValue(::vl::rpc_controller::RpcObjectReference ref)
	{
		auto arguments = ::vl::reflection::description::IValueArray::Create();
		::vl::__vwsn::This(arguments.Obj())->Resize(static_cast<::vl::vint>(0));
	...
	::vl::vint __vwsnc9_Rpc_CollectionOblist_Interface_Nested_PropByref_rpcwrapper_RpcCollectionOblist__Interface__Nested__InByref__PropByref__IValue__RpcCollectionOblist_Interface_Nested_InByref_PropByref_IRpcWrapper_IValue::GetValue()
	{
		if ((_lc == nullptr))
			throw ::vl::Exception(::vl::WString::Unmanaged(L"RPC wrapper has been disconnected from lifecycle."));
