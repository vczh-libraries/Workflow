...
***********************************************************************/
	...
	::vl::WString __vwsnc6_Rpc_Overloading_rpcwrapper_RpcOverloadingTest__IService__RpcOverloadingTest_IRpcWrapper_IService::ToString(::vl::Ptr<::RpcOverloadingTest::IStringRepresentable> value)
	{
		...
		auto arguments = ::vl::reflection::description::IValueArray::Create();
		::vl::__vwsn::This(arguments.Obj())->Resize(static_cast<::vl::vint>(1));
		::vl::__vwsn::This(arguments.Obj())->Set(static_cast<::vl::vint>(0), ::vl::rpc_controller::RpcBoxByval(::vl::Ptr<::vl::reflection::IDescriptable>(value), _lc));
	...
	::vl::WString __vwsnc6_Rpc_Overloading_rpcwrapper_RpcOverloadingTest__IService__RpcOverloadingTest_IRpcWrapper_IService::ToString(::vl::vint value1, bool value2, const ::vl::WString& value3, ::vl::Ptr<::RpcOverloadingTest::IStringRepresentable> value4)
	{
		...
		::vl::__vwsn::This(arguments.Obj())->Set(static_cast<::vl::vint>(0), ::vl::__vwsn::Box(value1));
		::vl::__vwsn::This(arguments.Obj())->Set(static_cast<::vl::vint>(1), ::vl::__vwsn::Box(value2));
		::vl::__vwsn::This(arguments.Obj())->Set(static_cast<::vl::vint>(2), ::vl::__vwsn::Box(value3));
		::vl::__vwsn::This(arguments.Obj())->Set(static_cast<::vl::vint>(3), ::vl::rpc_controller::RpcBoxByval(::vl::Ptr<::vl::reflection::IDescriptable>(value4), _lc));
