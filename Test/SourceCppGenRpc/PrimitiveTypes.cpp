		...
		if (static_cast<bool>(array))
		{
			auto keyword = ::vl::__vwsn::This(::vl::__vwsn::Ensure(::vl::__vwsn::SharedPtrCast<::vl::glr::json::JsonString>(::vl::__vwsn::This(array.Obj())->items[static_cast<::vl::vint>(0)].Obj())).Obj())->content.value;
			{
				...
				if ((__vwsn_switch_0 == ::vl::WString::Unmanaged(L"UInt8")))
					...
					return ::vl::__vwsn::Box(static_cast<::RpcPrimitiveTest::Season>(::vl::__vwsn::Parse<::vl::vuint64_t>(::vl::__vwsn::This(::vl::__vwsn::Ensure(::vl::__vwsn::SharedPtrCast<::vl::glr::json::JsonNumber>(::vl::__vwsn::This(array.Obj())->items[static_cast<::vl::vint>(1)].Obj())).Obj())->content.value)));
				else
		...
		if (static_cast<bool>(object))
		{
			auto keyword = ::vl::__vwsn::This(::vl::__vwsn::Ensure(::vl::__vwsn::SharedPtrCast<::vl::glr::json::JsonString>(GLOBAL_NAME rpcjson_ObjectGet(object, ::vl::WString::Unmanaged(L"$")).Obj())).Obj())->content.value;
			{
				...
				else if ((__vwsn_switch_1 == ::vl::WString::Unmanaged(L"map")))
				{
					...
					return ::vl::__vwsn::Box([&](){ ::RpcPrimitiveTest::Point __vwsn_temp__; __vwsn_temp__.x = ::vl::__vwsn::Unbox<::vl::vint>(GLOBAL_NAME rpcjson_Deserialize(GLOBAL_NAME rpcjson_ObjectGet(object, ::vl::WString::Unmanaged(L"x")))); __vwsn_temp__.y = ::vl::__vwsn::Unbox<::vl::vint>(GLOBAL_NAME rpcjson_Deserialize(GLOBAL_NAME rpcjson_ObjectGet(object, ::vl::WString::Unmanaged(L"y")))); return __vwsn_temp__; }());
