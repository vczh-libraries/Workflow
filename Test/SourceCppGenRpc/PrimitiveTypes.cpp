...
***********************************************************************/
	...
	void Rpc_PrimitiveTypes::rpcsvc_RaiseInvalidServiceTypeId(::vl::vint typeId)
	{
		{
			...
			if ((__vwsn_switch_0 == static_cast<::vl::vint>(-1)))
				...
				throw ::vl::Exception(::vl::WString::Unmanaged(L"RPC service type id is not an @rpc:Ctor interface."));
			else if ((__vwsn_switch_0 == GLOBAL_NAME rpctype_RpcPrimitiveTest__IService))
				throw ::vl::Exception(::vl::WString::Unmanaged(L"RPC service type id is not an @rpc:Ctor interface."));
			else
	...
	void Rpc_PrimitiveTypes::rpcsvc_EnsureCtorServiceTypeId(::vl::vint typeId)
	{
		{
