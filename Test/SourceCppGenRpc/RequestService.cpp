...
***********************************************************************/
	...
	void Rpc_RequestService::rpcsvc_RaiseInvalidServiceTypeId(::vl::vint typeId)
	{
		{
	...
	void Rpc_RequestService::rpcsvc_EnsureCtorServiceTypeId(::vl::vint typeId)
	{
		{
	...
	::vl::Ptr<::vl::rpc_controller::IRpcWrapperBase> Rpc_RequestService::rpcwrapper_Create(::vl::vint typeId, ::vl::rpc_controller::IRpcLifeCycle* lc)
	{
		{
