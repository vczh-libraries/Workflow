...
BEGIN_GLOBAL_STORAGE_CLASS(vl_workflow_global_Rpc_DtorList)
	...
	INITIALIZE_GLOBAL_STORAGE_CLASS
		...
		instance.rpctype_RpcDtorList__IValue = static_cast<::vl::vint>(0);
		instance.rpctype_RpcDtorList__IService = static_cast<::vl::vint>(1);
		instance.rpcmethod_RpcDtorList__IService_Set = static_cast<::vl::vint>(2);
		instance.rpcmethod_RpcDtorList__IService_Clear = static_cast<::vl::vint>(3);
		instance.rpcmethod_RpcDtorList__IService_Hold = static_cast<::vl::vint>(4);
		instance.rpcmethod_RpcDtorList__IService_Unhold = static_cast<::vl::vint>(5);
...
***********************************************************************/
	...
	::vl::Ptr<::vl::reflection::description::IValueDictionary> Rpc_DtorList::rpc_GetIds()
	{
		...
		::vl::__vwsn::This(result.Obj())->Set(::vl::__vwsn::Box(::vl::WString::Unmanaged(L"RpcDtorList::IValue")), ::vl::__vwsn::Box(static_cast<::vl::vint>(0)));
		::vl::__vwsn::This(result.Obj())->Set(::vl::__vwsn::Box(::vl::WString::Unmanaged(L"RpcDtorList::IService")), ::vl::__vwsn::Box(static_cast<::vl::vint>(1)));
		::vl::__vwsn::This(result.Obj())->Set(::vl::__vwsn::Box(::vl::WString::Unmanaged(L"RpcDtorList::IService.Set")), ::vl::__vwsn::Box(static_cast<::vl::vint>(2)));
		::vl::__vwsn::This(result.Obj())->Set(::vl::__vwsn::Box(::vl::WString::Unmanaged(L"RpcDtorList::IService.Clear")), ::vl::__vwsn::Box(static_cast<::vl::vint>(3)));
		::vl::__vwsn::This(result.Obj())->Set(::vl::__vwsn::Box(::vl::WString::Unmanaged(L"RpcDtorList::IService.Hold")), ::vl::__vwsn::Box(static_cast<::vl::vint>(4)));
		::vl::__vwsn::This(result.Obj())->Set(::vl::__vwsn::Box(::vl::WString::Unmanaged(L"RpcDtorList::IService.Unhold")), ::vl::__vwsn::Box(static_cast<::vl::vint>(5)));
		return result;
	}
...
***********************************************************************/
	...
	::vl::reflection::description::Value __vwsnc3_Rpc_DtorList_rpc_IRpcObjectOps__vl_rpc_controller_IRpcObjectOps::InvokeMethod(::vl::rpc_controller::RpcObjectReference ref, ::vl::vint methodId, ::vl::Ptr<::vl::reflection::description::IValueArray> arguments)
	{
		{
			...
			{
				auto target = ::vl::__vwsn::Ensure(::vl::__vwsn::SharedPtrCast<::RpcDtorList::IService>(::vl::__vwsn::This(_lc)->RefToPtr(ref).Obj()));
				::vl::__vwsn::This(target.Obj())->Set(::vl::__vwsn::Unbox<::vl::Ptr<::vl::reflection::description::IValueList>>(::vl::rpc_controller::RpcUnboxByref(::vl::__vwsn::Unbox<::vl::reflection::description::Value>(::vl::__vwsn::This(arguments.Obj())->Get(static_cast<::vl::vint>(0))), _lc)));
				return ::vl::reflection::description::Value();
			}
	...
	::vl::Ptr<::vl::reflection::description::IAsync> __vwsnc3_Rpc_DtorList_rpc_IRpcObjectOps__vl_rpc_controller_IRpcObjectOps::InvokeMethodAsync(::vl::rpc_controller::RpcObjectReference ref, ::vl::vint methodId, ::vl::Ptr<::vl::reflection::description::IValueArray> arguments)
	{
		throw ::vl::Exception(::vl::WString::Unmanaged(L"InvokeMethodAsync is not supported."));
	}

	void __vwsnc3_Rpc_DtorList_rpc_IRpcObjectOps__vl_rpc_controller_IRpcObjectOps::ObjectHold(::vl::rpc_controller::RpcObjectReference ref, ::vl::vint remoteClientId, bool hold)
	{
		if (hold)
		{
	...
	void __vwsnc3_Rpc_DtorList_rpc_IRpcObjectOps__vl_rpc_controller_IRpcObjectOps::RegisterService(::vl::vint typeId, ::vl::Ptr<::vl::reflection::IDescriptable> service)
	{
		{
	...
	void __vwsnc4_Rpc_DtorList_rpc_IRpcObjectEventOps__vl_rpc_controller_IRpcObjectEventOps::InvokeEvent(::vl::rpc_controller::RpcObjectReference ref, ::vl::vint eventId, ::vl::Ptr<::vl::reflection::description::IValueArray> arguments)
	{
