...
#define _ ,
			...
			BEGIN_INTERFACE_MEMBER(::RpcOverloadingTest::IService)
				...
				CLASS_MEMBER_METHOD_OVERLOAD(ToString, { L"value1" _ L"value2" _ L"value3" _ L"value4" }, ::vl::WString(::RpcOverloadingTest::IService::*)(::vl::vint, bool, const ::vl::WString&, ::vl::Ptr<::RpcOverloadingTest::IStringRepresentable>))
