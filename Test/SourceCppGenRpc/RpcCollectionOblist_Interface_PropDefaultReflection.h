...
#ifndef VCZH_WORKFLOW_COMPILER_GENERATED_RPCCOLLECTIONOBLIST_INTERFACE_PROPDEFAULTREFLECTION
#define VCZH_WORKFLOW_COMPILER_GENERATED_RPCCOLLECTIONOBLIST_INTERFACE_PROPDEFAULTREFLECTION
	...
	namespace reflection
	{
		namespace description
		{
			...
			BEGIN_INTERFACE_PROXY_NOPARENT_SHAREDPTR(::rpcops_IOps_Rpc_CollectionOblist_Interface_PropDefault)
				...
				{
					INVOKEGET_INTERFACE_PROXY(InvokeMethod_RpcCollectionOblist__Interface__PropDefault__IService_GetServiceResult, ref);
				}
