...
#ifndef VCZH_WORKFLOW_COMPILER_GENERATED_RPCCOLLECTION_INTERFACE_INBYVAL_OUTBYREFREFLECTION
#define VCZH_WORKFLOW_COMPILER_GENERATED_RPCCOLLECTION_INTERFACE_INBYVAL_OUTBYREFREFLECTION
...
namespace vl
{
	namespace reflection
	{
		namespace description
		{
			...
			DECL_TYPE_INFO(::RpcCollection::Interface::InByval::OutByref::IRpcWrapper_IService)
			...
			BEGIN_INTERFACE_PROXY_NOPARENT_SHAREDPTR(::RpcCollection::Interface::InByval::OutByref::IService)
			...
			END_INTERFACE_PROXY(::RpcCollection::Interface::InByval::OutByref::IService)

			BEGIN_INTERFACE_PROXY_NOPARENT_SHAREDPTR(::RpcCollection::Interface::InByval::OutByref::IValue)
			...
			BEGIN_INTERFACE_PROXY_NOPARENT_SHAREDPTR(::rpcops_IOps_Rpc_Collection_Interface_InByval_OutByref)
				...
				{
					INVOKEGET_INTERFACE_PROXY(InvokeMethod_RpcCollection__Interface__InByval__OutByref__IService_GetServiceResult, ref);
				}
			...
			BEGIN_INTERFACE_PROXY_SHAREDPTR(::RpcCollection::Interface::InByval::OutByref::IRpcWrapper_IValue, ::RpcCollection::Interface::InByval::OutByref::IValue, ::vl::rpc_controller::IRpcWrapperBase)
			END_INTERFACE_PROXY(::RpcCollection::Interface::InByval::OutByref::IRpcWrapper_IValue)
#endif
#endif

			extern bool LoadRpc_Collection_Interface_InByval_OutByrefTypes();
		}
	}
}
