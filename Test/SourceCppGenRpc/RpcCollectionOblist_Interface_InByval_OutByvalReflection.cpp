...
namespace vl
{
	namespace reflection
	{
		namespace description
		{
			...
			IMPL_CPP_TYPE_INFO(RpcCollectionOblist::Interface::InByval::OutByval::IRpcWrapper_IService)
...
#define _ ,
			BEGIN_INTERFACE_MEMBER(::RpcCollectionOblist::Interface::InByval::OutByval::IRpcWrapper_IService)
				CLASS_MEMBER_BASE(::RpcCollectionOblist::Interface::InByval::OutByval::IService)
				CLASS_MEMBER_BASE(::vl::rpc_controller::IRpcWrapperBase)
			END_INTERFACE_MEMBER(::RpcCollectionOblist::Interface::InByval::OutByval::IRpcWrapper_IService)

			BEGIN_INTERFACE_MEMBER(::RpcCollectionOblist::Interface::InByval::OutByval::IRpcWrapper_IValue)
				CLASS_MEMBER_BASE(::RpcCollectionOblist::Interface::InByval::OutByval::IValue)
				CLASS_MEMBER_BASE(::vl::rpc_controller::IRpcWrapperBase)
			END_INTERFACE_MEMBER(::RpcCollectionOblist::Interface::InByval::OutByval::IRpcWrapper_IValue)

			BEGIN_INTERFACE_MEMBER(::RpcCollectionOblist::Interface::InByval::OutByval::IService)
			...
			END_INTERFACE_MEMBER(::RpcCollectionOblist::Interface::InByval::OutByval::IService)

			BEGIN_INTERFACE_MEMBER(::RpcCollectionOblist::Interface::InByval::OutByval::IValue)
				ATTRIBUTE_TYPE(::vl::__vwsn::att_rpc_Interface)
				CLASS_MEMBER_BASE(::vl::reflection::IDescriptable)
			...
			BEGIN_INTERFACE_MEMBER(::rpcops_IOps_Rpc_CollectionOblist_Interface_InByval_OutByval)
				...
				CLASS_MEMBER_METHOD(InvokeMethod_RpcCollectionOblist__Interface__InByval__OutByval__IService_GetServiceResult, { L"ref" })
...
#undef _
			...
			public:
				...
				{
					ADD_TYPE_INFO(::RpcCollectionOblist::Interface::InByval::OutByval::IRpcWrapper_IService)
			...
			bool LoadRpc_CollectionOblist_Interface_InByval_OutByvalTypes()
			{
#ifdef VCZH_DESCRIPTABLEOBJECT_WITH_METADATA
				if (auto manager = GetGlobalTypeManager())
				{
					return manager->AddTypeLoader(Ptr(new Rpc_CollectionOblist_Interface_InByval_OutByvalTypeLoader));
				}
#endif
				return false;
			}
