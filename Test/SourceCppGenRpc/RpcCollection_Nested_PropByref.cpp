...
BEGIN_GLOBAL_STORAGE_CLASS(vl_workflow_global_Rpc_Collection_Nested_PropByref)
	...
	INITIALIZE_GLOBAL_STORAGE_CLASS
		...
		instance.rpcmethod_RpcCollection__Nested__InByref__PropByref__IService_GetServiceResult = static_cast<::vl::vint>(2);
		instance.rpcmethod_RpcCollection__Nested__InByref__PropByref__IService_SetList = static_cast<::vl::vint>(3);
...
***********************************************************************/
	...
	void Rpc_Collection_Nested_PropByref::serviceMain(::vl::rpc_controller::IRpcLifecycle* lc)
	{
		...
		::vl::__vwsn::This(lc)->RegisterLocalService(::vl::__vwsn::Unbox<::vl::vint>(::vl::__vwsn::This(GLOBAL_NAME rpc_GetIds().Obj())->Get(::vl::__vwsn::Box(::vl::WString::Unmanaged(L"RpcCollection::Nested::InByref::PropByref::IService")))), ::vl::Ptr<::vl::reflection::IDescriptable>(serviceObj));
	}
	...
	::vl::Ptr<::vl::reflection::description::IValueDictionary> Rpc_Collection_Nested_PropByref::rpc_GetIds()
	{
		...
		::vl::__vwsn::This(result.Obj())->Set(::vl::__vwsn::Box(::vl::WString::Unmanaged(L"RpcCollection::Nested::InByref::PropByref::IService.GetServiceResult")), ::vl::__vwsn::Box(static_cast<::vl::vint>(2)));
		::vl::__vwsn::This(result.Obj())->Set(::vl::__vwsn::Box(::vl::WString::Unmanaged(L"RpcCollection::Nested::InByref::PropByref::IService.SetList")), ::vl::__vwsn::Box(static_cast<::vl::vint>(3)));
		return result;
	}
	...
	::vl::vint Rpc_Collection_Nested_PropByref::rpcwrapper_GetTypeId(const ::vl::reflection::description::Value& obj)
	{
...
***********************************************************************/
	...
	::vl::reflection::description::Value __vwsnc3_Rpc_Collection_Nested_PropByref_rpcops_IRpcObjectEventOps__vl_rpc_controller_IRpcObjectEventOps::InvokeEvent(::vl::rpc_controller::RpcObjectReference ref, ::vl::vint eventId, ::vl::Ptr<::vl::reflection::description::IValueArray> arguments)
	{
	...
	::vl::reflection::description::Value __vwsnc8_Rpc_Collection_Nested_PropByref_rpcops_IRpcObjectEventOpsJson__vl_rpc_controller_IRpcObjectEventOps::InvokeEvent(::vl::rpc_controller::RpcObjectReference ref, ::vl::vint eventId, ::vl::Ptr<::vl::reflection::description::IValueArray> arguments)
	{
		throw ::vl::Exception(::vl::WString::Unmanaged(L"Unknown RPC event id."));
	}
