...
namespace vl
{
	namespace reflection
	{
		namespace description
		{
			...
			IMPL_CPP_TYPE_INFO(RpcCollectionOblist::Interface::Nested::InByval::PropByval::IRpcWrapper_IService)
...
#define _ ,
			BEGIN_INTERFACE_MEMBER(::RpcCollectionOblist::Interface::Nested::InByval::PropByval::IRpcWrapper_IService)
				CLASS_MEMBER_BASE(::RpcCollectionOblist::Interface::Nested::InByval::PropByval::IService)
				CLASS_MEMBER_BASE(::vl::rpc_controller::IRpcWrapperBase)
			END_INTERFACE_MEMBER(::RpcCollectionOblist::Interface::Nested::InByval::PropByval::IRpcWrapper_IService)

			BEGIN_INTERFACE_MEMBER(::RpcCollectionOblist::Interface::Nested::InByval::PropByval::IRpcWrapper_IValue)
				CLASS_MEMBER_BASE(::RpcCollectionOblist::Interface::Nested::InByval::PropByval::IValue)
				CLASS_MEMBER_BASE(::vl::rpc_controller::IRpcWrapperBase)
			END_INTERFACE_MEMBER(::RpcCollectionOblist::Interface::Nested::InByval::PropByval::IRpcWrapper_IValue)

			BEGIN_INTERFACE_MEMBER(::RpcCollectionOblist::Interface::Nested::InByval::PropByval::IService)
			...
			END_INTERFACE_MEMBER(::RpcCollectionOblist::Interface::Nested::InByval::PropByval::IService)

			BEGIN_INTERFACE_MEMBER(::RpcCollectionOblist::Interface::Nested::InByval::PropByval::IValue)
				ATTRIBUTE_TYPE(::vl::__vwsn::att_rpc_Interface)
				CLASS_MEMBER_BASE(::vl::reflection::IDescriptable)
			...
			BEGIN_INTERFACE_MEMBER(::rpcops_IOps_Rpc_CollectionOblist_Interface_Nested_PropByval)
				...
				CLASS_MEMBER_METHOD(InvokeMethod_RpcCollectionOblist__Interface__Nested__InByval__PropByval__IService_GetServiceResult, { L"ref" })
...
#undef _
			...
			public:
				...
				{
					ADD_TYPE_INFO(::RpcCollectionOblist::Interface::Nested::InByval::PropByval::IRpcWrapper_IService)
			...
			bool LoadRpc_CollectionOblist_Interface_Nested_PropByvalTypes()
			{
#ifdef VCZH_DESCRIPTABLEOBJECT_WITH_METADATA
				if (auto manager = GetGlobalTypeManager())
				{
					return manager->AddTypeLoader(Ptr(new Rpc_CollectionOblist_Interface_Nested_PropByvalTypeLoader));
				}
#endif
				return false;
			}
