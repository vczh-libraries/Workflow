...
***********************************************************************/
	...
	::vl::vint __vwsnc5_Rpc_Collection_Interface_Nested_InByval_OutByref_rpcwrapper_RpcCollection__Interface__Nested__InByval__OutByref__IValue__RpcCollection_Interface_Nested_InByval_OutByref_IRpcWrapper_IValue::GetValue()
	{
		...
		return ::vl::__vwsn::Unbox<::vl::vint>(::vl::__vwsn::This(::vl::__vwsn::This(::vl::__vwsn::This(_lc)->GetDispatcher())->SendToClient_ObjectOps(_ref.clientId))->InvokeMethod(_ref, GLOBAL_NAME rpcmethod_RpcCollection__Interface__Nested__InByval__OutByref__IValue_GetValue, arguments));
	}
