...
#define _ ,
			BEGIN_INTERFACE_MEMBER(::RpcCollection::PropDefault::IRpcWrapper_IService)
				CLASS_MEMBER_BASE(::RpcCollection::PropDefault::IService)
				CLASS_MEMBER_BASE(::vl::rpc_controller::IRpcWrapperBase)
			END_INTERFACE_MEMBER(::RpcCollection::PropDefault::IRpcWrapper_IService)

			BEGIN_INTERFACE_MEMBER(::RpcCollection::PropDefault::IService)
			...
			BEGIN_INTERFACE_MEMBER(::rpcops_IOps_Rpc_Collection_PropDefault)
				...
				CLASS_MEMBER_METHOD(InvokeMethod_RpcCollection__PropDefault__IService_GetServiceResult, { L"ref" })
...
#undef _
			...
			bool LoadRpc_Collection_PropDefaultTypes()
			{
#ifdef VCZH_DESCRIPTABLEOBJECT_WITH_METADATA
				if (auto manager = GetGlobalTypeManager())
				{
					return manager->AddTypeLoader(Ptr(new Rpc_Collection_PropDefaultTypeLoader));
				}
#endif
				return false;
			}
