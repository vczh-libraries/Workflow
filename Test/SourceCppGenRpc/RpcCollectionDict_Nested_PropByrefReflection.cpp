...
#define _ ,
			BEGIN_INTERFACE_MEMBER(::RpcCollectionDict::Nested::InByref::PropByref::IRpcWrapper_IService)
				CLASS_MEMBER_BASE(::RpcCollectionDict::Nested::InByref::PropByref::IService)
				CLASS_MEMBER_BASE(::vl::rpc_controller::IRpcWrapperBase)
			END_INTERFACE_MEMBER(::RpcCollectionDict::Nested::InByref::PropByref::IRpcWrapper_IService)

			BEGIN_INTERFACE_MEMBER(::RpcCollectionDict::Nested::InByref::PropByref::IService)
			...
			BEGIN_INTERFACE_MEMBER(::rpcops_IOps_Rpc_CollectionDict_Nested_PropByref)
				...
				CLASS_MEMBER_METHOD(InvokeMethod_RpcCollectionDict__Nested__InByref__PropByref__IService_GetServiceResult, { L"ref" })
...
#undef _
			...
			bool LoadRpc_CollectionDict_Nested_PropByrefTypes()
			{
#ifdef VCZH_DESCRIPTABLEOBJECT_WITH_METADATA
				if (auto manager = GetGlobalTypeManager())
				{
					return manager->AddTypeLoader(Ptr(new Rpc_CollectionDict_Nested_PropByrefTypeLoader));
				}
#endif
				return false;
			}
