...
***********************************************************************/
	...
	::vl::vint __vwsnc5_Rpc_CollectionOblist_Interface_Nested_PropDefault_rpcwrapper_RpcCollectionOblist__Interface__Nested__PropDefault__IValue__RpcCollectionOblist_Interface_Nested_PropDefault_IRpcWrapper_IValue::GetValue()
	{
		...
		return ::vl::__vwsn::Unbox<::vl::vint>(::vl::__vwsn::This(::vl::__vwsn::This(::vl::__vwsn::This(_lc)->GetDispatcher())->SendToClient_ObjectOps(_ref.clientId))->InvokeMethod(_ref, GLOBAL_NAME rpcmethod_RpcCollectionOblist__Interface__Nested__PropDefault__IValue_GetValue, arguments));
	}
