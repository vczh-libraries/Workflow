...
#endif
	public:
		virtual ::vl::vint ProcessInt(::vl::vint value) = 0;
		virtual ::vl::vuint ProcessUInt(::vl::vuint value) = 0;
...
namespace vl_workflow_global
{
	...
	public:
		...
		::vl::vint rpctype_RpcPrimitiveTest__IService = 0;
		::vl::vint rpcmethod_RpcPrimitiveTest__IService_ProcessInt = 0;
		::vl::vint rpcmethod_RpcPrimitiveTest__IService_ProcessUInt = 0;
		::vl::vint rpcmethod_RpcPrimitiveTest__IService_ProcessFloat = 0;
		::vl::vint rpcmethod_RpcPrimitiveTest__IService_ProcessDouble = 0;
		::vl::vint rpcmethod_RpcPrimitiveTest__IService_ProcessString = 0;
		::vl::vint rpcmethod_RpcPrimitiveTest__IService_ProcessBool = 0;
		::vl::vint rpcmethod_RpcPrimitiveTest__IService_ProcessEnum = 0;
		::vl::vint rpcmethod_RpcPrimitiveTest__IService_ProcessStruct = 0;
