	...
	{
		{
			...
			else if ((__vwsn_switch_7 == GLOBAL_NAME rpcmethod_RpcFailDoubleRegistrationTest__IService_SetObject))
			{
				...
				auto jsonValue1 = ::vl::__vwsn::Parse<::vl::vint>(::vl::__vwsn::This(::vl::__vwsn::Ensure(::vl::__vwsn::SharedPtrCast<::vl::glr::json::JsonNumber>(::vl::__vwsn::Unbox<::vl::Ptr<::vl::glr::json::JsonNode>>(::vl::rpc_controller::RpcGetSerializedArgument(arguments, static_cast<::vl::vint>(1))).Obj())).Obj())->content.value);
