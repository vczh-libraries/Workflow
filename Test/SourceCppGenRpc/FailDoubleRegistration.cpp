...
***********************************************************************/
	...
	{
		{
			...
			else if ((__vwsn_switch_4 == GLOBAL_NAME rpcmethod_RpcFailDoubleRegistrationTest__IService_SetObject))
			{
				...
				return ::vl::rpc_controller::RpcBoxByval(::vl::__vwsn::Box(::vl::__vwsn::This(target.Obj())->SetObject(::vl::__vwsn::Unbox<::vl::Ptr<::RpcFailDoubleRegistrationTest::IObject>>(::vl::rpc_controller::RpcUnboxByval(::vl::__vwsn::Unbox<::vl::reflection::description::Value>(::vl::__vwsn::This(arguments.Obj())->Get(static_cast<::vl::vint>(0))), _lc)), ::vl::__vwsn::Unbox<::vl::vint>(::vl::rpc_controller::RpcUnboxByval(::vl::__vwsn::Unbox<::vl::reflection::description::Value>(::vl::__vwsn::This(arguments.Obj())->Get(static_cast<::vl::vint>(1))), _lc)))), _lc);
			}
			else
	...
	::vl::Ptr<::vl::reflection::description::IAsync> __vwsnc3_Rpc_FailDoubleRegistration_rpc_IRpcObjectOps__vl_rpc_controller_IRpcObjectOps::InvokeMethodAsync(::vl::rpc_controller::RpcObjectReference ref, ::vl::vint methodId, ::vl::Ptr<::vl::reflection::description::IValueArray> arguments)
	{
	...
	::vl::Ptr<::RpcFailDoubleRegistrationTest::IObject> __vwsnc6_Rpc_FailDoubleRegistration_rpcwrapper_RpcFailDoubleRegistrationTest__IService__RpcFailDoubleRegistrationTest_IRpcWrapper_IService::SetObject(::vl::Ptr<::RpcFailDoubleRegistrationTest::IObject> obj, ::vl::vint index)
	{
		if ((_lc == nullptr))
			throw ::vl::Exception(::vl::WString::Unmanaged(L"RPC wrapper has been disconnected from lifecycle."));
		auto arguments = ::vl::reflection::description::IValueArray::Create();
		...
		::vl::__vwsn::This(arguments.Obj())->Set(static_cast<::vl::vint>(1), ::vl::rpc_controller::RpcBoxByval(::vl::__vwsn::Box(index), _lc));
