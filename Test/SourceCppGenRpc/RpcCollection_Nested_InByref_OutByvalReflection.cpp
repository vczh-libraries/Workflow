...
#define _ ,
			BEGIN_INTERFACE_MEMBER(::RpcCollection::Nested::InByref::OutByval::IRpcWrapper_IService)
				CLASS_MEMBER_BASE(::RpcCollection::Nested::InByref::OutByval::IService)
				CLASS_MEMBER_BASE(::vl::rpc_controller::IRpcWrapperBase)
			END_INTERFACE_MEMBER(::RpcCollection::Nested::InByref::OutByval::IRpcWrapper_IService)

			BEGIN_INTERFACE_MEMBER(::RpcCollection::Nested::InByref::OutByval::IService)
			...
			BEGIN_INTERFACE_MEMBER(::rpcops_IOps_Rpc_Collection_Nested_InByref_OutByval)
				...
				CLASS_MEMBER_METHOD(InvokeMethod_RpcCollection__Nested__InByref__OutByval__IService_GetServiceResult, { L"ref" })
...
#undef _
			...
			bool LoadRpc_Collection_Nested_InByref_OutByvalTypes()
			{
#ifdef VCZH_DESCRIPTABLEOBJECT_WITH_METADATA
				if (auto manager = GetGlobalTypeManager())
				{
					return manager->AddTypeLoader(Ptr(new Rpc_Collection_Nested_InByref_OutByvalTypeLoader));
				}
#endif
				return false;
			}
