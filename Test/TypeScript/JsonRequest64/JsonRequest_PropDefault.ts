import type { KnownTypeSchema, UnknownTypeSchema } from "../DataSchema64/Serialization_PropDefault";
...
export const json : (Request<KnownTypeSchema | UnknownTypeSchema> | Response<KnownTypeSchema | UnknownTypeSchema>)[] = [
  ...
  {"rpcMethod":"IObjectEventOps_InvokeEvent","rpcRequestId":5,"sourceClientId":1,"ref":{"clientId":1,"objectId":0,"typeId":0},"eventId":4,"arguments":[]},
  ...
  {"rpcMethod":"IObjectOps_InvokeMethod","rpcRequestId":6,"sourceClientId":1,"targetClientId":2,"response":"B"},
