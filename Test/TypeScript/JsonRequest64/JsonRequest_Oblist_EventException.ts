import type { KnownTypeSchema, UnknownTypeSchema } from "../DataSchema64/Serialization_Oblist_EventException";
...
export const json : (Request<KnownTypeSchema | UnknownTypeSchema> | Response<KnownTypeSchema | UnknownTypeSchema>)[] = [
  ...
  {"rpcMethod":"IObjectOps_InvokeMethod","rpcRequestId":4,"sourceClientId":2,"targetClientId":1,"ref":{"clientId":1,"objectId":1,"typeId":-5},"methodId":-7,"arguments":[["Int64",0]]},
  {"rpcMethod":"IObjectEventOps_InvokeEvent","rpcRequestId":5,"sourceClientId":1,"ref":{"clientId":1,"objectId":1,"typeId":-5},"eventId":-1,"arguments":[["Int64",0],["Int64",0],["Int64",1]]},
