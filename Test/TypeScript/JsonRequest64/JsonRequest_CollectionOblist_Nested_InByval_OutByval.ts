import type { KnownTypeSchema, UnknownTypeSchema } from "./Serialization_CollectionOblist_Nested_InByval_OutByval";
...
export const json : (Request<KnownTypeSchema | UnknownTypeSchema> | Response<KnownTypeSchema | UnknownTypeSchema>)[] = [
  ...
  {"rpcMethod":"IObjectOps_InvokeMethod","rpcRequestId":2,"sourceClientId":2,"targetClientId":1,"ref":{"clientId":1,"objectId":0,"typeId":0},"methodId":1,"arguments":[{"$":"oblist","values":[{"$":"oblist","values":[["Int64",1],["Int64",2],["Int64",3]]}]}]},
  {"rpcMethod":"IObjectOps_InvokeMethod","rpcRequestId":2,"sourceClientId":1,"targetClientId":2,"response":{"value":{"$":"oblist","values":[{"$":"oblist","values":[["Int64",1],["Int64",2],["Int64",3],["Int64",4]]}]},"slot":0}},
