...
#ifndef VCZH_WORKFLOW_COMPILER_GENERATED_RPCCOLLECTION_INTERFACE_NESTED_PROPDEFAULTREFLECTION
#define VCZH_WORKFLOW_COMPILER_GENERATED_RPCCOLLECTION_INTERFACE_NESTED_PROPDEFAULTREFLECTION
	...
	namespace reflection
	{
		namespace description
		{
			...
			BEGIN_INTERFACE_PROXY_NOPARENT_SHAREDPTR(::rpcops_IOps_Rpc_Collection_Interface_Nested_PropDefault)
				...
				{
					INVOKEGET_INTERFACE_PROXY(InvokeMethod_RpcCollection__Interface__Nested__PropDefault__IService_GetServiceResult, ref);
				}
