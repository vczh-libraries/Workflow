...
***********************************************************************/
	...
	::vl::vint64_t __vwsnc5_Rpc_CollectionOblist_Interface_Nested_InByval_OutByref_rpcwrapper_RpcCollectionOblist__Interface__Nested__InByval__OutByref__IValue__RpcCollectionOblist_Interface_Nested_InByval_OutByref_IRpcWrapper_IValue::GetValue()
	{
		...
		return ::vl::__vwsn::Unbox<::vl::vint64_t>(::vl::__vwsn::This(::vl::__vwsn::This(::vl::__vwsn::This(_lc)->GetDispatcher())->SendToClient_ObjectOps(_ref.clientId))->InvokeMethod(_ref, GLOBAL_NAME rpcmethod_RpcCollectionOblist__Interface__Nested__InByval__OutByref__IValue_GetValue, arguments));
	}
	...
	::vl::Ptr<::vl::reflection::description::IValueDictionary> __vwsnc6_Rpc_CollectionOblist_Interface_Nested_InByval_OutByref_rpcwrapper_RpcCollectionOblist__Interface__Nested__InByval__OutByref__IService__RpcCollectionOblist_Interface_Nested_InByval_OutByref_IRpcWrapper_IService::DoList(::vl::Ptr<::vl::reflection::description::IValueDictionary> xs)
	{
		...
		::vl::__vwsn::This(arguments.Obj())->Set(static_cast<::vl::vint64_t>(0L), ::vl::rpc_controller::RpcBoxByval(::vl::Ptr<::vl::reflection::IDescriptable>(xs), _lc));
