...
***********************************************************************/
	...
	::vl::reflection::description::Value __vwsnc3_Rpc_CollectionOblist_Interface_Nested_InByval_OutByref_rpc_IRpcObjectOps__vl_rpc_controller_IRpcObjectOps::InvokeMethod(::vl::rpc_controller::RpcObjectReference ref, ::vl::vint64_t methodId, ::vl::Ptr<::vl::reflection::description::IValueArray> arguments)
	{
		{
	...
	void __vwsnc3_Rpc_CollectionOblist_Interface_Nested_InByval_OutByref_rpc_IRpcObjectOps__vl_rpc_controller_IRpcObjectOps::ObjectHold(::vl::rpc_controller::RpcObjectReference ref, ::vl::vint64_t remoteClientId, bool hold)
	{
		if (hold)
		{
	...
	void __vwsnc3_Rpc_CollectionOblist_Interface_Nested_InByval_OutByref_rpc_IRpcObjectOps__vl_rpc_controller_IRpcObjectOps::RegisterService(::vl::vint64_t typeId, ::vl::Ptr<::vl::reflection::IDescriptable> service)
	{
		{
	...
	void __vwsnc4_Rpc_CollectionOblist_Interface_Nested_InByval_OutByref_rpc_IRpcObjectEventOps__vl_rpc_controller_IRpcObjectEventOps::InvokeEvent(::vl::rpc_controller::RpcObjectReference ref, ::vl::vint64_t eventId, ::vl::Ptr<::vl::reflection::description::IValueArray> arguments)
	{
	...
	::vl::vint64_t __vwsnc6_Rpc_CollectionOblist_Interface_Nested_InByval_OutByref_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_CollectionOblist_Interface_Nested_InByval_OutByref::InvokeMethod_RpcCollectionOblist__Interface__Nested__InByval__OutByref__IValue_GetValue(::vl::rpc_controller::RpcObjectReference ref)
	{
		auto arguments = ::vl::reflection::description::IValueArray::Create();
		::vl::__vwsn::This(arguments.Obj())->Resize(static_cast<::vl::vint64_t>(0L));
	...
	::vl::vint64_t __vwsnc7_Rpc_CollectionOblist_Interface_Nested_InByval_OutByref_rpcwrapper_RpcCollectionOblist__Interface__Nested__InByval__OutByref__IValue__RpcCollectionOblist_Interface_Nested_InByval_OutByref_IRpcWrapper_IValue::GetValue()
	{
		if ((_lc == nullptr))
