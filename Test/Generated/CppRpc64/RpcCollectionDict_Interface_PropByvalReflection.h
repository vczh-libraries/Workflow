...
#ifndef VCZH_WORKFLOW_COMPILER_GENERATED_RPCCOLLECTIONDICT_INTERFACE_PROPBYVALREFLECTION
#define VCZH_WORKFLOW_COMPILER_GENERATED_RPCCOLLECTIONDICT_INTERFACE_PROPBYVALREFLECTION
	...
	namespace reflection
	{
		namespace description
		{
			...
			BEGIN_INTERFACE_PROXY_NOPARENT_SHAREDPTR(::rpcops_IOps_Rpc_CollectionDict_Interface_PropByval)
				...
				{
					INVOKEGET_INTERFACE_PROXY(InvokeMethod_RpcCollectionDict__Interface__InByval__PropByval__IService_GetServiceResult, ref);
				}
