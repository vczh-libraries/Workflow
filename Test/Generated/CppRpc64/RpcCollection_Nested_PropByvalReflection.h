...
#ifndef VCZH_WORKFLOW_COMPILER_GENERATED_RPCCOLLECTION_NESTED_PROPBYVALREFLECTION
#define VCZH_WORKFLOW_COMPILER_GENERATED_RPCCOLLECTION_NESTED_PROPBYVALREFLECTION
...
namespace vl
{
	namespace reflection
	{
		namespace description
		{
			...
			BEGIN_INTERFACE_PROXY_NOPARENT_SHAREDPTR(::RpcCollection::Nested::InByval::PropByval::IService)
			...
			BEGIN_INTERFACE_PROXY_NOPARENT_SHAREDPTR(::rpcops_IOps_Rpc_Collection_Nested_PropByval)
				...
				{
					INVOKEGET_INTERFACE_PROXY(InvokeMethod_RpcCollection__Nested__InByval__PropByval__IService_GetServiceResult, ref);
				}
			...
			extern bool LoadRpc_Collection_Nested_PropByvalTypes();
		}
	}
}
