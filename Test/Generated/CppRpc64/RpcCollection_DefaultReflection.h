...
#ifndef VCZH_WORKFLOW_COMPILER_GENERATED_RPCCOLLECTION_DEFAULTREFLECTION
#define VCZH_WORKFLOW_COMPILER_GENERATED_RPCCOLLECTION_DEFAULTREFLECTION
...
namespace vl
{
	namespace reflection
	{
		namespace description
		{
			...
			BEGIN_INTERFACE_PROXY_NOPARENT_SHAREDPTR(::RpcCollection::Default::IService)
			...
			BEGIN_INTERFACE_PROXY_NOPARENT_SHAREDPTR(::rpcops_IOps_Rpc_Collection_Default)
				...
				{
					INVOKEGET_INTERFACE_PROXY(InvokeMethod_RpcCollection__Default__IService_GetServiceResult, ref);
				}
			...
			extern bool LoadRpc_Collection_DefaultTypes();
		}
	}
}
