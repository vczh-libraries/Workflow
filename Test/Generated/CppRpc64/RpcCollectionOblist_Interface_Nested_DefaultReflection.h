...
#ifndef VCZH_WORKFLOW_COMPILER_GENERATED_RPCCOLLECTIONOBLIST_INTERFACE_NESTED_DEFAULTREFLECTION
#define VCZH_WORKFLOW_COMPILER_GENERATED_RPCCOLLECTIONOBLIST_INTERFACE_NESTED_DEFAULTREFLECTION
...
namespace vl
{
	namespace reflection
	{
		namespace description
		{
			...
			DECL_TYPE_INFO(::RpcCollectionOblist::Interface::Nested::Default::IRpcWrapper_IService)
			...
			BEGIN_INTERFACE_PROXY_NOPARENT_SHAREDPTR(::RpcCollectionOblist::Interface::Nested::Default::IService)
			...
			END_INTERFACE_PROXY(::RpcCollectionOblist::Interface::Nested::Default::IService)

			BEGIN_INTERFACE_PROXY_NOPARENT_SHAREDPTR(::RpcCollectionOblist::Interface::Nested::Default::IValue)
			...
			BEGIN_INTERFACE_PROXY_NOPARENT_SHAREDPTR(::rpcops_IOps_Rpc_CollectionOblist_Interface_Nested_Default)
				...
				{
					INVOKEGET_INTERFACE_PROXY(InvokeMethod_RpcCollectionOblist__Interface__Nested__Default__IService_GetServiceResult, ref);
				}
			...
			BEGIN_INTERFACE_PROXY_SHAREDPTR(::RpcCollectionOblist::Interface::Nested::Default::IRpcWrapper_IValue, ::RpcCollectionOblist::Interface::Nested::Default::IValue, ::vl::rpc_controller::IRpcWrapperBase)
			END_INTERFACE_PROXY(::RpcCollectionOblist::Interface::Nested::Default::IRpcWrapper_IValue)
#endif
#endif

			extern bool LoadRpc_CollectionOblist_Interface_Nested_DefaultTypes();
		}
	}
}
