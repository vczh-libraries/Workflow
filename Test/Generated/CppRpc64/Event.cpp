...
***********************************************************************/
	...
	void Rpc_Event::rpcsvc_RaiseInvalidServiceTypeId(::vl::vint64_t typeId)
	{
		{
	...
	void Rpc_Event::rpcsvc_EnsureCtorServiceTypeId(::vl::vint64_t typeId)
	{
		{
	...
	void Rpc_Event::rpclistener_Attach(::vl::vint64_t typeId, ::vl::rpc_controller::IRpcLifeCycle* lc, ::vl::rpc_controller::RpcObjectReference ref, ::vl::Ptr<::vl::reflection::IDescriptable> obj)
	{
		{
	...
	::vl::Ptr<::vl::rpc_controller::IRpcWrapperBase> Rpc_Event::rpcwrapper_Create(::vl::vint64_t typeId, ::vl::rpc_controller::IRpcLifeCycle* lc)
	{
		{
