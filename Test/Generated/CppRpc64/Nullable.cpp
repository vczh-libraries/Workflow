	...
	{
		{
			...
			else if ((__vwsn_switch_7 == GLOBAL_NAME rpcmethod_RpcNullable__IService_Print))
			{
				...
				auto jsonLiteral1 = ::vl::__vwsn::SharedPtrCast<::vl::glr::json::JsonLiteral>(::vl::__vwsn::Unbox<::vl::Ptr<::vl::glr::json::JsonNode>>(::vl::rpc_controller::RpcGetSerializedArgument(arguments, static_cast<::vl::vint64_t>(0L))).Obj());
				if (((! static_cast<bool>(jsonLiteral1)) || (::vl::__vwsn::This(jsonLiteral1.Obj())->value != ::vl::glr::json::JsonLiteralValue::Null)))
				{
					auto jsonValue2 = ::vl::__vwsn::This(::vl::__vwsn::Ensure(::vl::__vwsn::SharedPtrCast<::vl::glr::json::JsonString>(::vl::__vwsn::Unbox<::vl::Ptr<::vl::glr::json::JsonNode>>(::vl::rpc_controller::RpcGetSerializedArgument(arguments, static_cast<::vl::vint64_t>(0L))).Obj())).Obj())->content.value;
					(jsonValue0 = ::vl::Nullable<::vl::WString>(jsonValue2));
				}
				auto jsonValue3 = GLOBAL_NAME rpcjson_Deserialize(::vl::__vwsn::Unbox<::vl::Ptr<::vl::glr::json::JsonNode>>(::vl::rpc_controller::RpcGetSerializedArgument(arguments, static_cast<::vl::vint64_t>(1L))));
