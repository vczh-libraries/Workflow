...
namespace vl_workflow_global
{
	...
	public:
		...
		::vl::WString s;
		::vl::vint64_t rpctype_RpcPropDefaultList__IService = 0;
		::vl::vint64_t rpcmethod_RpcPropDefaultList__IService_GetValue = 0;
		::vl::vint64_t rpcmethod_RpcPropDefaultList__IService_SetValue = 0;
		::vl::vint64_t rpcmethod_RpcPropDefaultList__IService_Signal = 0;
		::vl::vint64_t rpcevent_RpcPropDefaultList__IService_ValueChanged = 0;
		...
		void rpclistener_Attach(::vl::vint64_t typeId, ::vl::rpc_controller::IRpcLifecycle* lc, ::vl::rpc_controller::RpcObjectReference ref, ::vl::reflection::IDescriptable* obj, ::vl::Ptr<::rpcops_IOps_Rpc_PropDefaultList> ops);
