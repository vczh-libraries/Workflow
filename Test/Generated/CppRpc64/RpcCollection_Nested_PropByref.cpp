...
Source: ../Resources/Rpc/Collection_Nested_PropByref.txt; ../Resources/Rpc/Collection_Nested_PropByref_Client.txt; ../Resources/Rpc/Collection_Nested_PropByref_Service.txt
...
/* CodePack:ConditionOff(VCZH_DEBUG_NO_REFLECTION, RpcCollection_Nested_PropByrefReflection.h) */
...
BEGIN_GLOBAL_STORAGE_CLASS(vl_workflow_global_Rpc_Collection_Nested_PropByref)
	...
	INITIALIZE_GLOBAL_STORAGE_CLASS
		...
		instance.rpcmethod_RpcCollection__Nested__InByref__PropByref__IService_GetServiceResult = static_cast<::vl::vint64_t>(2L);
		instance.rpcmethod_RpcCollection__Nested__InByref__PropByref__IService_SetList = static_cast<::vl::vint64_t>(3L);
...
***********************************************************************/
	...
	void Rpc_Collection_Nested_PropByref::serviceMain(::vl::rpc_controller::IRpcLifecycle* lc)
	{
		...
		::vl::__vwsn::This(lc)->RegisterLocalService(::vl::__vwsn::Unbox<::vl::vint64_t>(::vl::__vwsn::This(GLOBAL_NAME rpc_GetIds().Obj())->Get(::vl::__vwsn::Box(::vl::WString::Unmanaged(L"RpcCollection::Nested::InByref::PropByref::IService")))), ::vl::Ptr<::vl::reflection::IDescriptable>(serviceObj));
	}
	...
	::vl::Ptr<::vl::reflection::description::IValueDictionary> Rpc_Collection_Nested_PropByref::rpc_GetIds()
	{
		...
		::vl::__vwsn::This(result.Obj())->Set(::vl::__vwsn::Box(::vl::WString::Unmanaged(L"RpcCollection::Nested::InByref::PropByref::IService.GetServiceResult")), ::vl::__vwsn::Box(static_cast<::vl::vint64_t>(2L)));
		::vl::__vwsn::This(result.Obj())->Set(::vl::__vwsn::Box(::vl::WString::Unmanaged(L"RpcCollection::Nested::InByref::PropByref::IService.SetList")), ::vl::__vwsn::Box(static_cast<::vl::vint64_t>(3L)));
		return result;
	}
	...
	::vl::vint64_t Rpc_Collection_Nested_PropByref::rpcwrapper_GetTypeId(const ::vl::reflection::description::Value& obj)
	{
		if ([&](){ auto __vwsn_temp__ = obj; return !__vwsn_temp__.GetSharedPtr() && ::vl::__vwsn::RawPtrCast<::RpcCollection::Nested::InByref::PropByref::IService>(__vwsn_temp__.GetRawPtr()) != nullptr; }())
			return GLOBAL_NAME rpctype_RpcCollection__Nested__InByref__PropByref__IService;
...
***********************************************************************/
	...
	::vl::reflection::description::Value __vwsnc3_Rpc_Collection_Nested_PropByref_rpcops_IRpcObjectEventOps__vl_rpc_controller_IRpcObjectEventOps::InvokeEvent(::vl::rpc_controller::RpcObjectReference ref, ::vl::vint64_t eventId, ::vl::Ptr<::vl::reflection::description::IValueArray> arguments)
	{
	...
	::vl::reflection::description::Value __vwsnc8_Rpc_Collection_Nested_PropByref_rpcops_IRpcObjectEventOpsJson__vl_rpc_controller_IRpcObjectEventOps::InvokeEvent(::vl::rpc_controller::RpcObjectReference ref, ::vl::vint64_t eventId, ::vl::Ptr<::vl::reflection::description::IValueArray> arguments)
	{
		throw ::vl::Exception(::vl::WString::Unmanaged(L"Unknown RPC event id."));
	}
