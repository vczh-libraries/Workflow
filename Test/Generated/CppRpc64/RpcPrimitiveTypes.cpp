...
***********************************************************************/
	...
	void Rpc_PrimitiveTypes::serviceMain(::vl::rpc_controller::IRpcLifecycle* lc)
	{
		...
		::vl::__vwsn::This(lc)->RegisterLocalService(::vl::__vwsn::Unbox<::vl::vint64_t>(::vl::__vwsn::This(GLOBAL_NAME rpc_GetIds().Obj())->Get(::vl::__vwsn::Box(::vl::WString::Unmanaged(L"RpcPrimitiveTest::IService")))), ::vl::Ptr<::vl::reflection::IDescriptable>(service));
	}
