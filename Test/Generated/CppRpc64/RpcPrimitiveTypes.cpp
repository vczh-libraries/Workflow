...
***********************************************************************/
	...
	::test::Point Rpc_PrimitiveTypes::rpcjson_Deserialize_Struct_test__Point(::vl::Ptr<::vl::glr::json::JsonNode> node)
	{
		...
		auto jsonValue7 = ::vl::__vwsn::Parse<::vl::vint64_t>(::vl::__vwsn::Unbox<::vl::WString>(GLOBAL_NAME rpcjson_Deserialize(jsonFieldValue5)));
		...
		auto jsonValue10 = ::vl::__vwsn::Parse<::vl::vint64_t>(::vl::__vwsn::Unbox<::vl::WString>(GLOBAL_NAME rpcjson_Deserialize(jsonFieldValue8)));
...
***********************************************************************/
	...
	::vl::reflection::description::Value __vwsnc3_Rpc_PrimitiveTypes_rpcops_IRpcObjectEventOps__vl_rpc_controller_IRpcObjectEventOps::InvokeEvent(::vl::rpc_controller::RpcObjectReference ref, ::vl::vint64_t eventId, ::vl::Ptr<::vl::reflection::description::IValueArray> arguments)
	{
		...
		{
			{
				...
				{
					auto target = ::vl::__vwsn::Ensure(::vl::__vwsn::SharedPtrCast<::RpcPrimitiveTest::IService>(::vl::__vwsn::This(_lc)->RefToPtr(ref).Obj()));
					auto jsonValue0 = ::vl::__vwsn::Parse<double>(::vl::__vwsn::Unbox<::vl::WString>(GLOBAL_NAME rpcjson_Deserialize(::vl::__vwsn::Unbox<::vl::Ptr<::vl::glr::json::JsonNode>>(::vl::__vwsn::Unbox<::vl::reflection::description::Value>(::vl::__vwsn::This(arguments.Obj())->Get(static_cast<::vl::vint64_t>(0L)))))));
					auto jsonNumber1 = ::vl::Ptr<::vl::glr::json::JsonNumber>(new ::vl::glr::json::JsonNumber());
				...
				{
					auto target = ::vl::__vwsn::Ensure(::vl::__vwsn::SharedPtrCast<::RpcPrimitiveTest::IService>(::vl::__vwsn::This(_lc)->RefToPtr(ref).Obj()));
					auto jsonValue0 = ::vl::__vwsn::Parse<float>(::vl::__vwsn::Unbox<::vl::WString>(GLOBAL_NAME rpcjson_Deserialize(::vl::__vwsn::Unbox<::vl::Ptr<::vl::glr::json::JsonNode>>(::vl::__vwsn::Unbox<::vl::reflection::description::Value>(::vl::__vwsn::This(arguments.Obj())->Get(static_cast<::vl::vint64_t>(0L)))))));
					auto jsonNumber1 = ::vl::Ptr<::vl::glr::json::JsonNumber>(new ::vl::glr::json::JsonNumber());
				...
				{
					auto target = ::vl::__vwsn::Ensure(::vl::__vwsn::SharedPtrCast<::RpcPrimitiveTest::IService>(::vl::__vwsn::This(_lc)->RefToPtr(ref).Obj()));
					auto jsonValue0 = ::vl::__vwsn::Parse<::vl::vuint64_t>(::vl::__vwsn::Unbox<::vl::WString>(GLOBAL_NAME rpcjson_Deserialize(::vl::__vwsn::Unbox<::vl::Ptr<::vl::glr::json::JsonNode>>(::vl::__vwsn::Unbox<::vl::reflection::description::Value>(::vl::__vwsn::This(arguments.Obj())->Get(static_cast<::vl::vint64_t>(0L)))))));
					auto jsonNumber1 = ::vl::Ptr<::vl::glr::json::JsonNumber>(new ::vl::glr::json::JsonNumber());
	...
	::vl::reflection::description::Value __vwsnc8_Rpc_PrimitiveTypes_rpcops_IRpcObjectEventOpsJson__vl_rpc_controller_IRpcObjectEventOps::InvokeEvent(::vl::rpc_controller::RpcObjectReference ref, ::vl::vint64_t eventId, ::vl::Ptr<::vl::reflection::description::IValueArray> arguments)
	{
		throw ::vl::Exception(::vl::WString::Unmanaged(L"Unknown RPC event id."));
	}
	...
	::vl::vint64_t __vwsnc9_Rpc_PrimitiveTypes_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_PrimitiveTypes::InvokeMethod_RpcPrimitiveTest__IService_ProcessInt(::vl::rpc_controller::RpcObjectReference ref, ::vl::vint64_t arg_value)
	{
		...
		auto methodResult = GLOBAL_NAME rpcjson_Deserialize(jsonResult);
		::vl::rpc_controller::ReadMethodException(methodResult);
		auto jsonValue1 = ::vl::__vwsn::Parse<::vl::vint64_t>(::vl::__vwsn::Unbox<::vl::WString>(GLOBAL_NAME rpcjson_Deserialize(jsonResult)));
		return jsonValue1;
	}
	...
	::vl::vuint64_t __vwsnc9_Rpc_PrimitiveTypes_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_PrimitiveTypes::InvokeMethod_RpcPrimitiveTest__IService_ProcessUInt(::vl::rpc_controller::RpcObjectReference ref, ::vl::vuint64_t arg_value)
	{
		...
		auto methodResult = GLOBAL_NAME rpcjson_Deserialize(jsonResult);
		::vl::rpc_controller::ReadMethodException(methodResult);
		auto jsonValue1 = ::vl::__vwsn::Parse<::vl::vuint64_t>(::vl::__vwsn::Unbox<::vl::WString>(GLOBAL_NAME rpcjson_Deserialize(jsonResult)));
		return jsonValue1;
	}
