...
***********************************************************************/
	...
	void Rpc_ServiceWrapper::rpcsvc_RaiseInvalidServiceTypeId(::vl::vint64_t typeId)
	{
		{
			...
			if ((__vwsn_switch_0 == static_cast<::vl::vint64_t>(-1L)))
				...
				throw ::vl::Exception(::vl::WString::Unmanaged(L"RPC service type id is not an @rpc:Ctor interface."));
			else if ((__vwsn_switch_0 == GLOBAL_NAME rpctype_RpcServiceWrapperTest__IService))
				throw ::vl::Exception(::vl::WString::Unmanaged(L"RPC service type id is not an @rpc:Ctor interface."));
			else
	...
	void Rpc_ServiceWrapper::rpcsvc_EnsureCtorServiceTypeId(::vl::vint64_t typeId)
	{
		{
	...
	::vl::Ptr<::RpcServiceWrapperTest::IRpcWrapper_IService> Rpc_ServiceWrapper::rpcwrapper_RpcServiceWrapperTest__IService(::vl::rpc_controller::IRpcLifeCycle* lc)
	{
	...
	::vl::Ptr<::vl::rpc_controller::IRpcWrapperBase> Rpc_ServiceWrapper::rpcwrapper_Create(::vl::vint64_t typeId, ::vl::rpc_controller::IRpcLifeCycle* lc)
	{
		{
...
***********************************************************************/
	...
	::vl::rpc_controller::RpcObjectReference __vwsnc2_Rpc_ServiceWrapper_rpc_IRpcObjectOps__vl_rpc_controller_IRpcObjectOps::RequestService(::vl::vint64_t typeId)
	{
		{
