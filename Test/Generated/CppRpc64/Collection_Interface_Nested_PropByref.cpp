...
***********************************************************************/
	...
	::vl::vint64_t __vwsnc10_Rpc_Collection_Interface_Nested_PropByref_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_Collection_Interface_Nested_PropByref::InvokeMethod_RpcCollection__Interface__Nested__InByref__PropByref__IValue_GetValue(::vl::rpc_controller::RpcObjectReference ref)
	{
	...
	::vl::reflection::description::Value __vwsnc8_Rpc_Collection_Interface_Nested_PropByref_rpcops_IRpcObjectOpsJson__vl_rpc_controller_IRpcObjectOps::InvokeMethod(::vl::rpc_controller::RpcObjectReference ref, ::vl::vint64_t methodId, ::vl::Ptr<::vl::reflection::description::IValueArray> arguments)
	{
		{
	...
	void __vwsnc8_Rpc_Collection_Interface_Nested_PropByref_rpcops_IRpcObjectOpsJson__vl_rpc_controller_IRpcObjectOps::ObjectHold(::vl::rpc_controller::RpcObjectReference ref, ::vl::vint64_t remoteClientId, bool hold)
	{
		if (hold)
		{
			::vl::__vwsn::This(_lc)->LocalObjectHold(ref, remoteClientId);
	...
	void __vwsnc8_Rpc_Collection_Interface_Nested_PropByref_rpcops_IRpcObjectOpsJson__vl_rpc_controller_IRpcObjectOps::RegisterService(::vl::vint64_t typeId, ::vl::Ptr<::vl::reflection::IDescriptable> service)
	{
		{
			if (GLOBAL_NAME rpcwrapper_IsCtorInterfaceTypeId(typeId))
			{
	...
	void __vwsnc9_Rpc_Collection_Interface_Nested_PropByref_rpcops_IRpcObjectEventOpsJson__vl_rpc_controller_IRpcObjectEventOps::InvokeEvent(::vl::rpc_controller::RpcObjectReference ref, ::vl::vint64_t eventId, ::vl::Ptr<::vl::reflection::description::IValueArray> arguments)
	{
		::vl::__vwsn::This(::vl::__vwsn::This(_lc)->GetController())->SetEventSuppressedFlag(ref, eventId, true);
		{
			auto __vwsnb_0 = [&]()
