...
***********************************************************************/
	...
	void Rpc_RequestService::rpcsvc_RaiseInvalidServiceTypeId(::vl::vint64_t typeId)
	{
		{
			...
			if ((__vwsn_switch_0 == static_cast<::vl::vint64_t>(-1L)))
				...
				throw ::vl::Exception(::vl::WString::Unmanaged(L"RPC service type id is not an @rpc:Ctor interface."));
			else if ((__vwsn_switch_0 == GLOBAL_NAME rpctype_RpcTest__IService))
				throw ::vl::Exception(::vl::WString::Unmanaged(L"RPC service type id is not an @rpc:Ctor interface."));
			else
	...
	void Rpc_RequestService::rpcsvc_EnsureCtorServiceTypeId(::vl::vint64_t typeId)
	{
		{
	...
	::vl::Ptr<::vl::rpc_controller::IRpcWrapperBase> Rpc_RequestService::rpcwrapper_Create(::vl::vint64_t typeId, ::vl::rpc_controller::IRpcLifeCycle* lc)
	{
		{
