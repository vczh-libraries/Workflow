...
***********************************************************************/
	...
	::vl::Ptr<::vl::reflection::description::IAsync> __vwsnc3_Rpc_Collection_Interface_Nested_PropByval_rpc_IRpcObjectOps__vl_rpc_controller_IRpcObjectOps::InvokeMethodAsync(::vl::rpc_controller::RpcObjectReference ref, ::vl::vint64_t methodId, ::vl::Ptr<::vl::reflection::description::IValueArray> arguments)
	{
	...
	::vl::vint64_t __vwsnc5_Rpc_Collection_Interface_Nested_PropByval_rpcwrapper_RpcCollection__Interface__Nested__InByval__PropByval__IValue__RpcCollection_Interface_Nested_InByval_PropByval_IRpcWrapper_IValue::GetValue()
	{
		if ((_lc == nullptr))
		...
		return ::vl::__vwsn::Unbox<::vl::vint64_t>(::vl::rpc_controller::RpcUnboxByval(::vl::__vwsn::This(::vl::__vwsn::This(::vl::__vwsn::This(_lc)->GetDispatcher())->SendToClient_ObjectOps(_ref.clientId))->InvokeMethod(_ref, GLOBAL_NAME rpcmethod_RpcCollection__Interface__Nested__InByval__PropByval__IValue_GetValue, arguments), _lc));
	}
