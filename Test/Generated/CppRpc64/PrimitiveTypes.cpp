...
***********************************************************************/
	...
	::vl::Ptr<::vl::reflection::IDescriptable> PrimitiveTypes::rpcwrapper_Create(::vl::vint64_t typeId, ::vl::rpc_controller::IRpcLifeCycle* lc)
	{
		{
...
***********************************************************************/
	...
	::vl::vuint64_t __vwsnc4_PrimitiveTypes_rpcwrapper_RpcPrimitiveTest__IService__RpcPrimitiveTest_IRpcWrapper_IService::ProcessUInt(::vl::vuint64_t value)
	{
		...
		::vl::__vwsn::This(arguments.Obj())->Resize(static_cast<::vl::vint64_t>(1L));
		::vl::__vwsn::This(arguments.Obj())->Set(static_cast<::vl::vint64_t>(0L), ::vl::rpc_controller::RpcBoxByval(::vl::__vwsn::Box(value), _lc));
		return ::vl::__vwsn::Unbox<::vl::vuint64_t>(::vl::rpc_controller::RpcUnboxByval(::vl::__vwsn::This(::vl::__vwsn::This(_lc)->GetController())->InvokeMethod(_ref, GLOBAL_NAME rpcmethod_RpcPrimitiveTest__IService_ProcessUInt, arguments), _lc));
	}
