...
***********************************************************************/
	...
	::vl::WString ClassCtor::main()
	{
		...
		{
			auto a = ::vl::Ptr<::Ctor>(new ::Ctor(static_cast<::vl::vint64_t>(1L), true));
			(GLOBAL_NAME s = (GLOBAL_NAME s + ((((::vl::WString::Unmanaged(L"[") + ::vl::__vwsn::ToString(::vl::__vwsn::This(a.Obj())->GetX())) + ::vl::WString::Unmanaged(L"][")) + ::vl::__vwsn::ToString(::vl::__vwsn::This(a.Obj())->GetValue())) + ::vl::WString::Unmanaged(L"]"))));
		}
		{
			auto a = ::vl::Ptr<::Ctor>(new ::Ctor(true, static_cast<::vl::vint64_t>(2L)));
			(GLOBAL_NAME s = (GLOBAL_NAME s + ((((::vl::WString::Unmanaged(L"[") + ::vl::__vwsn::ToString(::vl::__vwsn::This(a.Obj())->GetX())) + ::vl::WString::Unmanaged(L"][")) + ::vl::__vwsn::ToString(::vl::__vwsn::This(a.Obj())->GetValue())) + ::vl::WString::Unmanaged(L"]"))));
		}
		{
			auto a = ::vl::Ptr<::Ctor>(new ::Ctor(static_cast<::vl::vint64_t>(1L), static_cast<::vl::vint64_t>(2L)));
			(GLOBAL_NAME s = (GLOBAL_NAME s + ((((::vl::WString::Unmanaged(L"[") + ::vl::__vwsn::ToString(::vl::__vwsn::This(a.Obj())->GetX())) + ::vl::WString::Unmanaged(L"][")) + ::vl::__vwsn::ToString(::vl::__vwsn::This(a.Obj())->GetValue())) + ::vl::WString::Unmanaged(L"]"))));
		}
...
Base::Base()
	: x(static_cast<::vl::vint64_t>(0L))
{
}

Base::Base(::vl::vint64_t _x)
	: x(static_cast<::vl::vint64_t>(0L))
{
	(this->x = _x);
...
Ctor::Ctor(::vl::vint64_t y, bool b)
	: ::Base(y)
{
}

Ctor::Ctor(bool b, ::vl::vint64_t value)
	: ::test::ObservableValue(value, ::vl::Nullable<bool>(b))
{
}

Ctor::Ctor(::vl::vint64_t y, ::vl::vint64_t value)
	: ::Base(y)
