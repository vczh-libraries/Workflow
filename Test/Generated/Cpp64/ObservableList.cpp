...
***********************************************************************/
	...
	void ObservableList::Callback(::vl::vint64_t index, ::vl::vint64_t oldCount, ::vl::vint64_t newCount)
	{
	...
	{
		auto list = (::vl::__vwsn::CreateObservableList().Add(static_cast<::vl::vint64_t>(1L)).Add(static_cast<::vl::vint64_t>(2L)).Add(static_cast<::vl::vint64_t>(3L)).Add(static_cast<::vl::vint64_t>(4L)).Add(static_cast<::vl::vint64_t>(5L))).list;
		::vl::__vwsn::EventAttach(::vl::__vwsn::This(list.Obj())->ItemChanged, ::vl::Func<void(::vl::vint64_t, ::vl::vint64_t, ::vl::vint64_t)>(GLOBAL_OBJ, &GLOBAL_SYMBOL Callback));
		{
			auto __vwsn_for_enumerable_i = ::vl::Ptr<::vl::reflection::description::IValueEnumerable>((::vl::__vwsn::CreateList().Add(static_cast<::vl::vint64_t>(2L)).Add(static_cast<::vl::vint64_t>(4L)).Add(static_cast<::vl::vint64_t>(6L)).Add(static_cast<::vl::vint64_t>(8L)).Add(static_cast<::vl::vint64_t>(10L))).list);
			...
			while (::vl::__vwsn::This(__vwsn_for_enumerator_i.Obj())->Next())
			{
				...
				{
					::vl::__vwsn::This(list.Obj())->Insert((i - static_cast<::vl::vint64_t>(1L)), ::vl::__vwsn::Box(i));
				}
			}
		}
		{
			auto __vwsn_for_begin_i = static_cast<::vl::vint64_t>(0L);
			auto __vwsn_for_end_i = static_cast<::vl::vint64_t>(4L);
