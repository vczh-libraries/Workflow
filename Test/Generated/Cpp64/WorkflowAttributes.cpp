...
***********************************************************************/
	...
	::vl::vint64_t WorkflowAttributes::Evaluate(::vl::Ptr<::calculator::Expression> expr)
	{
		if (auto ne = ::vl::__vwsn::SharedPtrCast<::calculator::NumberExpression>(expr.Obj()))
		{
	...
	{
		auto expr = ::vl::Ptr<::calculator::BinaryExpression>(new ::calculator::BinaryExpression(::vl::Ptr<::calculator::Expression>(::vl::Ptr<::calculator::BinaryExpression>(new ::calculator::BinaryExpression(::vl::Ptr<::calculator::Expression>(::vl::Ptr<::calculator::NumberExpression>(new ::calculator::NumberExpression(static_cast<::vl::vint64_t>(1L)))), ::calculator::BinaryExpression::BinaryOperator::Add, ::vl::Ptr<::calculator::Expression>(::vl::Ptr<::calculator::NumberExpression>(new ::calculator::NumberExpression(static_cast<::vl::vint64_t>(2L))))))), ::calculator::BinaryExpression::BinaryOperator::Mul, ::vl::Ptr<::calculator::Expression>(::vl::Ptr<::calculator::BinaryExpression>(new ::calculator::BinaryExpression(::vl::Ptr<::calculator::Expression>(::vl::Ptr<::calculator::NumberExpression>(new ::calculator::NumberExpression(static_cast<::vl::vint64_t>(3L)))), ::calculator::BinaryExpression::BinaryOperator::Add, ::vl::Ptr<::calculator::Expression>(::vl::Ptr<::calculator::NumberExpression>(new ::calculator::NumberExpression(static_cast<::vl::vint64_t>(4L)))))))));
...
***********************************************************************/
	...
	::vl::vint64_t NumberExpression::GetValue()
	{
		return this->__vwsn_prop_Value;
	}
	void NumberExpression::SetValue(::vl::vint64_t __vwsn_value_)
	{
		(this->__vwsn_prop_Value = __vwsn_value_);
	}

	NumberExpression::NumberExpression(::vl::vint64_t _value)
