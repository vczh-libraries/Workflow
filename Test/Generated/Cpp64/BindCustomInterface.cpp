...
***********************************************************************/
	...
	{
		this->sum = static_cast<::vl::vint64_t>(0L);
	}

	::vl::vint64_t __vwsnc2_BindCustomInterface_main__IAdder::GetSum()
	{
		return sum;
	}

	void __vwsnc2_BindCustomInterface_main__IAdder::Add(::vl::vint64_t value)
	{
		(sum = (sum + value));
