...
***********************************************************************/
	...
	::vl::collections::LazyList<::vl::vint64_t> CoEnum2::GetNumbers()
	{
		return ::vl::reflection::description::GetLazyList<::vl::vint64_t>(::vl::reflection::description::EnumerableCoroutine::Create(vl::Func(::vl_workflow_global::__vwsnf1_CoEnum2_GetNumbers_())));
	}
		...
		{
			{
				...
				while (true)
				{
					if ((__vwsn_co_state_ == static_cast<::vl::vint64_t>(0L)))
					{
						...
						(__vwsn_co1_for_end_i = static_cast<::vl::vint64_t>(10L));
					...
					if ((__vwsn_co_state_ == static_cast<::vl::vint64_t>(3L)))
					{
						...
						{
							::vl::reflection::description::EnumerableCoroutine::JoinAndPause(__vwsn_co_impl_, ::vl::__vwsn::UnboxCollection<::vl::reflection::description::IValueEnumerable>(::vl::__vwsn::Range(__vwsn_co2_i, (__vwsn_co2_i + static_cast<::vl::vint64_t>(2L)) + 1)));
						}
						return;
					}
					if ((__vwsn_co_state_ == static_cast<::vl::vint64_t>(4L)))
					{
						...
						if ((__vwsn_co2_i == static_cast<::vl::vint64_t>(2L)))
						{
