...
***********************************************************************/
	...
	::vl::WString ClassMethod::main()
	{
		...
		{
			auto a = ::vl::Ptr<::Methods>(new ::Methods(static_cast<::vl::vint64_t>(100L)));
			(GLOBAL_NAME s = (GLOBAL_NAME s + ((::vl::WString::Unmanaged(L"[") + ::vl::__vwsn::ToString(::vl::__vwsn::This(a.Obj())->x)) + ::vl::WString::Unmanaged(L"]"))));
		}
		{
			auto a = ::vl::Ptr<::Methods>(new ::Methods(static_cast<::vl::vint64_t>(1L)));
			auto handler = ::vl::__vwsn::EventAttach(::vl::__vwsn::This(a.Obj())->XChanged, vl::Func(::vl_workflow_global::__vwsnf1_ClassMethod_main_(a)));
			::vl::__vwsn::This(a.Obj())->SetX((::vl::__vwsn::This(a.Obj())->GetX() + static_cast<::vl::vint64_t>(1L)));
			::vl::__vwsn::This(a.Obj())->SetX((::vl::__vwsn::This(a.Obj())->GetX() - static_cast<::vl::vint64_t>(1L)));
			::vl::__vwsn::This(a.Obj())->SetX(::vl::__vwsn::This(a.Obj())->GetX());
			::vl::__vwsn::EventDetach(::vl::__vwsn::This(a.Obj())->XChanged, handler);
			::vl::__vwsn::This(a.Obj())->SetX(static_cast<::vl::vint64_t>(100L));
...
Methods::Methods(::vl::vint64_t _x)
	: x(static_cast<::vl::vint64_t>(0L))
{
	(this->x = _x);
...
void Methods::SetX(::vl::vint64_t _x)
{
	if ((this->x != _x))
	{
		(this->x = _x);
