...
***********************************************************************/
	...
	__vwsnc1_CoSmcSwitchP2_SMSwitchP2___vwsn_state_CreateCoroutine__vl_reflection_description_ICoroutine::__vwsnc1_CoSmcSwitchP2_SMSwitchP2___vwsn_state_CreateCoroutine__vl_reflection_description_ICoroutine(::vl::Ptr<::vl::reflection::description::ICoroutine> __vwsnctor___vwsn_state_previousCoroutine, ::vl::vint64_t __vwsnctor___vwsn_state_startState, ::SMSwitchP2* __vwsnctor___vwsn_state_stateMachineObject, ::SMSwitchP2* __vwsnctorthis_0)
		...
		{
			{
				if ((__vwsn_co_state_before_pause_ != (- static_cast<::vl::vint64_t>(1L))))
				{
					...
					{
						if (((__vwsn_co_state_before_pause_ == static_cast<::vl::vint64_t>(0L)) || [&](auto __vwsn_1){ return (static_cast<::vl::vint64_t>(3L) <=  __vwsn_1 && __vwsn_1 <= static_cast<::vl::vint64_t>(6L)); }(__vwsn_co_state_before_pause_)))
						{
							(__vwsn_co_state_before_pause_ = (- static_cast<::vl::vint64_t>(1L)));
...
void SMSwitchP2::__vwsn_state_CreateCoroutine(::vl::vint64_t __vwsn_state_startState)
{
