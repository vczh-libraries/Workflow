...
***********************************************************************/
	...
	{
		return ((GLOBAL_NAME ReadValue(::vl::reflection::description::Value()) + ::vl::WString::Unmanaged(L", ")) + GLOBAL_NAME ReadValue(::vl::__vwsn::Box([&](){ ::BoxedIntValue __vwsn_temp__; __vwsn_temp__.value = static_cast<::vl::vint64_t>(0L); return __vwsn_temp__; }())));
	}
