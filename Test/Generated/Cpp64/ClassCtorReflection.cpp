...
#define _ ,
			BEGIN_CLASS_MEMBER(::Base)
				...
				CLASS_MEMBER_CONSTRUCTOR(::vl::Ptr<::Base>(::vl::vint64_t), { L"_x" })
			...
			BEGIN_CLASS_MEMBER(::Ctor)
				...
				CLASS_MEMBER_CONSTRUCTOR(::vl::Ptr<::Ctor>(::vl::vint64_t, bool), { L"y" _ L"b" })
				CLASS_MEMBER_CONSTRUCTOR(::vl::Ptr<::Ctor>(bool, ::vl::vint64_t), { L"b" _ L"value" })
				CLASS_MEMBER_CONSTRUCTOR(::vl::Ptr<::Ctor>(::vl::vint64_t, ::vl::vint64_t), { L"y" _ L"value" })
...
#undef _
			...
			bool LoadClassCtorTypes()
			{
				...
				{
					return manager->AddTypeLoader(Ptr(new ClassCtorTypeLoader));
				}
#endif
				return false;
			}
