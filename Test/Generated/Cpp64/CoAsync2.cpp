...
***********************************************************************/
	...
	::vl::Ptr<::CoAsync2_types::IStringAsync> CoAsync2::GetStringAsync(::vl::vint64_t x)
	{
...
***********************************************************************/
	...
	__vwsnf1_CoAsync2_GetStringAsync_::__vwsnf1_CoAsync2_GetStringAsync_(::vl::vint64_t __vwsnctor_x)
		:x(__vwsnctor_x)
	{
	}
	...
	__vwsnc1_CoAsync2_GetStringAsync___vl_reflection_description_ICoroutine::__vwsnc1_CoAsync2_GetStringAsync___vl_reflection_description_ICoroutine(::vl::reflection::description::AsyncCoroutine::IImpl* __vwsnctor___vwsn_co_impl_, ::vl::vint64_t __vwsnctor_x)
		...
		{
			{
				...
				while (true)
				{
					if ((__vwsn_co_state_ == static_cast<::vl::vint64_t>(0L)))
					{
						(__vwsn_co1_for_begin_i = static_cast<::vl::vint64_t>(1L));
						(__vwsn_co2_for_end_i = static_cast<::vl::vint64_t>(10L));
					...
					if ((__vwsn_co_state_ == static_cast<::vl::vint64_t>(2L)))
					{
						...
						if ((__vwsn_co3_i == static_cast<::vl::vint64_t>(5L)))
						{
