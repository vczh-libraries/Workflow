...
***********************************************************************/
	...
	{
		auto a = ::vl::Ptr<::test::ObservableValue>(new ::test::ObservableValue(static_cast<::vl::vint64_t>(1L)));
		auto b = ::vl::Ptr<::test::ObservableValue>(new ::test::ObservableValue(static_cast<::vl::vint64_t>(2L)));
