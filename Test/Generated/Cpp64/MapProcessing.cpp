...
***********************************************************************/
	...
	{
		auto xs = (::vl::__vwsn::CreateDictionary().Add(::vl::WString::Unmanaged(L"a"), static_cast<::vl::vint64_t>(1L)).Add(::vl::WString::Unmanaged(L"b"), static_cast<::vl::vint64_t>(2L)).Add(::vl::WString::Unmanaged(L"c"), static_cast<::vl::vint64_t>(3L)).Add(::vl::WString::Unmanaged(L"d"), static_cast<::vl::vint64_t>(4L)).Add(::vl::WString::Unmanaged(L"e"), static_cast<::vl::vint64_t>(5L))).dictionary;
		auto s1 = ((((::vl::__vwsn::ToString(::vl::__vwsn::This(xs.Obj())->GetCount()) + ::vl::WString::Unmanaged(L", ")) + ::vl::__vwsn::ToString(::vl::__vwsn::Unbox<::vl::vint64_t>(::vl::__vwsn::This(xs.Obj())->Get(::vl::__vwsn::Box(::vl::WString::Unmanaged(L"a")))))) + ::vl::WString::Unmanaged(L", ")) + ::vl::__vwsn::ToString(::vl::__vwsn::Unbox<::vl::vint64_t>(::vl::__vwsn::This(xs.Obj())->Get(::vl::__vwsn::Box(::vl::WString::Unmanaged(L"e"))))));
		::vl::__vwsn::This(xs.Obj())->Set(::vl::__vwsn::Box(::vl::WString::Unmanaged(L"e")), ::vl::__vwsn::Box(static_cast<::vl::vint64_t>(6L)));
		::vl::__vwsn::This(xs.Obj())->Set(::vl::__vwsn::Box(::vl::WString::Unmanaged(L"f")), ::vl::__vwsn::Box(static_cast<::vl::vint64_t>(7L)));
