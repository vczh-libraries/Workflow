...
#ifndef VCZH_WORKFLOW_COMPILER_GENERATED_COENUM2
#define VCZH_WORKFLOW_COMPILER_GENERATED_COENUM2
...
{
	struct __vwsnf1_CoEnum2_GetNumbers_;
	class __vwsnc1_CoEnum2_GetNumbers___vl_reflection_description_ICoroutine;
}
...
namespace vl_workflow_global
{
	...
	public:
		...
		::vl::collections::LazyList<::vl::vint64_t> GetNumbers();
		::vl::WString main();

		static CoEnum2& Instance();
	};
...
***********************************************************************/
	...
	class __vwsnc1_CoEnum2_GetNumbers___vl_reflection_description_ICoroutine : public ::vl::Object, public virtual ::vl::reflection::description::ICoroutine
	{
	public:
		::vl::reflection::description::EnumerableCoroutine::IImpl* __vwsn_co_impl_;

		__vwsnc1_CoEnum2_GetNumbers___vl_reflection_description_ICoroutine(::vl::reflection::description::EnumerableCoroutine::IImpl* __vwsnctor___vwsn_co_impl_);
