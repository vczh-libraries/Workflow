...
***********************************************************************/
	...
	{
		auto x = ::vl::Ptr<::MyClass>(new ::MyClass(static_cast<::vl::vint64_t>(1L), static_cast<::vl::vint64_t>(5L)));
...
***********************************************************************/
	...
	::vl::vint64_t __vwsnc1_NewCustomInterface3_MyClass_CreateMyInterface__IMyInterface3::Get100()
	{
		return (::MyClass::Get50() * static_cast<::vl::vint64_t>(2L));
	}
	...
	::vl::vint64_t __vwsnc2_NewCustomInterface3_MyClass_CreateMyInterface_CreateEnumerator__vl_reflection_description_IValueEnumerator::GetIndex()
	{
		return index;
	}
...
MyClass::MyClass(::vl::vint64_t _begin, ::vl::vint64_t _end)
	: begin((- static_cast<::vl::vint64_t>(1L)))
	, end((- static_cast<::vl::vint64_t>(1L)))
{
	(this->begin = _begin);
	(this->end = _end);
}

::vl::vint64_t MyClass::Get50()
{
