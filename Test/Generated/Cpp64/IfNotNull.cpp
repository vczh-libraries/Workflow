...
***********************************************************************/
	...
	{
		auto x = ::vl::__vwsn::Box((::vl::__vwsn::CreateList().Add(static_cast<::vl::vint64_t>(1L))).list);
		auto y = ::vl::__vwsn::Box((::vl::__vwsn::CreateDictionary().Add(static_cast<::vl::vint64_t>(1L), static_cast<::vl::vint64_t>(2L))).dictionary);
