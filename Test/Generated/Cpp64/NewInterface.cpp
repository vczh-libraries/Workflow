...
***********************************************************************/
	...
	::vl::WString NewInterface::Show1(const ::vl::collections::LazyList<::vl::vint64_t>& xs)
	{
	...
	::vl::WString NewInterface::Show2(const ::vl::collections::LazyList<::vl::vint64_t>& xs)
	{
		auto s = ::vl::WString::Unmanaged(L"");
		{
	...
	::vl::WString NewInterface::main()
	{
		...
		auto xs = ::vl::reflection::description::GetLazyList<::vl::vint64_t>(::vl::Ptr<::vl::reflection::description::IValueEnumerable>(new ::vl_workflow_global::__vwsnc1_NewInterface_main__vl_reflection_description_IValueEnumerable(begin, end)));
...
***********************************************************************/
	...
	__vwsnc1_NewInterface_main__vl_reflection_description_IValueEnumerable::__vwsnc1_NewInterface_main__vl_reflection_description_IValueEnumerable(::vl::vint64_t __vwsnctor_begin, ::vl::vint64_t __vwsnctor_end)
	...
	__vwsnc2_NewInterface_main_CreateEnumerator__vl_reflection_description_IValueEnumerator::__vwsnc2_NewInterface_main_CreateEnumerator__vl_reflection_description_IValueEnumerator(::vl::vint64_t __vwsnctor_begin, ::vl::vint64_t __vwsnctor_end, ::vl::reflection::description::IValueEnumerable* __vwsnctorthis_0)
		:begin(__vwsnctor_begin)
		, end(__vwsnctor_end)
	...
	::vl::vint64_t __vwsnc2_NewInterface_main_CreateEnumerator__vl_reflection_description_IValueEnumerator::GetIndex()
	{
		return index;
	}
