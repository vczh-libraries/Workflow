...
***********************************************************************/
	...
	::vl::WString OpCompare::main()
	{
		...
		auto p0 = [&](){ ::test::Point __vwsn_temp__; __vwsn_temp__.x = static_cast<::vl::vint64_t>(0L); return __vwsn_temp__; }();
		auto p1 = [&](){ ::test::Point __vwsn_temp__; __vwsn_temp__.y = static_cast<::vl::vint64_t>(0L); return __vwsn_temp__; }();
		auto p2 = [&](){ ::test::Point __vwsn_temp__; __vwsn_temp__.y = static_cast<::vl::vint64_t>(0L); __vwsn_temp__.x = static_cast<::vl::vint64_t>(0L); return __vwsn_temp__; }();
		auto p3 = ::test::Point{};
		auto p4 = [&](){ ::test::Point __vwsn_temp__; __vwsn_temp__.x = static_cast<::vl::vint64_t>(1L); __vwsn_temp__.y = static_cast<::vl::vint64_t>(1L); return __vwsn_temp__; }();
