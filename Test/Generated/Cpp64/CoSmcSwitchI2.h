...
#ifndef VCZH_WORKFLOW_COMPILER_GENERATED_COSMCSWITCHI2
#define VCZH_WORKFLOW_COMPILER_GENERATED_COSMCSWITCHI2
...
{
	class __vwsnc1_CoSmcSwitchI2_SMSwitchI2___vwsn_state_CreateCoroutine__vl_reflection_description_ICoroutine;
}

class SMSwitchI2;

class SMSwitchI2 : public ::vl::reflection::description::StateMachine, public ::vl::reflection::Description<SMSwitchI2>
{
	friend class ::vl_workflow_global::__vwsnc1_CoSmcSwitchI2_SMSwitchI2___vwsn_state_CreateCoroutine__vl_reflection_description_ICoroutine;
#ifdef VCZH_DESCRIPTABLEOBJECT_WITH_METADATA
	friend struct ::vl::reflection::description::CustomTypeDescriptorSelector<SMSwitchI2>;
#endif
public:
	void A();
	void B();
...
***********************************************************************/
	...
	class __vwsnc1_CoSmcSwitchI2_SMSwitchI2___vwsn_state_CreateCoroutine__vl_reflection_description_ICoroutine : public ::vl::Object, public virtual ::vl::reflection::description::ICoroutine
	{
	public:
		::vl::Ptr<::vl::reflection::description::ICoroutine> __vwsn_state_previousCoroutine;
		::vl::vint64_t __vwsn_state_startState;
		::SMSwitchI2* __vwsn_state_stateMachineObject;
		::SMSwitchI2* __vwsnthis_0;

		__vwsnc1_CoSmcSwitchI2_SMSwitchI2___vwsn_state_CreateCoroutine__vl_reflection_description_ICoroutine(::vl::Ptr<::vl::reflection::description::ICoroutine> __vwsnctor___vwsn_state_previousCoroutine, ::vl::vint64_t __vwsnctor___vwsn_state_startState, ::SMSwitchI2* __vwsnctor___vwsn_state_stateMachineObject, ::SMSwitchI2* __vwsnctorthis_0);
