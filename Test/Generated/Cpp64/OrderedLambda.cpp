...
***********************************************************************/
	...
	::vl::vint64_t OrderedLambda::Apply(const ::vl::Func<::vl::vint64_t(::vl::vint64_t)>& f, ::vl::vint64_t arg)
	{
		return f(arg);
	}

	::vl::Func<::vl::vint64_t(::vl::vint64_t)> OrderedLambda::Adder(::vl::vint64_t x)
	{
...
***********************************************************************/
	...
	__vwsno1_OrderedLambda_Adder_::__vwsno1_OrderedLambda_Adder_(::vl::vint64_t __vwsnctor_x)
		:x(__vwsnctor_x)
	{
	}

	::vl::vint64_t __vwsno1_OrderedLambda_Adder_::operator()(::vl::vint64_t __vwsno_1) const
	{
		return ((__vwsno_1 * static_cast<::vl::vint64_t>(0L)) + GLOBAL_NAME Apply(vl::Func(::vl_workflow_global::__vwsno2_OrderedLambda_Adder_(__vwsno_1)), x));
	}

	//-------------------------------------------------------------------

	__vwsno2_OrderedLambda_Adder_::__vwsno2_OrderedLambda_Adder_(::vl::vint64_t __vwsnctor___vwsno_1)
		:__vwsno_1(__vwsnctor___vwsno_1)
	{
	}

	::vl::vint64_t __vwsno2_OrderedLambda_Adder_::operator()(::vl::vint64_t __vwsno_2) const
	{
