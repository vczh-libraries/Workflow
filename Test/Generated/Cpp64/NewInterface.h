...
namespace vl_workflow_global
{
	...
	public:
		...
		::vl::WString Show1(const ::vl::collections::LazyList<::vl::vint64_t>& xs);
		::vl::WString Show2(const ::vl::collections::LazyList<::vl::vint64_t>& xs);
		::vl::WString main();
...
***********************************************************************/
	...
	public:
		...
		__vwsnc1_NewInterface_main__vl_reflection_description_IValueEnumerable(::vl::vint64_t __vwsnctor_begin, ::vl::vint64_t __vwsnctor_end);
	...
	public:
		...
		__vwsnc2_NewInterface_main_CreateEnumerator__vl_reflection_description_IValueEnumerator(::vl::vint64_t __vwsnctor_begin, ::vl::vint64_t __vwsnctor_end, ::vl::reflection::description::IValueEnumerable* __vwsnctorthis_0);
