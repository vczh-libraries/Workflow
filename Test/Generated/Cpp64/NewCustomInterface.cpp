...
***********************************************************************/
	...
	__vwsnc1_NewCustomInterface_main__IMyInterface::__vwsnc1_NewCustomInterface_main__IMyInterface(::vl::vint64_t __vwsnctor_begin, ::vl::vint64_t __vwsnctor_end)
	...
	::vl::vint64_t __vwsnc1_NewCustomInterface_main__IMyInterface::Get100()
	{
		return (::IMyInterface::Get50() * static_cast<::vl::vint64_t>(2L));
	}

	//-------------------------------------------------------------------

	__vwsnc2_NewCustomInterface_main_CreateEnumerator__vl_reflection_description_IValueEnumerator::__vwsnc2_NewCustomInterface_main_CreateEnumerator__vl_reflection_description_IValueEnumerator(::vl::vint64_t __vwsnctor_begin, ::vl::vint64_t __vwsnctor_end, ::IMyInterface* __vwsnctorthis_0)
		:begin(__vwsnctor_begin)
		, end(__vwsnctor_end)
	...
	::vl::vint64_t __vwsnc2_NewCustomInterface_main_CreateEnumerator__vl_reflection_description_IValueEnumerator::GetIndex()
	{
		return index;
	}
...
::vl::vint64_t IMyInterface::Get50()
{
