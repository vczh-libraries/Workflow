...
***********************************************************************/
	...
	::vl::vint64_t RecursiveFunction::Fib(::vl::vint64_t n)
	{
		return ((n <= static_cast<::vl::vint64_t>(2L)) ? static_cast<::vl::vint64_t>(1L) : (GLOBAL_NAME Fib((n - static_cast<::vl::vint64_t>(1L))) + GLOBAL_NAME Fib((n - static_cast<::vl::vint64_t>(2L)))));
	}

	::vl::WString RecursiveFunction::main()
	{
		return ((((((((::vl::__vwsn::ToString(GLOBAL_NAME Fib(static_cast<::vl::vint64_t>(1L))) + ::vl::WString::Unmanaged(L", ")) + ::vl::__vwsn::ToString(GLOBAL_NAME Fib(static_cast<::vl::vint64_t>(2L)))) + ::vl::WString::Unmanaged(L", ")) + ::vl::__vwsn::ToString(GLOBAL_NAME Fib(static_cast<::vl::vint64_t>(3L)))) + ::vl::WString::Unmanaged(L", ")) + ::vl::__vwsn::ToString(GLOBAL_NAME Fib(static_cast<::vl::vint64_t>(4L)))) + ::vl::WString::Unmanaged(L", ")) + ::vl::__vwsn::ToString(GLOBAL_NAME Fib(static_cast<::vl::vint64_t>(5L))));
	}
