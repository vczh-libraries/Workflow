...
#define _ ,
			BEGIN_CLASS_MEMBER(::workflow::hints::Base)
				...
				CLASS_MEMBER_CONSTRUCTOR(::workflow::hints::Base*(::vl::vint64_t), { L"x" })
			...
			BEGIN_CLASS_MEMBER(::workflow::hints::Derived)
				...
				CLASS_MEMBER_CONSTRUCTOR(::workflow::hints::Derived*(::vl::vint64_t), { L"x" })
...
#undef _
			...
			bool LoadWorkflowHintsTypes()
			{
				...
				{
					return manager->AddTypeLoader(Ptr(new WorkflowHintsTypeLoader));
				}
#endif
				return false;
			}
