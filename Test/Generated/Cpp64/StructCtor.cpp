...
***********************************************************************/
	...
	::vl::vint64_t StructCtor::Do(::test::Point p)
	{
		return (p.x + p.y);
	}
	...
	{
		auto a = [&](){ ::test::Point __vwsn_temp__; __vwsn_temp__.x = static_cast<::vl::vint64_t>(1L); __vwsn_temp__.y = static_cast<::vl::vint64_t>(2L); return __vwsn_temp__; }();
		auto b = [&](){ ::test::Point __vwsn_temp__; __vwsn_temp__.x = static_cast<::vl::vint64_t>(3L); __vwsn_temp__.y = static_cast<::vl::vint64_t>(4L); return __vwsn_temp__; }();
		return ::vl::__vwsn::ToString(((GLOBAL_NAME Do(a) + GLOBAL_NAME Do(b)) + GLOBAL_NAME Do([&](){ ::test::Point __vwsn_temp__; __vwsn_temp__.x = static_cast<::vl::vint64_t>(5L); __vwsn_temp__.y = static_cast<::vl::vint64_t>(6L); return __vwsn_temp__; }())));
	}
