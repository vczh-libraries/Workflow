...
***********************************************************************/
	...
	__vwsnc1_CoSmcSwitchIR1_SMSwitchIR1___vwsn_state_CreateCoroutine__vl_reflection_description_ICoroutine::__vwsnc1_CoSmcSwitchIR1_SMSwitchIR1___vwsn_state_CreateCoroutine__vl_reflection_description_ICoroutine(::vl::Ptr<::vl::reflection::description::ICoroutine> __vwsnctor___vwsn_state_previousCoroutine, ::vl::vint64_t __vwsnctor___vwsn_state_startState, ::SMSwitchIR1* __vwsnctor___vwsn_state_stateMachineObject, ::SMSwitchIR1* __vwsnctorthis_0)
		...
		, __vwsnthis_0(::vl::__vwsn::This(__vwsnctorthis_0))
	{
		...
		this->__vwsn_co2_state_currentState = static_cast<::vl::vint64_t>(0L);
		this->__vwsn_co3_state_state = static_cast<::vl::vint64_t>(0L);
		...
		{
			{
				if ((__vwsn_co_state_before_pause_ != (- static_cast<::vl::vint64_t>(1L))))
				{
					...
					{
						if (((__vwsn_co_state_before_pause_ == static_cast<::vl::vint64_t>(0L)) || [&](auto __vwsn_1){ return (static_cast<::vl::vint64_t>(3L) <=  __vwsn_1 && __vwsn_1 <= static_cast<::vl::vint64_t>(7L)); }(__vwsn_co_state_before_pause_)))
						{
							(__vwsn_co_state_before_pause_ = (- static_cast<::vl::vint64_t>(1L)));
					...
					{
						{
							...
							if ((__vwsn_co_state_ == static_cast<::vl::vint64_t>(4L)))
							{
								...
								(__vwsn_co3_state_state = (- static_cast<::vl::vint64_t>(1L)));
								(__vwsn_co1_switch_1 = __vwsn_co2_state_currentState);
								if ((__vwsn_co1_switch_1 == static_cast<::vl::vint64_t>(0L)))
								{
...
void SMSwitchIR1::__vwsn_state_CreateCoroutine(::vl::vint64_t __vwsn_state_startState)
{
