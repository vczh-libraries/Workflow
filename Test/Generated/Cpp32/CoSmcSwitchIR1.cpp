...
#include "CoSmcSwitchIR1.h"
/* CodePack:BeginIgnore() */
#ifndef VCZH_DEBUG_NO_REFLECTION
/* CodePack:ConditionOff(VCZH_DEBUG_NO_REFLECTION, CoSmcSwitchIR1Reflection.h) */
...
#define GLOBAL_SYMBOL ::vl_workflow_global::CoSmcSwitchIR1::
#define GLOBAL_NAME ::vl_workflow_global::CoSmcSwitchIR1::Instance().
#define GLOBAL_OBJ &::vl_workflow_global::CoSmcSwitchIR1::Instance()

/***********************************************************************
Global Variables
***********************************************************************/

BEGIN_GLOBAL_STORAGE_CLASS(vl_workflow_global_CoSmcSwitchIR1)
	vl_workflow_global::CoSmcSwitchIR1 instance;
...
END_GLOBAL_STORAGE_CLASS(vl_workflow_global_CoSmcSwitchIR1)
...
***********************************************************************/
	...
	::vl::WString CoSmcSwitchIR1::main()
	{
		auto sm = ::vl::Ptr<::SMSwitchIR1>(new ::SMSwitchIR1());
		try
		{
			{
	...
	CoSmcSwitchIR1& CoSmcSwitchIR1::Instance()
	{
		return Getvl_workflow_global_CoSmcSwitchIR1().instance;
	}
...
***********************************************************************/
	...
	__vwsnc1_CoSmcSwitchIR1_SMSwitchIR1___vwsn_state_CreateCoroutine__vl_reflection_description_ICoroutine::__vwsnc1_CoSmcSwitchIR1_SMSwitchIR1___vwsn_state_CreateCoroutine__vl_reflection_description_ICoroutine(::vl::Ptr<::vl::reflection::description::ICoroutine> __vwsnctor___vwsn_state_previousCoroutine, ::vl::vint32_t __vwsnctor___vwsn_state_startState, ::SMSwitchIR1* __vwsnctor___vwsn_state_stateMachineObject, ::SMSwitchIR1* __vwsnctorthis_0)
		...
		, __vwsnthis_0(::vl::__vwsn::This(__vwsnctorthis_0))
	{
		...
		this->__vwsn_co2_state_currentState = static_cast<::vl::vint32_t>(0);
		this->__vwsn_co3_state_state = static_cast<::vl::vint32_t>(0);
	...
	::vl::Ptr<::vl::reflection::description::IValueException> __vwsnc1_CoSmcSwitchIR1_SMSwitchIR1___vwsn_state_CreateCoroutine__vl_reflection_description_ICoroutine::GetFailure()
	{
		return __vwsn_prop_Failure;
	}
	void __vwsnc1_CoSmcSwitchIR1_SMSwitchIR1___vwsn_state_CreateCoroutine__vl_reflection_description_ICoroutine::SetFailure(::vl::Ptr<::vl::reflection::description::IValueException> __vwsn_value_)
	{
		(__vwsn_prop_Failure = __vwsn_value_);
	}

	::vl::reflection::description::CoroutineStatus __vwsnc1_CoSmcSwitchIR1_SMSwitchIR1___vwsn_state_CreateCoroutine__vl_reflection_description_ICoroutine::GetStatus()
	{
		return __vwsn_prop_Status;
	}
	void __vwsnc1_CoSmcSwitchIR1_SMSwitchIR1___vwsn_state_CreateCoroutine__vl_reflection_description_ICoroutine::SetStatus(::vl::reflection::description::CoroutineStatus __vwsn_value_)
	{
		(__vwsn_prop_Status = __vwsn_value_);
	}

	void __vwsnc1_CoSmcSwitchIR1_SMSwitchIR1___vwsn_state_CreateCoroutine__vl_reflection_description_ICoroutine::Resume(bool __vwsn_raise_exception_, ::vl::Ptr<::vl::reflection::description::CoroutineResult> __vwsn_coroutine_output_)
	{
		...
		{
			{
				if ((__vwsn_co_state_before_pause_ != (- static_cast<::vl::vint32_t>(1))))
				{
					...
					{
						if (((__vwsn_co_state_before_pause_ == static_cast<::vl::vint32_t>(0)) || [&](auto __vwsn_1){ return (static_cast<::vl::vint32_t>(3) <=  __vwsn_1 && __vwsn_1 <= static_cast<::vl::vint32_t>(7)); }(__vwsn_co_state_before_pause_)))
						{
							(__vwsn_co_state_before_pause_ = (- static_cast<::vl::vint32_t>(1)));
					...
					{
						{
							...
							if ((__vwsn_co_state_ == static_cast<::vl::vint32_t>(4)))
							{
								...
								(__vwsn_co3_state_state = (- static_cast<::vl::vint32_t>(1)));
								(__vwsn_co1_switch_1 = __vwsn_co2_state_currentState);
								if ((__vwsn_co1_switch_1 == static_cast<::vl::vint32_t>(0)))
								{
...
void SMSwitchIR1::__vwsn_state_CreateCoroutine(::vl::vint32_t __vwsn_state_startState)
{
	...
	(::vl::__vwsn::This(__vwsn_state_stateMachineObject)->stateMachineCoroutine = ::vl::Ptr<::vl::reflection::description::ICoroutine>(new ::vl_workflow_global::__vwsnc1_CoSmcSwitchIR1_SMSwitchIR1___vwsn_state_CreateCoroutine__vl_reflection_description_ICoroutine(__vwsn_state_previousCoroutine, __vwsn_state_startState, __vwsn_state_stateMachineObject, this)));
}

SMSwitchIR1::SMSwitchIR1()
{
}
