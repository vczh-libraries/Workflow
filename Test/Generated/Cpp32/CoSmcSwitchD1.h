...
#ifndef VCZH_WORKFLOW_COMPILER_GENERATED_COSMCSWITCHD1
#define VCZH_WORKFLOW_COMPILER_GENERATED_COSMCSWITCHD1
...
{
	class __vwsnc1_CoSmcSwitchD1_SMSwitchD1___vwsn_state_CreateCoroutine__vl_reflection_description_ICoroutine;
}

class SMSwitchD1;

class SMSwitchD1 : public ::vl::reflection::description::StateMachine, public ::vl::reflection::Description<SMSwitchD1>
{
	friend class ::vl_workflow_global::__vwsnc1_CoSmcSwitchD1_SMSwitchD1___vwsn_state_CreateCoroutine__vl_reflection_description_ICoroutine;
#ifdef VCZH_DESCRIPTABLEOBJECT_WITH_METADATA
	friend struct ::vl::reflection::description::CustomTypeDescriptorSelector<SMSwitchD1>;
#endif
public:
	void A();
	void B();
...
***********************************************************************/
	...
	class __vwsnc1_CoSmcSwitchD1_SMSwitchD1___vwsn_state_CreateCoroutine__vl_reflection_description_ICoroutine : public ::vl::Object, public virtual ::vl::reflection::description::ICoroutine
	{
	public:
		::vl::Ptr<::vl::reflection::description::ICoroutine> __vwsn_state_previousCoroutine;
		::vl::vint32_t __vwsn_state_startState;
		::SMSwitchD1* __vwsn_state_stateMachineObject;
		::SMSwitchD1* __vwsnthis_0;
