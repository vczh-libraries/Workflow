...
***********************************************************************/
	...
	{
		auto result = static_cast<::vl::vint32_t>(0);
		{
	...
	::vl::vint32_t ControlFlow::Sum3(::vl::vint32_t start, ::vl::vint32_t end)
	{
		...
		while ((current <= end))
		{
			...
			(current = (current + static_cast<::vl::vint32_t>(1)));
		}
		return result;
	}
		...
		{
			{
				...
				if ((__vwsn_switch_0 == (end + static_cast<::vl::vint32_t>(1))))
				{
					(needToExit = true);
				}
				else
	...
	{
		return ((((((((::vl::__vwsn::ToString(GLOBAL_NAME Sum1(static_cast<::vl::vint32_t>(1), static_cast<::vl::vint32_t>(10))) + ::vl::WString::Unmanaged(L", ")) + ::vl::__vwsn::ToString(GLOBAL_NAME Sum2(static_cast<::vl::vint32_t>(1), static_cast<::vl::vint32_t>(10)))) + ::vl::WString::Unmanaged(L", ")) + ::vl::__vwsn::ToString(GLOBAL_NAME Sum3(static_cast<::vl::vint32_t>(1), static_cast<::vl::vint32_t>(10)))) + ::vl::WString::Unmanaged(L", ")) + ::vl::__vwsn::ToString(GLOBAL_NAME Sum4(static_cast<::vl::vint32_t>(1), static_cast<::vl::vint32_t>(10)))) + ::vl::WString::Unmanaged(L", ")) + ::vl::__vwsn::ToString(GLOBAL_NAME Sum5(static_cast<::vl::vint32_t>(1), static_cast<::vl::vint32_t>(10))));
	}
