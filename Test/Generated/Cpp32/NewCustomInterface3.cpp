...
***********************************************************************/
	...
	{
		auto x = ::vl::Ptr<::MyClass>(new ::MyClass(static_cast<::vl::vint32_t>(1), static_cast<::vl::vint32_t>(5)));
...
***********************************************************************/
	...
	{
		return (::MyClass::Get50() * static_cast<::vl::vint32_t>(2));
	}
...
MyClass::MyClass(::vl::vint32_t _begin, ::vl::vint32_t _end)
	: begin((- static_cast<::vl::vint32_t>(1)))
	, end((- static_cast<::vl::vint32_t>(1)))
{
	(this->begin = _begin);
	(this->end = _end);
}
