...
***********************************************************************/
	...
	{
		(GLOBAL_NAME s = ((((::vl::WString::Unmanaged(L"") + GLOBAL_NAME s) + ::vl::WString::Unmanaged(L"[")) + ::vl::__vwsn::ToString(::vl::__vwsn::Unbox<::vl::vint32_t>(value))) + ::vl::WString::Unmanaged(L"]")));
	}
	...
	::vl::WString BindLet::main()
	{
		...
		::vl::__vwsn::This(x.Obj())->Setbar(::vl::Ptr<::Bar>(new ::Bar(static_cast<::vl::vint32_t>(1))));
		::vl::__vwsn::This(::vl::__vwsn::This(x.Obj())->Getbar().Obj())->Setvalue(static_cast<::vl::vint32_t>(2));
		::vl::__vwsn::This(y.Obj())->Setbar(::vl::Ptr<::Bar>(new ::Bar(static_cast<::vl::vint32_t>(10))));
		::vl::__vwsn::This(::vl::__vwsn::This(y.Obj())->Getbar().Obj())->Setvalue(static_cast<::vl::vint32_t>(20));
		::vl::__vwsn::This(z.Obj())->Setbar(::vl::Ptr<::Bar>(new ::Bar(static_cast<::vl::vint32_t>(100))));
		::vl::__vwsn::This(::vl::__vwsn::This(z.Obj())->Getbar().Obj())->Setvalue(static_cast<::vl::vint32_t>(200));
