...
***********************************************************************/
	...
	{
		return ((n <= static_cast<::vl::vint32_t>(2)) ? static_cast<::vl::vint32_t>(1) : (GLOBAL_NAME Fib((n - static_cast<::vl::vint32_t>(1))) + GLOBAL_NAME Fib((n - static_cast<::vl::vint32_t>(2)))));
	}

	::vl::WString RecursiveFunction::main()
	{
		return ((((((((::vl::__vwsn::ToString(GLOBAL_NAME Fib(static_cast<::vl::vint32_t>(1))) + ::vl::WString::Unmanaged(L", ")) + ::vl::__vwsn::ToString(GLOBAL_NAME Fib(static_cast<::vl::vint32_t>(2)))) + ::vl::WString::Unmanaged(L", ")) + ::vl::__vwsn::ToString(GLOBAL_NAME Fib(static_cast<::vl::vint32_t>(3)))) + ::vl::WString::Unmanaged(L", ")) + ::vl::__vwsn::ToString(GLOBAL_NAME Fib(static_cast<::vl::vint32_t>(4)))) + ::vl::WString::Unmanaged(L", ")) + ::vl::__vwsn::ToString(GLOBAL_NAME Fib(static_cast<::vl::vint32_t>(5))));
	}
