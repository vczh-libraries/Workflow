...
***********************************************************************/
	...
	::vl::WString NamedLambda::main()
	{
		...
		return ((((((((::vl::__vwsn::ToString(fib(static_cast<::vl::vint32_t>(1))) + ::vl::WString::Unmanaged(L", ")) + ::vl::__vwsn::ToString(fib(static_cast<::vl::vint32_t>(2)))) + ::vl::WString::Unmanaged(L", ")) + ::vl::__vwsn::ToString(fib(static_cast<::vl::vint32_t>(3)))) + ::vl::WString::Unmanaged(L", ")) + ::vl::__vwsn::ToString(fib(static_cast<::vl::vint32_t>(4)))) + ::vl::WString::Unmanaged(L", ")) + ::vl::__vwsn::ToString(fib(static_cast<::vl::vint32_t>(5))));
	}
...
***********************************************************************/
	...
	::vl::vint32_t __vwsnf1_NamedLambda_main_::operator()(::vl::vint32_t n) const
	{
		...
		return ((n <= static_cast<::vl::vint32_t>(2)) ? static_cast<::vl::vint32_t>(1) : ((*this)((n - static_cast<::vl::vint32_t>(1))) + fib2((n - static_cast<::vl::vint32_t>(2)))));
	}
}
