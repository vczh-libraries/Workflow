...
***********************************************************************/
	...
	{
		auto f = GLOBAL_NAME Adder(static_cast<::vl::vint32_t>(1));
		auto g = GLOBAL_NAME Adder(static_cast<::vl::vint32_t>(2));
		return ((((((::vl::__vwsn::ToString(f(static_cast<::vl::vint32_t>(1))) + ::vl::WString::Unmanaged(L", ")) + ::vl::__vwsn::ToString(f(static_cast<::vl::vint32_t>(2)))) + ::vl::WString::Unmanaged(L", ")) + ::vl::__vwsn::ToString(g(static_cast<::vl::vint32_t>(1)))) + ::vl::WString::Unmanaged(L", ")) + ::vl::__vwsn::ToString(g(static_cast<::vl::vint32_t>(2))));
	}
...
***********************************************************************/
	...
	{
		return ((__vwsno_1 * static_cast<::vl::vint32_t>(0)) + GLOBAL_NAME Apply(vl::Func(::vl_workflow_global::__vwsno2_OrderedLambda_Adder_(__vwsno_1)), x));
	}
