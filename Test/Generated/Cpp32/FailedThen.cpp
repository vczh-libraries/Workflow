...
***********************************************************************/
	...
	{
		return (((::vl::WString::Unmanaged(L"") + ::vl::__vwsn::ToString(GLOBAL_NAME GetValue(::vl::Ptr<::test::ObservableValue>(), static_cast<::vl::vint32_t>(10), (- static_cast<::vl::vint32_t>(1))))) + ::vl::WString::Unmanaged(L", ")) + ::vl::__vwsn::ToString(GLOBAL_NAME GetValue(::vl::Ptr<::test::ObservableValue>(new ::test::ObservableValue(static_cast<::vl::vint32_t>(100))), static_cast<::vl::vint32_t>(10), (- static_cast<::vl::vint32_t>(1)))));
	}
