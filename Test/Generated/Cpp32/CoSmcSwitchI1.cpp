...
/* CodePack:ConditionOff(VCZH_DEBUG_NO_REFLECTION, CoSmcSwitchI1Reflection.h) */
...
#define GLOBAL_SYMBOL ::vl_workflow_global::CoSmcSwitchI1::
#define GLOBAL_NAME ::vl_workflow_global::CoSmcSwitchI1::Instance().
#define GLOBAL_OBJ &::vl_workflow_global::CoSmcSwitchI1::Instance()

/***********************************************************************
Global Variables
***********************************************************************/

BEGIN_GLOBAL_STORAGE_CLASS(vl_workflow_global_CoSmcSwitchI1)
	vl_workflow_global::CoSmcSwitchI1 instance;
...
END_GLOBAL_STORAGE_CLASS(vl_workflow_global_CoSmcSwitchI1)
...
***********************************************************************/
	...
	::vl::WString CoSmcSwitchI1::main()
	{
		auto sm = ::vl::Ptr<::SMSwitchI1>(new ::SMSwitchI1());
		try
		{
			{
	...
	CoSmcSwitchI1& CoSmcSwitchI1::Instance()
	{
		return Getvl_workflow_global_CoSmcSwitchI1().instance;
	}
...
***********************************************************************/
	...
	__vwsnc1_CoSmcSwitchI1_SMSwitchI1___vwsn_state_CreateCoroutine__vl_reflection_description_ICoroutine::__vwsnc1_CoSmcSwitchI1_SMSwitchI1___vwsn_state_CreateCoroutine__vl_reflection_description_ICoroutine(::vl::Ptr<::vl::reflection::description::ICoroutine> __vwsnctor___vwsn_state_previousCoroutine, ::vl::vint32_t __vwsnctor___vwsn_state_startState, ::SMSwitchI1* __vwsnctor___vwsn_state_stateMachineObject, ::SMSwitchI1* __vwsnctorthis_0)
	...
	::vl::Ptr<::vl::reflection::description::IValueException> __vwsnc1_CoSmcSwitchI1_SMSwitchI1___vwsn_state_CreateCoroutine__vl_reflection_description_ICoroutine::GetFailure()
	{
		return __vwsn_prop_Failure;
	}
	void __vwsnc1_CoSmcSwitchI1_SMSwitchI1___vwsn_state_CreateCoroutine__vl_reflection_description_ICoroutine::SetFailure(::vl::Ptr<::vl::reflection::description::IValueException> __vwsn_value_)
	{
		(__vwsn_prop_Failure = __vwsn_value_);
	}

	::vl::reflection::description::CoroutineStatus __vwsnc1_CoSmcSwitchI1_SMSwitchI1___vwsn_state_CreateCoroutine__vl_reflection_description_ICoroutine::GetStatus()
	{
		return __vwsn_prop_Status;
	}
	void __vwsnc1_CoSmcSwitchI1_SMSwitchI1___vwsn_state_CreateCoroutine__vl_reflection_description_ICoroutine::SetStatus(::vl::reflection::description::CoroutineStatus __vwsn_value_)
	{
		(__vwsn_prop_Status = __vwsn_value_);
	}

	void __vwsnc1_CoSmcSwitchI1_SMSwitchI1___vwsn_state_CreateCoroutine__vl_reflection_description_ICoroutine::Resume(bool __vwsn_raise_exception_, ::vl::Ptr<::vl::reflection::description::CoroutineResult> __vwsn_coroutine_output_)
	{
...
void SMSwitchI1::__vwsn_state_CreateCoroutine(::vl::vint32_t __vwsn_state_startState)
{
	...
	(::vl::__vwsn::This(__vwsn_state_stateMachineObject)->stateMachineCoroutine = ::vl::Ptr<::vl::reflection::description::ICoroutine>(new ::vl_workflow_global::__vwsnc1_CoSmcSwitchI1_SMSwitchI1___vwsn_state_CreateCoroutine__vl_reflection_description_ICoroutine(__vwsn_state_previousCoroutine, __vwsn_state_startState, __vwsn_state_stateMachineObject, this)));
}

SMSwitchI1::SMSwitchI1()
{
}
