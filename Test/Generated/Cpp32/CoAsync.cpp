...
***********************************************************************/
	...
	::vl::Ptr<::CoAsync_types::IStringAsync> CoAsync::GetStringAsync(::vl::vint32_t x)
	{
	...
	::vl::Ptr<::CoAsync_types::IStringAsync> CoAsync::GetStringAsync2(::vl::vint32_t x)
	{
...
***********************************************************************/
		...
		:__vwsn_co_impl_(__vwsnctor___vwsn_co_impl_)
	{
		...
		this->__vwsn_co2_for_begin_i = static_cast<::vl::vint32_t>(0);
		this->__vwsn_co3_for_end_i = static_cast<::vl::vint32_t>(0);
		this->__vwsn_co4_i = static_cast<::vl::vint32_t>(0);
		this->__vwsn_co_state_ = static_cast<::vl::vint32_t>(0);
		this->__vwsn_co_state_before_pause_ = (- static_cast<::vl::vint32_t>(1));
		this->__vwsn_prop_Failure = ::vl::Ptr<::vl::reflection::description::IValueException>();
		this->__vwsn_prop_Status = ::vl::reflection::description::CoroutineStatus::Waiting;
		...
		{
			{
				...
				while (true)
				{
					if ((__vwsn_co_state_ == static_cast<::vl::vint32_t>(0)))
					{
						(__vwsn_co2_for_begin_i = static_cast<::vl::vint32_t>(0));
						(__vwsn_co3_for_end_i = static_cast<::vl::vint32_t>(1));
					...
					if ((__vwsn_co_state_ == static_cast<::vl::vint32_t>(2)))
					{
						...
						(__vwsn_co4_i = (__vwsn_co4_i + static_cast<::vl::vint32_t>(1)));
						if ((__vwsn_co4_i <= __vwsn_co3_for_end_i))
						{
							(__vwsn_co_state_ = static_cast<::vl::vint32_t>(3));
							continue;
					...
					if ((__vwsn_co_state_ == static_cast<::vl::vint32_t>(7)))
					{
						...
						{
							::vl::reflection::description::AsyncCoroutine::AwaitAndRead(__vwsn_co_impl_, ::vl::reflection::description::IAsync::Delay(static_cast<::vl::vint32_t>(0)));
						}
						return;
					}
				}
