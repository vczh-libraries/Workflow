...
#include "CoSmcSwitchD2.h"
/* CodePack:BeginIgnore() */
#ifndef VCZH_DEBUG_NO_REFLECTION
/* CodePack:ConditionOff(VCZH_DEBUG_NO_REFLECTION, CoSmcSwitchD2Reflection.h) */
...
#define GLOBAL_SYMBOL ::vl_workflow_global::CoSmcSwitchD2::
#define GLOBAL_NAME ::vl_workflow_global::CoSmcSwitchD2::Instance().
#define GLOBAL_OBJ &::vl_workflow_global::CoSmcSwitchD2::Instance()

/***********************************************************************
Global Variables
***********************************************************************/

BEGIN_GLOBAL_STORAGE_CLASS(vl_workflow_global_CoSmcSwitchD2)
	vl_workflow_global::CoSmcSwitchD2 instance;
...
END_GLOBAL_STORAGE_CLASS(vl_workflow_global_CoSmcSwitchD2)
...
***********************************************************************/
	...
	::vl::WString CoSmcSwitchD2::main()
	{
		auto sm = ::vl::Ptr<::SMSwitchD2>(new ::SMSwitchD2());
		try
		{
			{
	...
	CoSmcSwitchD2& CoSmcSwitchD2::Instance()
	{
		return Getvl_workflow_global_CoSmcSwitchD2().instance;
	}
...
***********************************************************************/
	...
	__vwsnc1_CoSmcSwitchD2_SMSwitchD2___vwsn_state_CreateCoroutine__vl_reflection_description_ICoroutine::__vwsnc1_CoSmcSwitchD2_SMSwitchD2___vwsn_state_CreateCoroutine__vl_reflection_description_ICoroutine(::vl::Ptr<::vl::reflection::description::ICoroutine> __vwsnctor___vwsn_state_previousCoroutine, ::vl::vint32_t __vwsnctor___vwsn_state_startState, ::SMSwitchD2* __vwsnctor___vwsn_state_stateMachineObject, ::SMSwitchD2* __vwsnctorthis_0)
		...
		, __vwsnthis_0(::vl::__vwsn::This(__vwsnctorthis_0))
	{
		...
		this->__vwsn_co0_switch_1 = static_cast<::vl::vint32_t>(0);
	...
	::vl::Ptr<::vl::reflection::description::IValueException> __vwsnc1_CoSmcSwitchD2_SMSwitchD2___vwsn_state_CreateCoroutine__vl_reflection_description_ICoroutine::GetFailure()
	{
		return __vwsn_prop_Failure;
	}
	void __vwsnc1_CoSmcSwitchD2_SMSwitchD2___vwsn_state_CreateCoroutine__vl_reflection_description_ICoroutine::SetFailure(::vl::Ptr<::vl::reflection::description::IValueException> __vwsn_value_)
	{
		(__vwsn_prop_Failure = __vwsn_value_);
	}

	::vl::reflection::description::CoroutineStatus __vwsnc1_CoSmcSwitchD2_SMSwitchD2___vwsn_state_CreateCoroutine__vl_reflection_description_ICoroutine::GetStatus()
	{
		return __vwsn_prop_Status;
	}
	void __vwsnc1_CoSmcSwitchD2_SMSwitchD2___vwsn_state_CreateCoroutine__vl_reflection_description_ICoroutine::SetStatus(::vl::reflection::description::CoroutineStatus __vwsn_value_)
	{
		(__vwsn_prop_Status = __vwsn_value_);
	}

	void __vwsnc1_CoSmcSwitchD2_SMSwitchD2___vwsn_state_CreateCoroutine__vl_reflection_description_ICoroutine::Resume(bool __vwsn_raise_exception_, ::vl::Ptr<::vl::reflection::description::CoroutineResult> __vwsn_coroutine_output_)
	{
		...
		{
			{
				if ((__vwsn_co_state_before_pause_ != (- static_cast<::vl::vint32_t>(1))))
				{
					...
					{
						if (((__vwsn_co_state_before_pause_ == static_cast<::vl::vint32_t>(0)) || [&](auto __vwsn_1){ return (static_cast<::vl::vint32_t>(3) <=  __vwsn_1 && __vwsn_1 <= static_cast<::vl::vint32_t>(5)); }(__vwsn_co_state_before_pause_)))
						{
							(__vwsn_co_state_before_pause_ = (- static_cast<::vl::vint32_t>(1)));
					...
					{
						{
							...
							if ((__vwsn_co_state_ == static_cast<::vl::vint32_t>(4)))
							{
								...
								if ((__vwsn_co0_switch_1 == static_cast<::vl::vint32_t>(0)))
								{
							...
							{
								{
									...
									{
										(::vl::__vwsn::This(this->__vwsn_state_stateMachineObject)->stateMachineInput = (- static_cast<::vl::vint32_t>(1)));
										throw ::vl::Exception(::vl::WString::Unmanaged(L"Method \"B\" of class \"SMSwitchD2\" cannot be called at this moment."));
									}
								}
								(GLOBAL_NAME s = ((::vl::WString::Unmanaged(L"") + GLOBAL_NAME s) + ::vl::WString::Unmanaged(L".")));
								(__vwsn_co_state_ = static_cast<::vl::vint32_t>(6));
...
void SMSwitchD2::__vwsn_state_CreateCoroutine(::vl::vint32_t __vwsn_state_startState)
{
	...
	(::vl::__vwsn::This(__vwsn_state_stateMachineObject)->stateMachineCoroutine = ::vl::Ptr<::vl::reflection::description::ICoroutine>(new ::vl_workflow_global::__vwsnc1_CoSmcSwitchD2_SMSwitchD2___vwsn_state_CreateCoroutine__vl_reflection_description_ICoroutine(__vwsn_state_previousCoroutine, __vwsn_state_startState, __vwsn_state_stateMachineObject, this)));
}

SMSwitchD2::SMSwitchD2()
{
}
