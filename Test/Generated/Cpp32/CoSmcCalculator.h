...
public:
	...
	void Calculate();
	::vl::vint32_t __vwsn_stateip_Digit_i;
	bool __vwsn_statesp_Integer_newNumber;
	void Digit(::vl::vint32_t i);
	void Dot();
	void Add();
	void Mul();
	void Equal();
...
***********************************************************************/
	...
	public:
		...
		::vl::vint32_t __vwsn_co0_i = 0;
		::vl::vint32_t __vwsn_co1_switch_0 = 0;
		::vl::vint32_t __vwsn_co2_i = 0;
		::vl::vint32_t __vwsn_co3_switch_1 = 0;
		bool __vwsn_co4_newNumber = false;
		::vl::vint32_t __vwsn_co5_switch_2 = 0;
		::vl::vint32_t __vwsn_co6_switch_4 = 0;
		::vl::vint32_t __vwsn_co7_state_currentState = 0;
		::vl::vint32_t __vwsn_co8_state_state = 0;
