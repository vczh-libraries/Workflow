...
***********************************************************************/
	...
	__vwsnc1_CoSmcGoto_SMGoto___vwsn_state_CreateCoroutine__vl_reflection_description_ICoroutine::__vwsnc1_CoSmcGoto_SMGoto___vwsn_state_CreateCoroutine__vl_reflection_description_ICoroutine(::vl::Ptr<::vl::reflection::description::ICoroutine> __vwsnctor___vwsn_state_previousCoroutine, ::vl::vint32_t __vwsnctor___vwsn_state_startState, ::SMGoto* __vwsnctor___vwsn_state_stateMachineObject, ::SMGoto* __vwsnctorthis_0)
		...
		{
			{
				if ((__vwsn_co_state_before_pause_ != (- static_cast<::vl::vint32_t>(1))))
				{
					...
					{
						if (((__vwsn_co_state_before_pause_ == static_cast<::vl::vint32_t>(0)) || [&](auto __vwsn_1){ return (static_cast<::vl::vint32_t>(3) <=  __vwsn_1 && __vwsn_1 <= static_cast<::vl::vint32_t>(8)); }(__vwsn_co_state_before_pause_)))
						{
							(__vwsn_co_state_before_pause_ = (- static_cast<::vl::vint32_t>(1)));
					...
					{
						{
							...
							{
								(__vwsn_co2_state_state = static_cast<::vl::vint32_t>(2));
								(__vwsn_co_state_ = static_cast<::vl::vint32_t>(3));
								continue;
...
void SMGoto::__vwsn_state_CreateCoroutine(::vl::vint32_t __vwsn_state_startState)
{
