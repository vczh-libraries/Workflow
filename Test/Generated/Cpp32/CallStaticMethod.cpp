...
***********************************************************************/
	...
	{
		return ::vl::__vwsn::ToString(::Calculator::Internal::Sum(static_cast<::vl::vint32_t>(1), static_cast<::vl::vint32_t>(10)));
	}
...
::vl::vint32_t Calculator::Sum2(::vl::vint32_t begin, ::vl::vint32_t end, ::vl::vint32_t sum)
{
	...
	{
		return ::Calculator::Sum2((begin + static_cast<::vl::vint32_t>(1)), end, (sum + begin));
	}
}
...
{
	return ::Calculator::Sum2(begin, end, static_cast<::vl::vint32_t>(0));
}
