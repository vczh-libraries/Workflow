...
#include "CoSmcSwitchP1.h"
/* CodePack:BeginIgnore() */
#ifndef VCZH_DEBUG_NO_REFLECTION
/* CodePack:ConditionOff(VCZH_DEBUG_NO_REFLECTION, CoSmcSwitchP1Reflection.h) */
...
#define GLOBAL_SYMBOL ::vl_workflow_global::CoSmcSwitchP1::
#define GLOBAL_NAME ::vl_workflow_global::CoSmcSwitchP1::Instance().
#define GLOBAL_OBJ &::vl_workflow_global::CoSmcSwitchP1::Instance()

/***********************************************************************
Global Variables
***********************************************************************/

BEGIN_GLOBAL_STORAGE_CLASS(vl_workflow_global_CoSmcSwitchP1)
	vl_workflow_global::CoSmcSwitchP1 instance;
...
END_GLOBAL_STORAGE_CLASS(vl_workflow_global_CoSmcSwitchP1)
...
***********************************************************************/
	...
	::vl::WString CoSmcSwitchP1::main()
	{
		auto sm = ::vl::Ptr<::SMSwitchP1>(new ::SMSwitchP1());
		try
		{
			{
	...
	CoSmcSwitchP1& CoSmcSwitchP1::Instance()
	{
		return Getvl_workflow_global_CoSmcSwitchP1().instance;
	}
...
***********************************************************************/
	...
	::vl::Ptr<::vl::reflection::description::IValueException> __vwsnc1_CoSmcSwitchP1_SMSwitchP1___vwsn_state_CreateCoroutine__vl_reflection_description_ICoroutine::GetFailure()
	{
		return __vwsn_prop_Failure;
	}
	void __vwsnc1_CoSmcSwitchP1_SMSwitchP1___vwsn_state_CreateCoroutine__vl_reflection_description_ICoroutine::SetFailure(::vl::Ptr<::vl::reflection::description::IValueException> __vwsn_value_)
	{
		(__vwsn_prop_Failure = __vwsn_value_);
	}

	::vl::reflection::description::CoroutineStatus __vwsnc1_CoSmcSwitchP1_SMSwitchP1___vwsn_state_CreateCoroutine__vl_reflection_description_ICoroutine::GetStatus()
	{
		return __vwsn_prop_Status;
	}
	void __vwsnc1_CoSmcSwitchP1_SMSwitchP1___vwsn_state_CreateCoroutine__vl_reflection_description_ICoroutine::SetStatus(::vl::reflection::description::CoroutineStatus __vwsn_value_)
	{
		(__vwsn_prop_Status = __vwsn_value_);
	}

	void __vwsnc1_CoSmcSwitchP1_SMSwitchP1___vwsn_state_CreateCoroutine__vl_reflection_description_ICoroutine::Resume(bool __vwsn_raise_exception_, ::vl::Ptr<::vl::reflection::description::CoroutineResult> __vwsn_coroutine_output_)
	{
...
void SMSwitchP1::__vwsn_state_CreateCoroutine(::vl::vint32_t __vwsn_state_startState)
{
	...
	(::vl::__vwsn::This(__vwsn_state_stateMachineObject)->stateMachineCoroutine = ::vl::Ptr<::vl::reflection::description::ICoroutine>(new ::vl_workflow_global::__vwsnc1_CoSmcSwitchP1_SMSwitchP1___vwsn_state_CreateCoroutine__vl_reflection_description_ICoroutine(__vwsn_state_previousCoroutine, __vwsn_state_startState, __vwsn_state_stateMachineObject, this)));
}

SMSwitchP1::SMSwitchP1()
{
}
