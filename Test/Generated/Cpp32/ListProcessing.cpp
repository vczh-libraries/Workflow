...
***********************************************************************/
	...
	::vl::WString ListProcessing::main()
	{
		...
		::vl::__vwsn::This(xs.Obj())->Set(static_cast<::vl::vint32_t>(4), ::vl::__vwsn::Box(static_cast<::vl::vint32_t>(6)));
		::vl::__vwsn::This(xs.Obj())->Add(::vl::__vwsn::Box(static_cast<::vl::vint32_t>(7)));
