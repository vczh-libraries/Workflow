...
***********************************************************************/
	...
	{
		auto x = [&](){ ::test::Point __vwsn_temp__; __vwsn_temp__.x = static_cast<::vl::vint32_t>(10); __vwsn_temp__.y = static_cast<::vl::vint32_t>(20); return __vwsn_temp__; }();
		auto y = ::vl::Ptr<::test::ObservableValue>(new ::test::ObservableValue(static_cast<::vl::vint32_t>(10)));
