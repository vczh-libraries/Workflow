...
***********************************************************************/
	...
	::vl::WString BindFormat::main()
	{
		...
		::vl::__vwsn::This(x.Obj())->SetValue(static_cast<::vl::vint32_t>(20));
		::vl::__vwsn::This(x.Obj())->SetValue(static_cast<::vl::vint32_t>(30));
