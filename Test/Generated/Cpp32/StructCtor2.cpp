...
***********************************************************************/
	...
	{
		auto a = [&](){ ::Point __vwsn_temp__; __vwsn_temp__.x = static_cast<::vl::vint32_t>(1); __vwsn_temp__.y = static_cast<::vl::vint32_t>(2); return __vwsn_temp__; }();
		auto b = [&](){ ::Point __vwsn_temp__; __vwsn_temp__.x = static_cast<::vl::vint32_t>(3); __vwsn_temp__.y = static_cast<::vl::vint32_t>(4); return __vwsn_temp__; }();
		return ::vl::__vwsn::ToString(((GLOBAL_NAME Do(a) + GLOBAL_NAME Do(b)) + GLOBAL_NAME Do([&](){ ::Point __vwsn_temp__; __vwsn_temp__.x = static_cast<::vl::vint32_t>(5); __vwsn_temp__.y = static_cast<::vl::vint32_t>(6); return __vwsn_temp__; }())));
	}
