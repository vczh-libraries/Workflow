...
***********************************************************************/
	...
	{
		return ::vl::reflection::description::GetLazyList<::vl::vint32_t>(::vl::reflection::description::EnumerableCoroutine::Create(vl::Func(::vl_workflow_global::__vwsnf1_CoEnum2_GetNumbers_())));
	}
		...
		{
			{
				...
				while (true)
				{
					if ((__vwsn_co_state_ == static_cast<::vl::vint32_t>(0)))
					{
						...
						(__vwsn_co1_for_end_i = static_cast<::vl::vint32_t>(10));
					...
					if ((__vwsn_co_state_ == static_cast<::vl::vint32_t>(3)))
					{
						...
						{
							::vl::reflection::description::EnumerableCoroutine::JoinAndPause(__vwsn_co_impl_, ::vl::__vwsn::UnboxCollection<::vl::reflection::description::IValueEnumerable>(::vl::__vwsn::Range(__vwsn_co2_i, (__vwsn_co2_i + static_cast<::vl::vint32_t>(2)) + 1)));
						}
						return;
					}
					if ((__vwsn_co_state_ == static_cast<::vl::vint32_t>(4)))
					{
						...
						if ((__vwsn_co2_i == static_cast<::vl::vint32_t>(2)))
						{
