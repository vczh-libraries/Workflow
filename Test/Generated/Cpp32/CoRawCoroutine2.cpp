		...
		{
			{
				if ((__vwsn_co_state_before_pause_ != (- static_cast<::vl::vint32_t>(1))))
				{
					...
					{
						if ((__vwsn_co_state_before_pause_ == static_cast<::vl::vint32_t>(4)))
						{
							(__vwsn_co_state_before_pause_ = (- static_cast<::vl::vint32_t>(1)));
							(__vwsn_co4_ex = ::vl::__vwsn::This(__vwsn_coroutine_output_.Obj())->GetFailure());
							(__vwsn_co_state_ = static_cast<::vl::vint32_t>(3));
						}
						else if ([&](auto __vwsn_1){ return (static_cast<::vl::vint32_t>(5) <=  __vwsn_1 && __vwsn_1 <= static_cast<::vl::vint32_t>(6)); }(__vwsn_co_state_before_pause_))
						{
							(__vwsn_co_state_before_pause_ = (- static_cast<::vl::vint32_t>(1)));
							(__vwsn_co4_ex = ::vl::__vwsn::This(__vwsn_coroutine_output_.Obj())->GetFailure());
