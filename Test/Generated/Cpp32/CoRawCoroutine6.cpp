...
Source: ../Resources/Codegen/CoRawCoroutine6.txt
...
#define GLOBAL_SYMBOL ::vl_workflow_global::CoRawCoroutine6::
#define GLOBAL_NAME ::vl_workflow_global::CoRawCoroutine6::Instance().
#define GLOBAL_OBJ &::vl_workflow_global::CoRawCoroutine6::Instance()

/***********************************************************************
Global Variables
***********************************************************************/

BEGIN_GLOBAL_STORAGE_CLASS(vl_workflow_global_CoRawCoroutine6)
	vl_workflow_global::CoRawCoroutine6 instance;
...
END_GLOBAL_STORAGE_CLASS(vl_workflow_global_CoRawCoroutine6)
...
***********************************************************************/
	...
	::vl::WString CoRawCoroutine6::main()
	{
		auto coroutine = ::vl::Ptr<::vl::reflection::description::ICoroutine>(new ::vl_workflow_global::__vwsnc1_CoRawCoroutine6_main__vl_reflection_description_ICoroutine());
		{
	...
	CoRawCoroutine6& CoRawCoroutine6::Instance()
	{
		return Getvl_workflow_global_CoRawCoroutine6().instance;
	}
...
***********************************************************************/
	...
	__vwsnc1_CoRawCoroutine6_main__vl_reflection_description_ICoroutine::__vwsnc1_CoRawCoroutine6_main__vl_reflection_description_ICoroutine()
	{
	...
	::vl::Ptr<::vl::reflection::description::IValueException> __vwsnc1_CoRawCoroutine6_main__vl_reflection_description_ICoroutine::GetFailure()
	{
		return __vwsn_prop_Failure;
	}
	void __vwsnc1_CoRawCoroutine6_main__vl_reflection_description_ICoroutine::SetFailure(::vl::Ptr<::vl::reflection::description::IValueException> __vwsn_value_)
	{
		(__vwsn_prop_Failure = __vwsn_value_);
	}

	::vl::reflection::description::CoroutineStatus __vwsnc1_CoRawCoroutine6_main__vl_reflection_description_ICoroutine::GetStatus()
	{
		return __vwsn_prop_Status;
	}
	void __vwsnc1_CoRawCoroutine6_main__vl_reflection_description_ICoroutine::SetStatus(::vl::reflection::description::CoroutineStatus __vwsn_value_)
	{
		(__vwsn_prop_Status = __vwsn_value_);
	}

	void __vwsnc1_CoRawCoroutine6_main__vl_reflection_description_ICoroutine::Resume(bool __vwsn_raise_exception_, ::vl::Ptr<::vl::reflection::description::CoroutineResult> __vwsn_coroutine_output_)
	{
		...
		{
			{
				...
				while (true)
				{
					if ((__vwsn_co_state_ == static_cast<::vl::vint32_t>(0)))
					{
						...
						(__vwsn_co1_for_end_i = (static_cast<::vl::vint32_t>(10) - static_cast<::vl::vint32_t>(1)));
					...
					{
						if ((__vwsn_co2_i < static_cast<::vl::vint32_t>(4)))
						{
