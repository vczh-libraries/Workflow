...
Source: ../Resources/Codegen/CoSmcSwitchP2.txt

This file is generated by Workflow compiler
https://github.com/vczh-libraries
***********************************************************************/

#include "CoSmcSwitchP2.h"
/* CodePack:BeginIgnore() */
#ifndef VCZH_DEBUG_NO_REFLECTION
/* CodePack:ConditionOff(VCZH_DEBUG_NO_REFLECTION, CoSmcSwitchP2Reflection.h) */
...
BEGIN_GLOBAL_STORAGE_CLASS(vl_workflow_global_CoSmcSwitchP2)
	vl_workflow_global::CoSmcSwitchP2 instance;
...
END_GLOBAL_STORAGE_CLASS(vl_workflow_global_CoSmcSwitchP2)
...
***********************************************************************/
	...
	::vl::WString CoSmcSwitchP2::main()
	{
		auto sm = ::vl::Ptr<::SMSwitchP2>(new ::SMSwitchP2());
		try
		{
			{
	...
	CoSmcSwitchP2& CoSmcSwitchP2::Instance()
	{
		return Getvl_workflow_global_CoSmcSwitchP2().instance;
	}
...
***********************************************************************/
	...
	__vwsnc1_CoSmcSwitchP2_SMSwitchP2___vwsn_state_CreateCoroutine__vl_reflection_description_ICoroutine::__vwsnc1_CoSmcSwitchP2_SMSwitchP2___vwsn_state_CreateCoroutine__vl_reflection_description_ICoroutine(::vl::Ptr<::vl::reflection::description::ICoroutine> __vwsnctor___vwsn_state_previousCoroutine, ::vl::vint32_t __vwsnctor___vwsn_state_startState, ::SMSwitchP2* __vwsnctor___vwsn_state_stateMachineObject, ::SMSwitchP2* __vwsnctorthis_0)
	...
	::vl::Ptr<::vl::reflection::description::IValueException> __vwsnc1_CoSmcSwitchP2_SMSwitchP2___vwsn_state_CreateCoroutine__vl_reflection_description_ICoroutine::GetFailure()
	{
		return __vwsn_prop_Failure;
	}
	void __vwsnc1_CoSmcSwitchP2_SMSwitchP2___vwsn_state_CreateCoroutine__vl_reflection_description_ICoroutine::SetFailure(::vl::Ptr<::vl::reflection::description::IValueException> __vwsn_value_)
	{
		(__vwsn_prop_Failure = __vwsn_value_);
	}

	::vl::reflection::description::CoroutineStatus __vwsnc1_CoSmcSwitchP2_SMSwitchP2___vwsn_state_CreateCoroutine__vl_reflection_description_ICoroutine::GetStatus()
	{
		return __vwsn_prop_Status;
	}
	void __vwsnc1_CoSmcSwitchP2_SMSwitchP2___vwsn_state_CreateCoroutine__vl_reflection_description_ICoroutine::SetStatus(::vl::reflection::description::CoroutineStatus __vwsn_value_)
	{
		(__vwsn_prop_Status = __vwsn_value_);
	}

	void __vwsnc1_CoSmcSwitchP2_SMSwitchP2___vwsn_state_CreateCoroutine__vl_reflection_description_ICoroutine::Resume(bool __vwsn_raise_exception_, ::vl::Ptr<::vl::reflection::description::CoroutineResult> __vwsn_coroutine_output_)
	{
		...
		{
			{
				if ((__vwsn_co_state_before_pause_ != (- static_cast<::vl::vint32_t>(1))))
				{
					...
					{
						if (((__vwsn_co_state_before_pause_ == static_cast<::vl::vint32_t>(0)) || [&](auto __vwsn_1){ return (static_cast<::vl::vint32_t>(3) <=  __vwsn_1 && __vwsn_1 <= static_cast<::vl::vint32_t>(6)); }(__vwsn_co_state_before_pause_)))
						{
							(__vwsn_co_state_before_pause_ = (- static_cast<::vl::vint32_t>(1)));
...
void SMSwitchP2::__vwsn_state_CreateCoroutine(::vl::vint32_t __vwsn_state_startState)
{
	...
	(::vl::__vwsn::This(__vwsn_state_stateMachineObject)->stateMachineCoroutine = ::vl::Ptr<::vl::reflection::description::ICoroutine>(new ::vl_workflow_global::__vwsnc1_CoSmcSwitchP2_SMSwitchP2___vwsn_state_CreateCoroutine__vl_reflection_description_ICoroutine(__vwsn_state_previousCoroutine, __vwsn_state_startState, __vwsn_state_stateMachineObject, this)));
}

SMSwitchP2::SMSwitchP2()
{
}
