...
***********************************************************************/
	...
	{
		auto x = ::vl::__vwsn::Box((::vl::__vwsn::CreateList().Add(static_cast<::vl::vint32_t>(1))).list);
		auto y = ::vl::__vwsn::Box((::vl::__vwsn::CreateDictionary().Add(static_cast<::vl::vint32_t>(1), static_cast<::vl::vint32_t>(2))).dictionary);
