...
***********************************************************************/
	...
	bool Rpc_CollectionDict_PropByref::rpcwrapper_IsInterfaceTypeId(::vl::vint32_t typeId)
	{
			...
			return true;
		{
			...
			if ((__vwsn_switch_2 == GLOBAL_NAME rpctype_RpcCollectionDict__InByref__PropByref__IService))
				return true;
			else
				return false;
		}
	...
	{
		return ::vl::Ptr<::vl::rpc_controller::IRpcObjectOps>(new ::vl_workflow_global::__vwsnc4_Rpc_CollectionDict_PropByref_rpcops_IRpcObjectOpsJson__vl_rpc_controller_IRpcObjectOps(lc));
	}
	...
	{
		return ::vl::Ptr<::vl::rpc_controller::IRpcObjectEventOps>(new ::vl_workflow_global::__vwsnc5_Rpc_CollectionDict_PropByref_rpcops_IRpcObjectEventOpsJson__vl_rpc_controller_IRpcObjectEventOps(lc));
	}
	...
	{
		return ::vl::Ptr<::rpcops_IOps_Rpc_CollectionDict_PropByref>(new ::vl_workflow_global::__vwsnc6_Rpc_CollectionDict_PropByref_rpcops_IOps_Create__rpcops_IOps_Rpc_CollectionDict_PropByref(lc));
	}
	...
	{
		return ::vl::Ptr<::rpcops_IOps_Rpc_CollectionDict_PropByref>(new ::vl_workflow_global::__vwsnc7_Rpc_CollectionDict_PropByref_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_CollectionDict_PropByref(lc));
	}
	...
	{
		auto proxy = ::vl::Ptr<::RpcCollectionDict::InByref::PropByref::IRpcWrapper_IService>(new ::vl_workflow_global::__vwsnc8_Rpc_CollectionDict_PropByref_rpcwrapper_RpcCollectionDict__InByref__PropByref__IService__RpcCollectionDict_InByref_PropByref_IRpcWrapper_IService(lc, ops, proxyRef));
	...
	{
		{
			...
			if ((__vwsn_switch_8 == GLOBAL_NAME rpctype_RpcCollectionDict__InByref__PropByref__IService))
			{
...
***********************************************************************/
	...
	{
		{
			...
			if ((__vwsn_switch_4 == GLOBAL_NAME rpcmethod_RpcCollectionDict__InByref__PropByref__IService_GetList))
			{
			...
			else if ((__vwsn_switch_4 == GLOBAL_NAME rpcmethod_RpcCollectionDict__InByref__PropByref__IService_SetList))
			{
				auto target = ::vl::__vwsn::Ensure(::vl::__vwsn::SharedPtrCast<::RpcCollectionDict::InByref::PropByref::IService>(::vl::__vwsn::This(_lc)->RefToPtr(ref).Obj()));
	...
	__vwsnc4_Rpc_CollectionDict_PropByref_rpcops_IRpcObjectOpsJson__vl_rpc_controller_IRpcObjectOps::__vwsnc4_Rpc_CollectionDict_PropByref_rpcops_IRpcObjectOpsJson__vl_rpc_controller_IRpcObjectOps(::vl::rpc_controller::IRpcLifecycle* __vwsnctor_lc)
	{
		this->_lc = __vwsnctor_lc;
	}

	::vl::reflection::description::Value __vwsnc4_Rpc_CollectionDict_PropByref_rpcops_IRpcObjectOpsJson__vl_rpc_controller_IRpcObjectOps::InvokeMethod(::vl::rpc_controller::RpcObjectReference ref, ::vl::vint32_t methodId, ::vl::Ptr<::vl::reflection::description::IValueArray> arguments)
	{
		{
	...
	void __vwsnc4_Rpc_CollectionDict_PropByref_rpcops_IRpcObjectOpsJson__vl_rpc_controller_IRpcObjectOps::ObjectHold(::vl::rpc_controller::RpcObjectReference ref, ::vl::vint32_t remoteClientId, bool hold)
	{
		if (hold)
		{
			::vl::__vwsn::This(_lc)->LocalObjectHold(ref, remoteClientId);
	...
	void __vwsnc4_Rpc_CollectionDict_PropByref_rpcops_IRpcObjectOpsJson__vl_rpc_controller_IRpcObjectOps::RegisterService(::vl::vint32_t typeId, ::vl::Ptr<::vl::reflection::IDescriptable> service)
	{
		{
			if (GLOBAL_NAME rpcwrapper_IsCtorInterfaceTypeId(typeId))
			{
	...
	__vwsnc5_Rpc_CollectionDict_PropByref_rpcops_IRpcObjectEventOpsJson__vl_rpc_controller_IRpcObjectEventOps::__vwsnc5_Rpc_CollectionDict_PropByref_rpcops_IRpcObjectEventOpsJson__vl_rpc_controller_IRpcObjectEventOps(::vl::rpc_controller::IRpcLifecycle* __vwsnctor_lc)
	{
		this->_lc = __vwsnctor_lc;
	}

	void __vwsnc5_Rpc_CollectionDict_PropByref_rpcops_IRpcObjectEventOpsJson__vl_rpc_controller_IRpcObjectEventOps::InvokeEvent(::vl::rpc_controller::RpcObjectReference ref, ::vl::vint32_t eventId, ::vl::Ptr<::vl::reflection::description::IValueArray> arguments)
	{
		::vl::__vwsn::This(::vl::__vwsn::This(_lc)->GetController())->SetEventSuppressedFlag(ref, eventId, true);
		{
			auto __vwsnb_0 = [&]()
	...
	__vwsnc6_Rpc_CollectionDict_PropByref_rpcops_IOps_Create__rpcops_IOps_Rpc_CollectionDict_PropByref::__vwsnc6_Rpc_CollectionDict_PropByref_rpcops_IOps_Create__rpcops_IOps_Rpc_CollectionDict_PropByref(::vl::rpc_controller::IRpcLifecycle* __vwsnctor_lc)
	{
		this->_lc = __vwsnctor_lc;
	}

	::vl::Ptr<::vl::reflection::description::IValueDictionary> __vwsnc6_Rpc_CollectionDict_PropByref_rpcops_IOps_Create__rpcops_IOps_Rpc_CollectionDict_PropByref::InvokeMethod_RpcCollectionDict__InByref__PropByref__IService_GetList(::vl::rpc_controller::RpcObjectReference ref)
	{
		auto arguments = ::vl::reflection::description::IValueArray::Create();
		::vl::__vwsn::This(arguments.Obj())->Resize(static_cast<::vl::vint32_t>(0));
		return ::vl::__vwsn::SharedPtrCast<::vl::reflection::description::IValueDictionary>(::vl::rpc_controller::RpcUnboxByref(::vl::__vwsn::Unbox<::vl::rpc_controller::RpcObjectReference>(::vl::__vwsn::This(::vl::__vwsn::This(::vl::__vwsn::This(_lc)->GetDispatcher())->SendToClient_ObjectOps(ref.clientId))->InvokeMethod(ref, GLOBAL_NAME rpcmethod_RpcCollectionDict__InByref__PropByref__IService_GetList, arguments)), _lc).Obj());
	}

	void __vwsnc6_Rpc_CollectionDict_PropByref_rpcops_IOps_Create__rpcops_IOps_Rpc_CollectionDict_PropByref::InvokeMethod_RpcCollectionDict__InByref__PropByref__IService_SetList(::vl::rpc_controller::RpcObjectReference ref, ::vl::Ptr<::vl::reflection::description::IValueDictionary> __vwsn_value_)
	{
		auto arguments = ::vl::reflection::description::IValueArray::Create();
	...
	__vwsnc7_Rpc_CollectionDict_PropByref_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_CollectionDict_PropByref::__vwsnc7_Rpc_CollectionDict_PropByref_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_CollectionDict_PropByref(::vl::rpc_controller::IRpcLifecycle* __vwsnctor_lc)
	{
		this->_lc = __vwsnctor_lc;
	}

	::vl::Ptr<::vl::reflection::description::IValueDictionary> __vwsnc7_Rpc_CollectionDict_PropByref_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_CollectionDict_PropByref::InvokeMethod_RpcCollectionDict__InByref__PropByref__IService_GetList(::vl::rpc_controller::RpcObjectReference ref)
	{
		auto arguments = ::vl::reflection::description::IValueArray::Create();
		::vl::__vwsn::This(arguments.Obj())->Resize(static_cast<::vl::vint32_t>(0));
	...
	void __vwsnc7_Rpc_CollectionDict_PropByref_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_CollectionDict_PropByref::InvokeMethod_RpcCollectionDict__InByref__PropByref__IService_SetList(::vl::rpc_controller::RpcObjectReference ref, ::vl::Ptr<::vl::reflection::description::IValueDictionary> __vwsn_value_)
	{
		auto arguments = ::vl::reflection::description::IValueArray::Create();
		::vl::__vwsn::This(arguments.Obj())->Resize(static_cast<::vl::vint32_t>(1));
	...
	__vwsnc8_Rpc_CollectionDict_PropByref_rpcwrapper_RpcCollectionDict__InByref__PropByref__IService__RpcCollectionDict_InByref_PropByref_IRpcWrapper_IService::__vwsnc8_Rpc_CollectionDict_PropByref_rpcwrapper_RpcCollectionDict__InByref__PropByref__IService__RpcCollectionDict_InByref_PropByref_IRpcWrapper_IService(::vl::rpc_controller::IRpcLifecycle* __vwsnctor_lc, ::vl::Ptr<::rpcops_IOps_Rpc_CollectionDict_PropByref> __vwsnctor_ops, ::vl::rpc_controller::RpcObjectReference __vwsnctor_proxyRef)
	{
		this->_lc = __vwsnctor_lc;
	...
	void __vwsnc8_Rpc_CollectionDict_PropByref_rpcwrapper_RpcCollectionDict__InByref__PropByref__IService__RpcCollectionDict_InByref_PropByref_IRpcWrapper_IService::DisconnectFromLifecycle()
	{
	...
	::vl::Ptr<::vl::reflection::description::IValueDictionary> __vwsnc8_Rpc_CollectionDict_PropByref_rpcwrapper_RpcCollectionDict__InByref__PropByref__IService__RpcCollectionDict_InByref_PropByref_IRpcWrapper_IService::GetList()
	{
		if ((_lc == nullptr))
	...
	void __vwsnc8_Rpc_CollectionDict_PropByref_rpcwrapper_RpcCollectionDict__InByref__PropByref__IService__RpcCollectionDict_InByref_PropByref_IRpcWrapper_IService::SetList(::vl::Ptr<::vl::reflection::description::IValueDictionary> __vwsn_value_)
	{
		if ((_lc == nullptr))
			throw ::vl::Exception(::vl::WString::Unmanaged(L"RPC wrapper has been disconnected from lifecycle."));
