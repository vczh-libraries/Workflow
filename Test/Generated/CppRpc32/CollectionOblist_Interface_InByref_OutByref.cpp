...
***********************************************************************/
	...
	bool Rpc_CollectionOblist_Interface_InByref_OutByref::rpcwrapper_IsInterfaceTypeId(::vl::vint32_t typeId)
	{
			...
			return true;
		{
			...
			if ((__vwsn_switch_2 == GLOBAL_NAME rpctype_RpcCollectionOblist__Interface__InByref__OutByref__IValue))
				return true;
			else if ((__vwsn_switch_2 == GLOBAL_NAME rpctype_RpcCollectionOblist__Interface__InByref__OutByref__IService))
				return true;
			else
				return false;
		}
	...
	{
		{
			...
			if ((__vwsn_switch_3 == GLOBAL_NAME rpctype_RpcCollectionOblist__Interface__InByref__OutByref__IService))
				return true;
			else
				return false;
		}
	...
	{
		return ::vl::Ptr<::vl::rpc_controller::IRpcObjectOps>(new ::vl_workflow_global::__vwsnc5_Rpc_CollectionOblist_Interface_InByref_OutByref_rpcops_IRpcObjectOpsJson__vl_rpc_controller_IRpcObjectOps(lc));
	}
	...
	{
		return ::vl::Ptr<::vl::rpc_controller::IRpcObjectEventOps>(new ::vl_workflow_global::__vwsnc6_Rpc_CollectionOblist_Interface_InByref_OutByref_rpcops_IRpcObjectEventOpsJson__vl_rpc_controller_IRpcObjectEventOps(lc));
	}
	...
	{
		return ::vl::Ptr<::rpcops_IOps_Rpc_CollectionOblist_Interface_InByref_OutByref>(new ::vl_workflow_global::__vwsnc7_Rpc_CollectionOblist_Interface_InByref_OutByref_rpcops_IOps_Create__rpcops_IOps_Rpc_CollectionOblist_Interface_InByref_OutByref(lc));
	}
	...
	{
		return ::vl::Ptr<::rpcops_IOps_Rpc_CollectionOblist_Interface_InByref_OutByref>(new ::vl_workflow_global::__vwsnc8_Rpc_CollectionOblist_Interface_InByref_OutByref_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_CollectionOblist_Interface_InByref_OutByref(lc));
	}
	...
	{
		auto proxy = ::vl::Ptr<::RpcCollectionOblist::Interface::InByref::OutByref::IRpcWrapper_IValue>(new ::vl_workflow_global::__vwsnc9_Rpc_CollectionOblist_Interface_InByref_OutByref_rpcwrapper_RpcCollectionOblist__Interface__InByref__OutByref__IValue__RpcCollectionOblist_Interface_InByref_OutByref_IRpcWrapper_IValue(lc, ops, proxyRef));
	...
	{
		auto proxy = ::vl::Ptr<::RpcCollectionOblist::Interface::InByref::OutByref::IRpcWrapper_IService>(new ::vl_workflow_global::__vwsnc10_Rpc_CollectionOblist_Interface_InByref_OutByref_rpcwrapper_RpcCollectionOblist__Interface__InByref__OutByref__IService__RpcCollectionOblist_Interface_InByref_OutByref_IRpcWrapper_IService(lc, ops, proxyRef));
		::vl::__vwsn::This(::vl::__vwsn::This(::vl::__vwsn::This(lc)->GetDispatcher())->SendToClient_ObjectOps(proxyRef.clientId))->ObjectHold(proxyRef, ::vl::__vwsn::This(lc)->GetClientId(), true);
		return proxy;
	}
	...
	{
		{
			...
			if ((__vwsn_switch_8 == GLOBAL_NAME rpctype_RpcCollectionOblist__Interface__InByref__OutByref__IValue))
			{
			...
			else if ((__vwsn_switch_8 == GLOBAL_NAME rpctype_RpcCollectionOblist__Interface__InByref__OutByref__IService))
			{
...
***********************************************************************/
	...
	__vwsnc10_Rpc_CollectionOblist_Interface_InByref_OutByref_rpcwrapper_RpcCollectionOblist__Interface__InByref__OutByref__IService__RpcCollectionOblist_Interface_InByref_OutByref_IRpcWrapper_IService::__vwsnc10_Rpc_CollectionOblist_Interface_InByref_OutByref_rpcwrapper_RpcCollectionOblist__Interface__InByref__OutByref__IService__RpcCollectionOblist_Interface_InByref_OutByref_IRpcWrapper_IService(::vl::rpc_controller::IRpcLifecycle* __vwsnctor_lc, ::vl::Ptr<::rpcops_IOps_Rpc_CollectionOblist_Interface_InByref_OutByref> __vwsnctor_ops, ::vl::rpc_controller::RpcObjectReference __vwsnctor_proxyRef)
	{
	...
	void __vwsnc10_Rpc_CollectionOblist_Interface_InByref_OutByref_rpcwrapper_RpcCollectionOblist__Interface__InByref__OutByref__IService__RpcCollectionOblist_Interface_InByref_OutByref_IRpcWrapper_IService::DisconnectFromLifecycle()
	{
	...
	::vl::Ptr<::vl::reflection::description::IValueObservableList> __vwsnc10_Rpc_CollectionOblist_Interface_InByref_OutByref_rpcwrapper_RpcCollectionOblist__Interface__InByref__OutByref__IService__RpcCollectionOblist_Interface_InByref_OutByref_IRpcWrapper_IService::DoList(::vl::Ptr<::vl::reflection::description::IValueObservableList> xs)
	{
		if ((_lc == nullptr))
	...
	{
		{
			...
			if ((__vwsn_switch_4 == GLOBAL_NAME rpcmethod_RpcCollectionOblist__Interface__InByref__OutByref__IValue_GetValue))
			{
			...
			else if ((__vwsn_switch_4 == GLOBAL_NAME rpcmethod_RpcCollectionOblist__Interface__InByref__OutByref__IService_DoList))
			{
				...
				return ::vl::__vwsn::Box(::vl::rpc_controller::RpcBoxByref(::vl::Ptr<::vl::reflection::IDescriptable>(::vl::__vwsn::This(target.Obj())->DoList(::vl::__vwsn::SharedPtrCast<::vl::reflection::description::IValueObservableList>(::vl::rpc_controller::RpcUnboxByref(::vl::__vwsn::Unbox<::vl::rpc_controller::RpcObjectReference>(::vl::__vwsn::Unbox<::vl::reflection::description::Value>(::vl::__vwsn::This(arguments.Obj())->Get(static_cast<::vl::vint32_t>(0)))), _lc).Obj()))), _lc));
			}
			else
	...
	__vwsnc5_Rpc_CollectionOblist_Interface_InByref_OutByref_rpcops_IRpcObjectOpsJson__vl_rpc_controller_IRpcObjectOps::__vwsnc5_Rpc_CollectionOblist_Interface_InByref_OutByref_rpcops_IRpcObjectOpsJson__vl_rpc_controller_IRpcObjectOps(::vl::rpc_controller::IRpcLifecycle* __vwsnctor_lc)
	{
		this->_lc = __vwsnctor_lc;
	}

	::vl::reflection::description::Value __vwsnc5_Rpc_CollectionOblist_Interface_InByref_OutByref_rpcops_IRpcObjectOpsJson__vl_rpc_controller_IRpcObjectOps::InvokeMethod(::vl::rpc_controller::RpcObjectReference ref, ::vl::vint32_t methodId, ::vl::Ptr<::vl::reflection::description::IValueArray> arguments)
	{
		{
			...
			else if ((__vwsn_switch_6 == GLOBAL_NAME rpcmethod_RpcCollectionOblist__Interface__InByref__OutByref__IService_DoList))
			{
				...
				auto jsonNode1 = GLOBAL_NAME rpcjson_Serialize_Struct_system__RpcObjectReference(::vl::rpc_controller::RpcBoxByref(::vl::Ptr<::vl::reflection::IDescriptable>(::vl::__vwsn::This(target.Obj())->DoList(::vl::__vwsn::SharedPtrCast<::vl::reflection::description::IValueObservableList>(::vl::rpc_controller::RpcUnboxByref(jsonValue0, _lc).Obj()))), _lc));
	...
	void __vwsnc5_Rpc_CollectionOblist_Interface_InByref_OutByref_rpcops_IRpcObjectOpsJson__vl_rpc_controller_IRpcObjectOps::ObjectHold(::vl::rpc_controller::RpcObjectReference ref, ::vl::vint32_t remoteClientId, bool hold)
	{
		if (hold)
		{
			::vl::__vwsn::This(_lc)->LocalObjectHold(ref, remoteClientId);
	...
	void __vwsnc5_Rpc_CollectionOblist_Interface_InByref_OutByref_rpcops_IRpcObjectOpsJson__vl_rpc_controller_IRpcObjectOps::RegisterService(::vl::vint32_t typeId, ::vl::Ptr<::vl::reflection::IDescriptable> service)
	{
		{
			if (GLOBAL_NAME rpcwrapper_IsCtorInterfaceTypeId(typeId))
			{
	...
	__vwsnc6_Rpc_CollectionOblist_Interface_InByref_OutByref_rpcops_IRpcObjectEventOpsJson__vl_rpc_controller_IRpcObjectEventOps::__vwsnc6_Rpc_CollectionOblist_Interface_InByref_OutByref_rpcops_IRpcObjectEventOpsJson__vl_rpc_controller_IRpcObjectEventOps(::vl::rpc_controller::IRpcLifecycle* __vwsnctor_lc)
	{
		this->_lc = __vwsnctor_lc;
	}

	void __vwsnc6_Rpc_CollectionOblist_Interface_InByref_OutByref_rpcops_IRpcObjectEventOpsJson__vl_rpc_controller_IRpcObjectEventOps::InvokeEvent(::vl::rpc_controller::RpcObjectReference ref, ::vl::vint32_t eventId, ::vl::Ptr<::vl::reflection::description::IValueArray> arguments)
	{
		::vl::__vwsn::This(::vl::__vwsn::This(_lc)->GetController())->SetEventSuppressedFlag(ref, eventId, true);
		{
			auto __vwsnb_0 = [&]()
	...
	__vwsnc7_Rpc_CollectionOblist_Interface_InByref_OutByref_rpcops_IOps_Create__rpcops_IOps_Rpc_CollectionOblist_Interface_InByref_OutByref::__vwsnc7_Rpc_CollectionOblist_Interface_InByref_OutByref_rpcops_IOps_Create__rpcops_IOps_Rpc_CollectionOblist_Interface_InByref_OutByref(::vl::rpc_controller::IRpcLifecycle* __vwsnctor_lc)
	{
		this->_lc = __vwsnctor_lc;
	}

	::vl::WString __vwsnc7_Rpc_CollectionOblist_Interface_InByref_OutByref_rpcops_IOps_Create__rpcops_IOps_Rpc_CollectionOblist_Interface_InByref_OutByref::InvokeMethod_RpcCollectionOblist__Interface__InByref__OutByref__IValue_GetValue(::vl::rpc_controller::RpcObjectReference ref)
	{
	...
	::vl::Ptr<::vl::reflection::description::IValueObservableList> __vwsnc7_Rpc_CollectionOblist_Interface_InByref_OutByref_rpcops_IOps_Create__rpcops_IOps_Rpc_CollectionOblist_Interface_InByref_OutByref::InvokeMethod_RpcCollectionOblist__Interface__InByref__OutByref__IService_DoList(::vl::rpc_controller::RpcObjectReference ref, ::vl::Ptr<::vl::reflection::description::IValueObservableList> arg_xs)
	{
		auto arguments = ::vl::reflection::description::IValueArray::Create();
		...
		return ::vl::__vwsn::SharedPtrCast<::vl::reflection::description::IValueObservableList>(::vl::rpc_controller::RpcUnboxByref(::vl::__vwsn::Unbox<::vl::rpc_controller::RpcObjectReference>(::vl::__vwsn::This(::vl::__vwsn::This(::vl::__vwsn::This(_lc)->GetDispatcher())->SendToClient_ObjectOps(ref.clientId))->InvokeMethod(ref, GLOBAL_NAME rpcmethod_RpcCollectionOblist__Interface__InByref__OutByref__IService_DoList, arguments)), _lc).Obj());
	}

	//-------------------------------------------------------------------

	__vwsnc8_Rpc_CollectionOblist_Interface_InByref_OutByref_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_CollectionOblist_Interface_InByref_OutByref::__vwsnc8_Rpc_CollectionOblist_Interface_InByref_OutByref_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_CollectionOblist_Interface_InByref_OutByref(::vl::rpc_controller::IRpcLifecycle* __vwsnctor_lc)
	{
		this->_lc = __vwsnctor_lc;
	}

	::vl::WString __vwsnc8_Rpc_CollectionOblist_Interface_InByref_OutByref_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_CollectionOblist_Interface_InByref_OutByref::InvokeMethod_RpcCollectionOblist__Interface__InByref__OutByref__IValue_GetValue(::vl::rpc_controller::RpcObjectReference ref)
	{
		auto arguments = ::vl::reflection::description::IValueArray::Create();
		::vl::__vwsn::This(arguments.Obj())->Resize(static_cast<::vl::vint32_t>(0));
	...
	::vl::Ptr<::vl::reflection::description::IValueObservableList> __vwsnc8_Rpc_CollectionOblist_Interface_InByref_OutByref_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_CollectionOblist_Interface_InByref_OutByref::InvokeMethod_RpcCollectionOblist__Interface__InByref__OutByref__IService_DoList(::vl::rpc_controller::RpcObjectReference ref, ::vl::Ptr<::vl::reflection::description::IValueObservableList> arg_xs)
	{
		auto arguments = ::vl::reflection::description::IValueArray::Create();
		::vl::__vwsn::This(arguments.Obj())->Resize(static_cast<::vl::vint32_t>(1));
		...
		return ::vl::__vwsn::SharedPtrCast<::vl::reflection::description::IValueObservableList>(::vl::rpc_controller::RpcUnboxByref(jsonValue1, _lc).Obj());
	}

	//-------------------------------------------------------------------

	__vwsnc9_Rpc_CollectionOblist_Interface_InByref_OutByref_rpcwrapper_RpcCollectionOblist__Interface__InByref__OutByref__IValue__RpcCollectionOblist_Interface_InByref_OutByref_IRpcWrapper_IValue::__vwsnc9_Rpc_CollectionOblist_Interface_InByref_OutByref_rpcwrapper_RpcCollectionOblist__Interface__InByref__OutByref__IValue__RpcCollectionOblist_Interface_InByref_OutByref_IRpcWrapper_IValue(::vl::rpc_controller::IRpcLifecycle* __vwsnctor_lc, ::vl::Ptr<::rpcops_IOps_Rpc_CollectionOblist_Interface_InByref_OutByref> __vwsnctor_ops, ::vl::rpc_controller::RpcObjectReference __vwsnctor_proxyRef)
	{
		this->_lc = __vwsnctor_lc;
		this->_ref = __vwsnctor_proxyRef;
		this->_ops = __vwsnctor_ops;
	...
	void __vwsnc9_Rpc_CollectionOblist_Interface_InByref_OutByref_rpcwrapper_RpcCollectionOblist__Interface__InByref__OutByref__IValue__RpcCollectionOblist_Interface_InByref_OutByref_IRpcWrapper_IValue::DisconnectFromLifecycle()
	{
		(_lc = static_cast<::vl::rpc_controller::IRpcLifecycle*>(nullptr));
		(_ops = ::vl::Ptr<::rpcops_IOps_Rpc_CollectionOblist_Interface_InByref_OutByref>());
	}
	...
	::vl::WString __vwsnc9_Rpc_CollectionOblist_Interface_InByref_OutByref_rpcwrapper_RpcCollectionOblist__Interface__InByref__OutByref__IValue__RpcCollectionOblist_Interface_InByref_OutByref_IRpcWrapper_IValue::GetValue()
	{
		if ((_lc == nullptr))
			throw ::vl::Exception(::vl::WString::Unmanaged(L"RPC wrapper has been disconnected from lifecycle."));
