	...
	{
		{
			...
			if ((__vwsn_switch_7 == GLOBAL_NAME rpcmethod_RpcCollectionOblist__Interface__InByref__OutByref__IValue_GetValue))
			{
				auto target = ::vl::__vwsn::Ensure(::vl::__vwsn::SharedPtrCast<::RpcCollectionOblist::Interface::InByref::OutByref::IValue>(::vl::__vwsn::This(_lc)->RefToPtr(ref).Obj()));
			...
			else if ((__vwsn_switch_7 == GLOBAL_NAME rpcmethod_RpcCollectionOblist__Interface__InByref__OutByref__IService_DoList))
			{
				auto target = ::vl::__vwsn::Ensure(::vl::__vwsn::SharedPtrCast<::RpcCollectionOblist::Interface::InByref::OutByref::IService>(::vl::__vwsn::This(_lc)->RefToPtr(ref).Obj()));
