...
***********************************************************************/
	...
	bool Rpc_Collection_Interface_Default::rpcwrapper_IsInterfaceTypeId(::vl::vint32_t typeId)
	{
			...
			return true;
		{
			...
			if ((__vwsn_switch_2 == GLOBAL_NAME rpctype_RpcCollection__Interface__Default__IValue))
				return true;
			else if ((__vwsn_switch_2 == GLOBAL_NAME rpctype_RpcCollection__Interface__Default__IService))
				return true;
			else
				return false;
		}
	...
	{
		{
			...
			if ((__vwsn_switch_3 == GLOBAL_NAME rpctype_RpcCollection__Interface__Default__IService))
				return true;
			else
				return false;
		}
	...
	{
		return ::vl::Ptr<::vl::rpc_controller::IRpcObjectOps>(new ::vl_workflow_global::__vwsnc5_Rpc_Collection_Interface_Default_rpcops_IRpcObjectOpsJson__vl_rpc_controller_IRpcObjectOps(lc));
	}
	...
	{
		return ::vl::Ptr<::vl::rpc_controller::IRpcObjectEventOps>(new ::vl_workflow_global::__vwsnc6_Rpc_Collection_Interface_Default_rpcops_IRpcObjectEventOpsJson__vl_rpc_controller_IRpcObjectEventOps(lc));
	}
	...
	{
		return ::vl::Ptr<::rpcops_IOps_Rpc_Collection_Interface_Default>(new ::vl_workflow_global::__vwsnc7_Rpc_Collection_Interface_Default_rpcops_IOps_Create__rpcops_IOps_Rpc_Collection_Interface_Default(lc));
	}
	...
	{
		return ::vl::Ptr<::rpcops_IOps_Rpc_Collection_Interface_Default>(new ::vl_workflow_global::__vwsnc8_Rpc_Collection_Interface_Default_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_Collection_Interface_Default(lc));
	}
	...
	{
		auto proxy = ::vl::Ptr<::RpcCollection::Interface::Default::IRpcWrapper_IValue>(new ::vl_workflow_global::__vwsnc9_Rpc_Collection_Interface_Default_rpcwrapper_RpcCollection__Interface__Default__IValue__RpcCollection_Interface_Default_IRpcWrapper_IValue(lc, ops, proxyRef));
	...
	{
		auto proxy = ::vl::Ptr<::RpcCollection::Interface::Default::IRpcWrapper_IService>(new ::vl_workflow_global::__vwsnc10_Rpc_Collection_Interface_Default_rpcwrapper_RpcCollection__Interface__Default__IService__RpcCollection_Interface_Default_IRpcWrapper_IService(lc, ops, proxyRef));
		::vl::__vwsn::This(::vl::__vwsn::This(::vl::__vwsn::This(lc)->GetDispatcher())->SendToClient_ObjectOps(proxyRef.clientId))->ObjectHold(proxyRef, ::vl::__vwsn::This(lc)->GetClientId(), true);
		return proxy;
	}
	...
	{
		{
			...
			if ((__vwsn_switch_8 == GLOBAL_NAME rpctype_RpcCollection__Interface__Default__IValue))
			{
			...
			else if ((__vwsn_switch_8 == GLOBAL_NAME rpctype_RpcCollection__Interface__Default__IService))
			{
...
***********************************************************************/
	...
	__vwsnc10_Rpc_Collection_Interface_Default_rpcwrapper_RpcCollection__Interface__Default__IService__RpcCollection_Interface_Default_IRpcWrapper_IService::__vwsnc10_Rpc_Collection_Interface_Default_rpcwrapper_RpcCollection__Interface__Default__IService__RpcCollection_Interface_Default_IRpcWrapper_IService(::vl::rpc_controller::IRpcLifecycle* __vwsnctor_lc, ::vl::Ptr<::rpcops_IOps_Rpc_Collection_Interface_Default> __vwsnctor_ops, ::vl::rpc_controller::RpcObjectReference __vwsnctor_proxyRef)
	{
	...
	void __vwsnc10_Rpc_Collection_Interface_Default_rpcwrapper_RpcCollection__Interface__Default__IService__RpcCollection_Interface_Default_IRpcWrapper_IService::DisconnectFromLifecycle()
	{
	...
	::vl::Ptr<::vl::reflection::description::IValueList> __vwsnc10_Rpc_Collection_Interface_Default_rpcwrapper_RpcCollection__Interface__Default__IService__RpcCollection_Interface_Default_IRpcWrapper_IService::DoList(::vl::Ptr<::vl::reflection::description::IValueList> xs)
	{
		if ((_lc == nullptr))
	...
	{
		{
			...
			if ((__vwsn_switch_4 == GLOBAL_NAME rpcmethod_RpcCollection__Interface__Default__IValue_GetValue))
			{
			...
			else if ((__vwsn_switch_4 == GLOBAL_NAME rpcmethod_RpcCollection__Interface__Default__IService_DoList))
			{
	...
	__vwsnc5_Rpc_Collection_Interface_Default_rpcops_IRpcObjectOpsJson__vl_rpc_controller_IRpcObjectOps::__vwsnc5_Rpc_Collection_Interface_Default_rpcops_IRpcObjectOpsJson__vl_rpc_controller_IRpcObjectOps(::vl::rpc_controller::IRpcLifecycle* __vwsnctor_lc)
	{
		this->_lc = __vwsnctor_lc;
	}

	::vl::reflection::description::Value __vwsnc5_Rpc_Collection_Interface_Default_rpcops_IRpcObjectOpsJson__vl_rpc_controller_IRpcObjectOps::InvokeMethod(::vl::rpc_controller::RpcObjectReference ref, ::vl::vint32_t methodId, ::vl::Ptr<::vl::reflection::description::IValueArray> arguments)
	{
		{
	...
	void __vwsnc5_Rpc_Collection_Interface_Default_rpcops_IRpcObjectOpsJson__vl_rpc_controller_IRpcObjectOps::ObjectHold(::vl::rpc_controller::RpcObjectReference ref, ::vl::vint32_t remoteClientId, bool hold)
	{
		if (hold)
		{
			::vl::__vwsn::This(_lc)->LocalObjectHold(ref, remoteClientId);
	...
	void __vwsnc5_Rpc_Collection_Interface_Default_rpcops_IRpcObjectOpsJson__vl_rpc_controller_IRpcObjectOps::RegisterService(::vl::vint32_t typeId, ::vl::Ptr<::vl::reflection::IDescriptable> service)
	{
		{
			if (GLOBAL_NAME rpcwrapper_IsCtorInterfaceTypeId(typeId))
			{
	...
	__vwsnc6_Rpc_Collection_Interface_Default_rpcops_IRpcObjectEventOpsJson__vl_rpc_controller_IRpcObjectEventOps::__vwsnc6_Rpc_Collection_Interface_Default_rpcops_IRpcObjectEventOpsJson__vl_rpc_controller_IRpcObjectEventOps(::vl::rpc_controller::IRpcLifecycle* __vwsnctor_lc)
	{
		this->_lc = __vwsnctor_lc;
	}

	void __vwsnc6_Rpc_Collection_Interface_Default_rpcops_IRpcObjectEventOpsJson__vl_rpc_controller_IRpcObjectEventOps::InvokeEvent(::vl::rpc_controller::RpcObjectReference ref, ::vl::vint32_t eventId, ::vl::Ptr<::vl::reflection::description::IValueArray> arguments)
	{
		::vl::__vwsn::This(::vl::__vwsn::This(_lc)->GetController())->SetEventSuppressedFlag(ref, eventId, true);
		{
			auto __vwsnb_0 = [&]()
	...
	__vwsnc7_Rpc_Collection_Interface_Default_rpcops_IOps_Create__rpcops_IOps_Rpc_Collection_Interface_Default::__vwsnc7_Rpc_Collection_Interface_Default_rpcops_IOps_Create__rpcops_IOps_Rpc_Collection_Interface_Default(::vl::rpc_controller::IRpcLifecycle* __vwsnctor_lc)
	{
		this->_lc = __vwsnctor_lc;
	}

	::vl::WString __vwsnc7_Rpc_Collection_Interface_Default_rpcops_IOps_Create__rpcops_IOps_Rpc_Collection_Interface_Default::InvokeMethod_RpcCollection__Interface__Default__IValue_GetValue(::vl::rpc_controller::RpcObjectReference ref)
	{
	...
	::vl::Ptr<::vl::reflection::description::IValueList> __vwsnc7_Rpc_Collection_Interface_Default_rpcops_IOps_Create__rpcops_IOps_Rpc_Collection_Interface_Default::InvokeMethod_RpcCollection__Interface__Default__IService_DoList(::vl::rpc_controller::RpcObjectReference ref, ::vl::Ptr<::vl::reflection::description::IValueList> arg_xs)
	{
		...
		return ::vl::__vwsn::SharedPtrCast<::vl::reflection::description::IValueList>(::vl::rpc_controller::RpcUnboxByref(::vl::__vwsn::Unbox<::vl::rpc_controller::RpcObjectReference>(::vl::__vwsn::This(::vl::__vwsn::This(::vl::__vwsn::This(_lc)->GetDispatcher())->SendToClient_ObjectOps(ref.clientId))->InvokeMethod(ref, GLOBAL_NAME rpcmethod_RpcCollection__Interface__Default__IService_DoList, arguments)), _lc).Obj());
	}

	//-------------------------------------------------------------------

	__vwsnc8_Rpc_Collection_Interface_Default_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_Collection_Interface_Default::__vwsnc8_Rpc_Collection_Interface_Default_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_Collection_Interface_Default(::vl::rpc_controller::IRpcLifecycle* __vwsnctor_lc)
	{
		this->_lc = __vwsnctor_lc;
	}

	::vl::WString __vwsnc8_Rpc_Collection_Interface_Default_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_Collection_Interface_Default::InvokeMethod_RpcCollection__Interface__Default__IValue_GetValue(::vl::rpc_controller::RpcObjectReference ref)
	{
		auto arguments = ::vl::reflection::description::IValueArray::Create();
		::vl::__vwsn::This(arguments.Obj())->Resize(static_cast<::vl::vint32_t>(0));
	...
	::vl::Ptr<::vl::reflection::description::IValueList> __vwsnc8_Rpc_Collection_Interface_Default_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_Collection_Interface_Default::InvokeMethod_RpcCollection__Interface__Default__IService_DoList(::vl::rpc_controller::RpcObjectReference ref, ::vl::Ptr<::vl::reflection::description::IValueList> arg_xs)
	{
		auto arguments = ::vl::reflection::description::IValueArray::Create();
		::vl::__vwsn::This(arguments.Obj())->Resize(static_cast<::vl::vint32_t>(1));
	...
	__vwsnc9_Rpc_Collection_Interface_Default_rpcwrapper_RpcCollection__Interface__Default__IValue__RpcCollection_Interface_Default_IRpcWrapper_IValue::__vwsnc9_Rpc_Collection_Interface_Default_rpcwrapper_RpcCollection__Interface__Default__IValue__RpcCollection_Interface_Default_IRpcWrapper_IValue(::vl::rpc_controller::IRpcLifecycle* __vwsnctor_lc, ::vl::Ptr<::rpcops_IOps_Rpc_Collection_Interface_Default> __vwsnctor_ops, ::vl::rpc_controller::RpcObjectReference __vwsnctor_proxyRef)
	{
		this->_lc = __vwsnctor_lc;
		this->_ref = __vwsnctor_proxyRef;
		this->_ops = __vwsnctor_ops;
	...
	void __vwsnc9_Rpc_Collection_Interface_Default_rpcwrapper_RpcCollection__Interface__Default__IValue__RpcCollection_Interface_Default_IRpcWrapper_IValue::DisconnectFromLifecycle()
	{
		(_lc = static_cast<::vl::rpc_controller::IRpcLifecycle*>(nullptr));
		(_ops = ::vl::Ptr<::rpcops_IOps_Rpc_Collection_Interface_Default>());
	}

	__vwsnc9_Rpc_Collection_Interface_Default_rpcwrapper_RpcCollection__Interface__Default__IValue__RpcCollection_Interface_Default_IRpcWrapper_IValue::~__vwsnc9_Rpc_Collection_Interface_Default_rpcwrapper_RpcCollection__Interface__Default__IValue__RpcCollection_Interface_Default_IRpcWrapper_IValue()
	{
		if ((_lc != nullptr))
		{
			::vl::__vwsn::This(::vl::__vwsn::This(::vl::__vwsn::This(_lc)->GetDispatcher())->SendToClient_ObjectOps(_ref.clientId))->ObjectHold(_ref, ::vl::__vwsn::This(_lc)->GetClientId(), false);
	...
	::vl::WString __vwsnc9_Rpc_Collection_Interface_Default_rpcwrapper_RpcCollection__Interface__Default__IValue__RpcCollection_Interface_Default_IRpcWrapper_IValue::GetValue()
	{
		if ((_lc == nullptr))
			throw ::vl::Exception(::vl::WString::Unmanaged(L"RPC wrapper has been disconnected from lifecycle."));
