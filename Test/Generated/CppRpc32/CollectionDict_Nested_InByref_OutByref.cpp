...
***********************************************************************/
	...
	::vl::Ptr<::vl::reflection::description::IValueList> __vwsnc4_Rpc_CollectionDict_Nested_InByref_OutByref_rpcwrapper_RpcCollectionDict__Nested__InByref__OutByref__IService__RpcCollectionDict_Nested_InByref_OutByref_IRpcWrapper_IService::DoList(::vl::Ptr<::vl::reflection::description::IValueList> xs)
	{
		...
		return ::vl::__vwsn::SharedPtrCast<::vl::reflection::description::IValueList>(::vl::rpc_controller::RpcUnboxByref(::vl::__vwsn::Unbox<::vl::rpc_controller::RpcObjectReference>(::vl::__vwsn::This(::vl::__vwsn::This(::vl::__vwsn::This(_lc)->GetDispatcher())->SendToClient_ObjectOps(_ref.clientId))->InvokeMethod(_ref, GLOBAL_NAME rpcmethod_RpcCollectionDict__Nested__InByref__OutByref__IService_DoList, arguments)), _lc).Obj());
	}
