...
namespace vl
{
	namespace reflection
	{
		namespace description
		{
			...
			IMPL_CPP_TYPE_INFO(RpcCollectionDict::Interface::Nested::InByref::OutByval::IRpcWrapper_IService)
...
#define _ ,
			BEGIN_INTERFACE_MEMBER(::RpcCollectionDict::Interface::Nested::InByref::OutByval::IRpcWrapper_IService)
				CLASS_MEMBER_BASE(::RpcCollectionDict::Interface::Nested::InByref::OutByval::IService)
				CLASS_MEMBER_BASE(::vl::rpc_controller::IRpcWrapperBase)
			END_INTERFACE_MEMBER(::RpcCollectionDict::Interface::Nested::InByref::OutByval::IRpcWrapper_IService)

			BEGIN_INTERFACE_MEMBER(::RpcCollectionDict::Interface::Nested::InByref::OutByval::IRpcWrapper_IValue)
				CLASS_MEMBER_BASE(::RpcCollectionDict::Interface::Nested::InByref::OutByval::IValue)
				CLASS_MEMBER_BASE(::vl::rpc_controller::IRpcWrapperBase)
			END_INTERFACE_MEMBER(::RpcCollectionDict::Interface::Nested::InByref::OutByval::IRpcWrapper_IValue)

			BEGIN_INTERFACE_MEMBER(::RpcCollectionDict::Interface::Nested::InByref::OutByval::IService)
			...
			END_INTERFACE_MEMBER(::RpcCollectionDict::Interface::Nested::InByref::OutByval::IService)

			BEGIN_INTERFACE_MEMBER(::RpcCollectionDict::Interface::Nested::InByref::OutByval::IValue)
				ATTRIBUTE_TYPE(::vl::__vwsn::att_rpc_Interface)
				CLASS_MEMBER_BASE(::vl::reflection::IDescriptable)
			...
			BEGIN_INTERFACE_MEMBER(::rpcops_IOps_Rpc_CollectionDict_Interface_Nested_InByref_OutByval)
				...
				CLASS_MEMBER_METHOD(InvokeMethod_RpcCollectionDict__Interface__Nested__InByref__OutByval__IService_GetServiceResult, { L"ref" })
...
#undef _
			...
			public:
				...
				{
					ADD_TYPE_INFO(::RpcCollectionDict::Interface::Nested::InByref::OutByval::IRpcWrapper_IService)
			...
			bool LoadRpc_CollectionDict_Interface_Nested_InByref_OutByvalTypes()
			{
#ifdef VCZH_DESCRIPTABLEOBJECT_WITH_METADATA
				if (auto manager = GetGlobalTypeManager())
				{
					return manager->AddTypeLoader(Ptr(new Rpc_CollectionDict_Interface_Nested_InByref_OutByvalTypeLoader));
				}
#endif
				return false;
			}
