...
***********************************************************************/
	...
	::vl::WString __vwsnc5_Rpc_CollectionDict_Interface_PropDefault_rpcwrapper_RpcCollectionDict__Interface__PropDefault__IValue__RpcCollectionDict_Interface_PropDefault_IRpcWrapper_IValue::GetValue()
	{
		...
		return ::vl::__vwsn::Unbox<::vl::WString>(::vl::__vwsn::This(::vl::__vwsn::This(::vl::__vwsn::This(_lc)->GetDispatcher())->SendToClient_ObjectOps(_ref.clientId))->InvokeMethod(_ref, GLOBAL_NAME rpcmethod_RpcCollectionDict__Interface__PropDefault__IValue_GetValue, arguments));
	}
	...
	::vl::Ptr<::vl::reflection::description::IValueDictionary> __vwsnc6_Rpc_CollectionDict_Interface_PropDefault_rpcwrapper_RpcCollectionDict__Interface__PropDefault__IService__RpcCollectionDict_Interface_PropDefault_IRpcWrapper_IService::GetList()
	{
		...
		auto arguments = ::vl::reflection::description::IValueArray::Create();
		::vl::__vwsn::This(arguments.Obj())->Resize(static_cast<::vl::vint32_t>(0));
		return ::vl::__vwsn::SharedPtrCast<::vl::reflection::description::IValueDictionary>(::vl::rpc_controller::RpcUnboxByref(::vl::__vwsn::Unbox<::vl::rpc_controller::RpcObjectReference>(::vl::__vwsn::This(::vl::__vwsn::This(::vl::__vwsn::This(_lc)->GetDispatcher())->SendToClient_ObjectOps(_ref.clientId))->InvokeMethod(_ref, GLOBAL_NAME rpcmethod_RpcCollectionDict__Interface__PropDefault__IService_GetList, arguments)), _lc).Obj());
	}
