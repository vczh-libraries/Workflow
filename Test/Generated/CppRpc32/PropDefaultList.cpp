...
***********************************************************************/
	...
	bool Rpc_PropDefaultList::rpcwrapper_IsInterfaceTypeId(::vl::vint32_t typeId)
	{
			...
			return true;
		{
			...
			if ((__vwsn_switch_2 == GLOBAL_NAME rpctype_RpcPropDefaultList__IService))
				return true;
			else
				return false;
		}
	...
	{
		{
			...
			if ((__vwsn_switch_3 == GLOBAL_NAME rpctype_RpcPropDefaultList__IService))
				return true;
			else
				return false;
		}
	...
	{
		return ::vl::Ptr<::vl::rpc_controller::IRpcObjectOps>(new ::vl_workflow_global::__vwsnc4_Rpc_PropDefaultList_rpcops_IRpcObjectOpsJson__vl_rpc_controller_IRpcObjectOps(lc));
	}
	...
	{
		return ::vl::Ptr<::vl::rpc_controller::IRpcObjectEventOps>(new ::vl_workflow_global::__vwsnc5_Rpc_PropDefaultList_rpcops_IRpcObjectEventOpsJson__vl_rpc_controller_IRpcObjectEventOps(lc));
	}

	::vl::Ptr<::rpcops_IOps_Rpc_PropDefaultList> Rpc_PropDefaultList::rpcops_IOps_Create(::vl::rpc_controller::IRpcLifecycle* lc)
	{
		return ::vl::Ptr<::rpcops_IOps_Rpc_PropDefaultList>(new ::vl_workflow_global::__vwsnc6_Rpc_PropDefaultList_rpcops_IOps_Create__rpcops_IOps_Rpc_PropDefaultList(lc));
	}

	::vl::Ptr<::rpcops_IOps_Rpc_PropDefaultList> Rpc_PropDefaultList::rpcops_IOps_CreateJson(::vl::rpc_controller::IRpcLifecycle* lc)
	{
		return ::vl::Ptr<::rpcops_IOps_Rpc_PropDefaultList>(new ::vl_workflow_global::__vwsnc7_Rpc_PropDefaultList_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_PropDefaultList(lc));
	}
	...
	{
		{
			...
			if ((__vwsn_switch_8 == GLOBAL_NAME rpctype_RpcPropDefaultList__IService))
			{
	...
	{
		auto proxy = ::vl::Ptr<::RpcPropDefaultList::IRpcWrapper_IService>(new ::vl_workflow_global::__vwsnc8_Rpc_PropDefaultList_rpcwrapper_RpcPropDefaultList__IService__RpcPropDefaultList_IRpcWrapper_IService(lc, ops, proxyRef));
	...
	{
		{
			...
			if ((__vwsn_switch_9 == GLOBAL_NAME rpctype_RpcPropDefaultList__IService))
			{
...
***********************************************************************/
	...
	{
		{
			...
			if ((__vwsn_switch_4 == GLOBAL_NAME rpcmethod_RpcPropDefaultList__IService_GetValue))
			{
			...
			else if ((__vwsn_switch_4 == GLOBAL_NAME rpcmethod_RpcPropDefaultList__IService_SetValue))
			{
				auto target = ::vl::__vwsn::Ensure(::vl::__vwsn::SharedPtrCast<::RpcPropDefaultList::IService>(::vl::__vwsn::This(_lc)->RefToPtr(ref).Obj()));
				::vl::__vwsn::This(target.Obj())->SetValue(::vl::__vwsn::SharedPtrCast<::vl::reflection::description::IValueList>(::vl::rpc_controller::RpcUnboxByval(::vl::__vwsn::Unbox<::vl::reflection::description::Value>(::vl::__vwsn::This(arguments.Obj())->Get(static_cast<::vl::vint32_t>(0))), _lc).Obj()));
				return ::vl::reflection::description::Value();
			}
			else if ((__vwsn_switch_4 == GLOBAL_NAME rpcmethod_RpcPropDefaultList__IService_Signal))
			{
				auto target = ::vl::__vwsn::Ensure(::vl::__vwsn::SharedPtrCast<::RpcPropDefaultList::IService>(::vl::__vwsn::This(_lc)->RefToPtr(ref).Obj()));
			...
			{
				{
					...
					if ((__vwsn_switch_5 == GLOBAL_NAME rpcevent_RpcPropDefaultList__IService_ValueChanged))
					{
						auto target = ::vl::__vwsn::Ensure(::vl::__vwsn::SharedPtrCast<::RpcPropDefaultList::IService>(::vl::__vwsn::This(_lc)->RefToPtr(ref).Obj()));
	...
	__vwsnc4_Rpc_PropDefaultList_rpcops_IRpcObjectOpsJson__vl_rpc_controller_IRpcObjectOps::__vwsnc4_Rpc_PropDefaultList_rpcops_IRpcObjectOpsJson__vl_rpc_controller_IRpcObjectOps(::vl::rpc_controller::IRpcLifecycle* __vwsnctor_lc)
	{
		this->_lc = __vwsnctor_lc;
	}

	::vl::reflection::description::Value __vwsnc4_Rpc_PropDefaultList_rpcops_IRpcObjectOpsJson__vl_rpc_controller_IRpcObjectOps::InvokeMethod(::vl::rpc_controller::RpcObjectReference ref, ::vl::vint32_t methodId, ::vl::Ptr<::vl::reflection::description::IValueArray> arguments)
	{
		{
			auto __vwsn_switch_6 = methodId;
			if ((__vwsn_switch_6 == GLOBAL_NAME rpcmethod_RpcPropDefaultList__IService_GetValue))
			{
				auto target = ::vl::__vwsn::Ensure(::vl::__vwsn::SharedPtrCast<::RpcPropDefaultList::IService>(::vl::__vwsn::This(_lc)->RefToPtr(ref).Obj()));
			...
			else if ((__vwsn_switch_6 == GLOBAL_NAME rpcmethod_RpcPropDefaultList__IService_SetValue))
			{
				auto target = ::vl::__vwsn::Ensure(::vl::__vwsn::SharedPtrCast<::RpcPropDefaultList::IService>(::vl::__vwsn::This(_lc)->RefToPtr(ref).Obj()));
				...
				::vl::__vwsn::This(target.Obj())->SetValue(::vl::__vwsn::SharedPtrCast<::vl::reflection::description::IValueList>(::vl::rpc_controller::RpcUnboxByval(jsonValue0, _lc).Obj()));
				return ::vl::reflection::description::Value();
			}
			else if ((__vwsn_switch_6 == GLOBAL_NAME rpcmethod_RpcPropDefaultList__IService_Signal))
			{
				auto target = ::vl::__vwsn::Ensure(::vl::__vwsn::SharedPtrCast<::RpcPropDefaultList::IService>(::vl::__vwsn::This(_lc)->RefToPtr(ref).Obj()));
				::vl::__vwsn::This(target.Obj())->Signal();
				return ::vl::reflection::description::Value();
	...
	void __vwsnc4_Rpc_PropDefaultList_rpcops_IRpcObjectOpsJson__vl_rpc_controller_IRpcObjectOps::ObjectHold(::vl::rpc_controller::RpcObjectReference ref, ::vl::vint32_t remoteClientId, bool hold)
	{
		if (hold)
		{
			::vl::__vwsn::This(_lc)->LocalObjectHold(ref, remoteClientId);
	...
	void __vwsnc4_Rpc_PropDefaultList_rpcops_IRpcObjectOpsJson__vl_rpc_controller_IRpcObjectOps::RegisterService(::vl::vint32_t typeId, ::vl::Ptr<::vl::reflection::IDescriptable> service)
	{
		{
			if (GLOBAL_NAME rpcwrapper_IsCtorInterfaceTypeId(typeId))
			{
	...
	__vwsnc5_Rpc_PropDefaultList_rpcops_IRpcObjectEventOpsJson__vl_rpc_controller_IRpcObjectEventOps::__vwsnc5_Rpc_PropDefaultList_rpcops_IRpcObjectEventOpsJson__vl_rpc_controller_IRpcObjectEventOps(::vl::rpc_controller::IRpcLifecycle* __vwsnctor_lc)
	{
		this->_lc = __vwsnctor_lc;
	}

	void __vwsnc5_Rpc_PropDefaultList_rpcops_IRpcObjectEventOpsJson__vl_rpc_controller_IRpcObjectEventOps::InvokeEvent(::vl::rpc_controller::RpcObjectReference ref, ::vl::vint32_t eventId, ::vl::Ptr<::vl::reflection::description::IValueArray> arguments)
	{
		::vl::__vwsn::This(::vl::__vwsn::This(_lc)->GetController())->SetEventSuppressedFlag(ref, eventId, true);
		{
			auto __vwsnb_0 = [&]()
			...
			{
				{
					...
					if ((__vwsn_switch_7 == GLOBAL_NAME rpcevent_RpcPropDefaultList__IService_ValueChanged))
					{
						auto target = ::vl::__vwsn::Ensure(::vl::__vwsn::SharedPtrCast<::RpcPropDefaultList::IService>(::vl::__vwsn::This(_lc)->RefToPtr(ref).Obj()));
						::vl::__vwsn::EventInvoke(::vl::__vwsn::This(target.Obj())->ValueChanged)();
					}
	...
	__vwsnc6_Rpc_PropDefaultList_rpcops_IOps_Create__rpcops_IOps_Rpc_PropDefaultList::__vwsnc6_Rpc_PropDefaultList_rpcops_IOps_Create__rpcops_IOps_Rpc_PropDefaultList(::vl::rpc_controller::IRpcLifecycle* __vwsnctor_lc)
	{
		this->_lc = __vwsnctor_lc;
	}

	::vl::Ptr<::vl::reflection::description::IValueList> __vwsnc6_Rpc_PropDefaultList_rpcops_IOps_Create__rpcops_IOps_Rpc_PropDefaultList::InvokeMethod_RpcPropDefaultList__IService_GetValue(::vl::rpc_controller::RpcObjectReference ref)
	{
		auto arguments = ::vl::reflection::description::IValueArray::Create();
		::vl::__vwsn::This(arguments.Obj())->Resize(static_cast<::vl::vint32_t>(0));
		return ::vl::__vwsn::SharedPtrCast<::vl::reflection::description::IValueList>(::vl::rpc_controller::RpcUnboxByval(::vl::__vwsn::This(::vl::__vwsn::This(::vl::__vwsn::This(_lc)->GetDispatcher())->SendToClient_ObjectOps(ref.clientId))->InvokeMethod(ref, GLOBAL_NAME rpcmethod_RpcPropDefaultList__IService_GetValue, arguments), _lc).Obj());
	}

	void __vwsnc6_Rpc_PropDefaultList_rpcops_IOps_Create__rpcops_IOps_Rpc_PropDefaultList::InvokeMethod_RpcPropDefaultList__IService_SetValue(::vl::rpc_controller::RpcObjectReference ref, ::vl::Ptr<::vl::reflection::description::IValueList> arg_value)
	{
		auto arguments = ::vl::reflection::description::IValueArray::Create();
	...
	void __vwsnc6_Rpc_PropDefaultList_rpcops_IOps_Create__rpcops_IOps_Rpc_PropDefaultList::InvokeMethod_RpcPropDefaultList__IService_Signal(::vl::rpc_controller::RpcObjectReference ref)
	{
		auto arguments = ::vl::reflection::description::IValueArray::Create();
		::vl::__vwsn::This(arguments.Obj())->Resize(static_cast<::vl::vint32_t>(0));
	...
	void __vwsnc6_Rpc_PropDefaultList_rpcops_IOps_Create__rpcops_IOps_Rpc_PropDefaultList::InvokeEvent_RpcPropDefaultList__IService_ValueChanged(::vl::rpc_controller::RpcObjectReference ref)
	{
		auto arguments = ::vl::reflection::description::IValueArray::Create();
		::vl::__vwsn::This(arguments.Obj())->Resize(static_cast<::vl::vint32_t>(0));
	...
	__vwsnc7_Rpc_PropDefaultList_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_PropDefaultList::__vwsnc7_Rpc_PropDefaultList_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_PropDefaultList(::vl::rpc_controller::IRpcLifecycle* __vwsnctor_lc)
	{
		this->_lc = __vwsnctor_lc;
	}

	::vl::Ptr<::vl::reflection::description::IValueList> __vwsnc7_Rpc_PropDefaultList_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_PropDefaultList::InvokeMethod_RpcPropDefaultList__IService_GetValue(::vl::rpc_controller::RpcObjectReference ref)
	{
		auto arguments = ::vl::reflection::description::IValueArray::Create();
		::vl::__vwsn::This(arguments.Obj())->Resize(static_cast<::vl::vint32_t>(0));
	...
	void __vwsnc7_Rpc_PropDefaultList_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_PropDefaultList::InvokeMethod_RpcPropDefaultList__IService_SetValue(::vl::rpc_controller::RpcObjectReference ref, ::vl::Ptr<::vl::reflection::description::IValueList> arg_value)
	{
		auto arguments = ::vl::reflection::description::IValueArray::Create();
		::vl::__vwsn::This(arguments.Obj())->Resize(static_cast<::vl::vint32_t>(1));
	...
	void __vwsnc7_Rpc_PropDefaultList_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_PropDefaultList::InvokeMethod_RpcPropDefaultList__IService_Signal(::vl::rpc_controller::RpcObjectReference ref)
	{
		auto arguments = ::vl::reflection::description::IValueArray::Create();
		::vl::__vwsn::This(arguments.Obj())->Resize(static_cast<::vl::vint32_t>(0));
		::vl::__vwsn::This(::vl::__vwsn::This(::vl::__vwsn::This(_lc)->GetDispatcher())->SendToClient_ObjectOps(ref.clientId))->InvokeMethod(ref, GLOBAL_NAME rpcmethod_RpcPropDefaultList__IService_Signal, arguments);
	...
	void __vwsnc7_Rpc_PropDefaultList_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_PropDefaultList::InvokeEvent_RpcPropDefaultList__IService_ValueChanged(::vl::rpc_controller::RpcObjectReference ref)
	{
		auto arguments = ::vl::reflection::description::IValueArray::Create();
		::vl::__vwsn::This(arguments.Obj())->Resize(static_cast<::vl::vint32_t>(0));
		::vl::__vwsn::This(::vl::__vwsn::This(::vl::__vwsn::This(_lc)->GetDispatcher())->BroadcastFromClient_ObjectEventOps(::vl::__vwsn::This(_lc)->GetClientId()))->InvokeEvent(ref, GLOBAL_NAME rpcevent_RpcPropDefaultList__IService_ValueChanged, arguments);
	...
	void __vwsnc8_Rpc_PropDefaultList_rpcwrapper_RpcPropDefaultList__IService__RpcPropDefaultList_IRpcWrapper_IService::_rpcInvalidate_Value()
	{
		(__vwsn_Available_ = false);
	}

	void __vwsnc8_Rpc_PropDefaultList_rpcwrapper_RpcPropDefaultList__IService__RpcPropDefaultList_IRpcWrapper_IService::DisconnectFromLifecycle()
	{
		(_lc = static_cast<::vl::rpc_controller::IRpcLifecycle*>(nullptr));
		(_ops = ::vl::Ptr<::rpcops_IOps_Rpc_PropDefaultList>());
	}

	__vwsnc8_Rpc_PropDefaultList_rpcwrapper_RpcPropDefaultList__IService__RpcPropDefaultList_IRpcWrapper_IService::~__vwsnc8_Rpc_PropDefaultList_rpcwrapper_RpcPropDefaultList__IService__RpcPropDefaultList_IRpcWrapper_IService()
	{
		if ((_lc != nullptr))
		{
	...
	::vl::Ptr<::vl::reflection::description::IValueList> __vwsnc8_Rpc_PropDefaultList_rpcwrapper_RpcPropDefaultList__IService__RpcPropDefaultList_IRpcWrapper_IService::GetValue()
	{
		if ((_lc == nullptr))
	...
	void __vwsnc8_Rpc_PropDefaultList_rpcwrapper_RpcPropDefaultList__IService__RpcPropDefaultList_IRpcWrapper_IService::SetValue(::vl::Ptr<::vl::reflection::description::IValueList> value)
	{
		if ((_lc == nullptr))
			throw ::vl::Exception(::vl::WString::Unmanaged(L"RPC wrapper has been disconnected from lifecycle."));
	...
	void __vwsnc8_Rpc_PropDefaultList_rpcwrapper_RpcPropDefaultList__IService__RpcPropDefaultList_IRpcWrapper_IService::Signal()
	{
		if ((_lc == nullptr))
			throw ::vl::Exception(::vl::WString::Unmanaged(L"RPC wrapper has been disconnected from lifecycle."));
