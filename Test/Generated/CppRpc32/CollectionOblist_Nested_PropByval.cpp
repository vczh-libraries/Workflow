	...
	{
		{
			...
			if ((__vwsn_switch_7 == GLOBAL_NAME rpcmethod_RpcCollectionOblist__Nested__InByval__PropByval__IService_GetList))
			{
				auto target = ::vl::__vwsn::Ensure(::vl::__vwsn::SharedPtrCast<::RpcCollectionOblist::Nested::InByval::PropByval::IService>(::vl::__vwsn::This(_lc)->RefToPtr(ref).Obj()));
				auto copiedReturnValue = ::vl::rpc_controller::RpcCopyByval(::vl::__vwsn::Box(::vl::__vwsn::This(target.Obj())->GetList()), _lc);
			...
			else if ((__vwsn_switch_7 == GLOBAL_NAME rpcmethod_RpcCollectionOblist__Nested__InByval__PropByval__IService_SetList))
			{
				auto target = ::vl::__vwsn::Ensure(::vl::__vwsn::SharedPtrCast<::RpcCollectionOblist::Nested::InByval::PropByval::IService>(::vl::__vwsn::This(_lc)->RefToPtr(ref).Obj()));
