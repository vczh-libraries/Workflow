...
***********************************************************************/
	...
	{
		return ::vl::Ptr<::vl::rpc_controller::IRpcObjectOps>(new ::vl_workflow_global::__vwsnc6_Rpc_CollectionOblist_Nested_PropByval_rpcops_IRpcObjectOpsJson__vl_rpc_controller_IRpcObjectOps(lc));
	}
	...
	{
		return ::vl::Ptr<::vl::rpc_controller::IRpcObjectEventOps>(new ::vl_workflow_global::__vwsnc7_Rpc_CollectionOblist_Nested_PropByval_rpcops_IRpcObjectEventOpsJson__vl_rpc_controller_IRpcObjectEventOps(lc));
	}
	...
	{
		return ::vl::Ptr<::rpcops_IOps_Rpc_CollectionOblist_Nested_PropByval>(new ::vl_workflow_global::__vwsnc8_Rpc_CollectionOblist_Nested_PropByval_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_CollectionOblist_Nested_PropByval(lc));
	}
...
***********************************************************************/
	...
	__vwsnc6_Rpc_CollectionOblist_Nested_PropByval_rpcops_IRpcObjectOpsJson__vl_rpc_controller_IRpcObjectOps::__vwsnc6_Rpc_CollectionOblist_Nested_PropByval_rpcops_IRpcObjectOpsJson__vl_rpc_controller_IRpcObjectOps(::vl::rpc_controller::IRpcLifecycle* __vwsnctor_lc)
	{
		this->_lc = __vwsnctor_lc;
	}

	::vl::reflection::description::Value __vwsnc6_Rpc_CollectionOblist_Nested_PropByval_rpcops_IRpcObjectOpsJson__vl_rpc_controller_IRpcObjectOps::InvokeMethod(::vl::rpc_controller::RpcObjectReference ref, ::vl::vint32_t methodId, ::vl::Ptr<::vl::reflection::description::IValueArray> arguments)
	{
		{
	...
	void __vwsnc6_Rpc_CollectionOblist_Nested_PropByval_rpcops_IRpcObjectOpsJson__vl_rpc_controller_IRpcObjectOps::ObjectHold(::vl::rpc_controller::RpcObjectReference ref, ::vl::vint32_t remoteClientId, bool hold)
	{
		if (hold)
		{
			::vl::__vwsn::This(_lc)->LocalObjectHold(ref, remoteClientId);
	...
	void __vwsnc6_Rpc_CollectionOblist_Nested_PropByval_rpcops_IRpcObjectOpsJson__vl_rpc_controller_IRpcObjectOps::RegisterService(::vl::vint32_t typeId, ::vl::Ptr<::vl::reflection::IDescriptable> service)
	{
		{
			if (GLOBAL_NAME rpcwrapper_IsCtorInterfaceTypeId(typeId))
			{
	...
	__vwsnc7_Rpc_CollectionOblist_Nested_PropByval_rpcops_IRpcObjectEventOpsJson__vl_rpc_controller_IRpcObjectEventOps::__vwsnc7_Rpc_CollectionOblist_Nested_PropByval_rpcops_IRpcObjectEventOpsJson__vl_rpc_controller_IRpcObjectEventOps(::vl::rpc_controller::IRpcLifecycle* __vwsnctor_lc)
	{
		this->_lc = __vwsnctor_lc;
	}

	void __vwsnc7_Rpc_CollectionOblist_Nested_PropByval_rpcops_IRpcObjectEventOpsJson__vl_rpc_controller_IRpcObjectEventOps::InvokeEvent(::vl::rpc_controller::RpcObjectReference ref, ::vl::vint32_t eventId, ::vl::Ptr<::vl::reflection::description::IValueArray> arguments)
	{
		::vl::__vwsn::This(::vl::__vwsn::This(_lc)->GetController())->SetEventSuppressedFlag(ref, eventId, true);
		{
			auto __vwsnb_0 = [&]()
	...
	__vwsnc8_Rpc_CollectionOblist_Nested_PropByval_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_CollectionOblist_Nested_PropByval::__vwsnc8_Rpc_CollectionOblist_Nested_PropByval_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_CollectionOblist_Nested_PropByval(::vl::rpc_controller::IRpcLifecycle* __vwsnctor_lc)
	{
		this->_lc = __vwsnctor_lc;
	}

	::vl::Ptr<::vl::reflection::description::IValueObservableList> __vwsnc8_Rpc_CollectionOblist_Nested_PropByval_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_CollectionOblist_Nested_PropByval::InvokeMethod_RpcCollectionOblist__Nested__InByval__PropByval__IService_GetList(::vl::rpc_controller::RpcObjectReference ref)
	{
		auto arguments = ::vl::reflection::description::IValueArray::Create();
		::vl::__vwsn::This(arguments.Obj())->Resize(static_cast<::vl::vint32_t>(0));
	...
	void __vwsnc8_Rpc_CollectionOblist_Nested_PropByval_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_CollectionOblist_Nested_PropByval::InvokeMethod_RpcCollectionOblist__Nested__InByval__PropByval__IService_SetList(::vl::rpc_controller::RpcObjectReference ref, ::vl::Ptr<::vl::reflection::description::IValueObservableList> __vwsn_value_)
	{
		auto arguments = ::vl::reflection::description::IValueArray::Create();
		::vl::__vwsn::This(arguments.Obj())->Resize(static_cast<::vl::vint32_t>(1));
