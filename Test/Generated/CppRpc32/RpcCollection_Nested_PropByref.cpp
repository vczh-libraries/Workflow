...
***********************************************************************/
	...
	void Rpc_Collection_Nested_PropByref::serviceMain(::vl::rpc_controller::IRpcLifecycle* lc)
	{
		...
		::vl::__vwsn::This(lc)->RegisterLocalService(::vl::__vwsn::Unbox<::vl::vint32_t>(::vl::__vwsn::This(GLOBAL_NAME rpc_GetIds().Obj())->Get(::vl::__vwsn::Box(::vl::WString::Unmanaged(L"RpcCollection::Nested::InByref::PropByref::IService")))), ::vl::Ptr<::vl::reflection::IDescriptable>(serviceObj));
	}
	...
	::vl::vint32_t Rpc_Collection_Nested_PropByref::rpcwrapper_GetTypeId(const ::vl::reflection::description::Value& obj)
	{
...
***********************************************************************/
	...
	::vl::reflection::description::Value __vwsnc3_Rpc_Collection_Nested_PropByref_rpcops_IRpcObjectEventOps__vl_rpc_controller_IRpcObjectEventOps::InvokeEvent(::vl::rpc_controller::RpcObjectReference ref, ::vl::vint32_t eventId, ::vl::Ptr<::vl::reflection::description::IValueArray> arguments)
	{
	...
	::vl::reflection::description::Value __vwsnc8_Rpc_Collection_Nested_PropByref_rpcops_IRpcObjectEventOpsJson__vl_rpc_controller_IRpcObjectEventOps::InvokeEvent(::vl::rpc_controller::RpcObjectReference ref, ::vl::vint32_t eventId, ::vl::Ptr<::vl::reflection::description::IValueArray> arguments)
	{
		throw ::vl::Exception(::vl::WString::Unmanaged(L"Unknown RPC event id."));
	}
