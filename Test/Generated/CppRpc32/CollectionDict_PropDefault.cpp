...
***********************************************************************/
	...
	::vl::Ptr<::vl::glr::json::JsonNode> Rpc_CollectionDict_PropDefault::rpcjson_NewNull()
	{
	...
	::vl::glr::ParsingToken Rpc_CollectionDict_PropDefault::rpcjson_NewToken(const ::vl::WString& value)
	{
		return [&](){ ::vl::glr::ParsingToken __vwsn_temp__; __vwsn_temp__.value = value; return __vwsn_temp__; }();
	}

	::vl::Ptr<::vl::glr::json::JsonString> Rpc_CollectionDict_PropDefault::rpcjson_NewString(const ::vl::WString& content)
	{
	...
	::vl::Ptr<::vl::glr::json::JsonNumber> Rpc_CollectionDict_PropDefault::rpcjson_NewNumber(const ::vl::WString& content)
	{
	...
	::vl::Ptr<::vl::glr::json::JsonNode> Rpc_CollectionDict_PropDefault::rpcjson_NewArray2(const ::vl::WString& keyword, ::vl::Ptr<::vl::glr::json::JsonNode> value)
	{
	...
	void Rpc_CollectionDict_PropDefault::rpcjson_ObjectAdd(::vl::Ptr<::vl::glr::json::JsonObject> object, const ::vl::WString& name, ::vl::Ptr<::vl::glr::json::JsonNode> value)
	{
	...
	::vl::Ptr<::vl::glr::json::JsonObject> Rpc_CollectionDict_PropDefault::rpcjson_NewObject(const ::vl::WString& keyword)
	{
	...
	::vl::Ptr<::vl::glr::json::JsonNode> Rpc_CollectionDict_PropDefault::rpcjson_ObjectGet(::vl::Ptr<::vl::glr::json::JsonObject> object, const ::vl::WString& name)
	{
		{
	...
	::vl::Ptr<::vl::glr::json::JsonNode> Rpc_CollectionDict_PropDefault::rpcjson_SerializeCollection(const ::vl::WString& keyword, ::vl::Ptr<::vl::reflection::description::IValueEnumerable> values)
	{
	...
	::vl::Ptr<::vl::glr::json::JsonNode> Rpc_CollectionDict_PropDefault::rpcjson_SerializeMap(::vl::Ptr<::vl::reflection::description::IValueReadonlyDictionary> values)
	{
	...
	::vl::Ptr<::RpcCollectionDict::PropDefault::IRpcWrapper_IService> Rpc_CollectionDict_PropDefault::rpcwrapper_RpcCollectionDict__PropDefault__IService(::vl::rpc_controller::IRpcLifecycle* lc, ::vl::rpc_controller::RpcObjectReference proxyRef)
	{
	...
	::vl::Ptr<::vl::rpc_controller::IRpcWrapperBase> Rpc_CollectionDict_PropDefault::rpcwrapper_Create(::vl::rpc_controller::RpcObjectReference ref, ::vl::rpc_controller::IRpcLifecycle* lc)
	{
		{
			auto __vwsn_switch_6 = ref.typeId;
			if ((__vwsn_switch_6 == GLOBAL_NAME rpctype_RpcCollectionDict__PropDefault__IService))
			{
				return ::vl::Ptr<::vl::rpc_controller::IRpcWrapperBase>(GLOBAL_NAME rpcwrapper_RpcCollectionDict__PropDefault__IService(lc, ref));
			}
			else
...
***********************************************************************/
	...
	::vl::Ptr<::vl::reflection::description::IAsync> __vwsnc2_Rpc_CollectionDict_PropDefault_rpc_IRpcObjectOps__vl_rpc_controller_IRpcObjectOps::InvokeMethodAsync(::vl::rpc_controller::RpcObjectReference ref, ::vl::vint32_t methodId, ::vl::Ptr<::vl::reflection::description::IValueArray> arguments)
	{
	...
	::vl::Ptr<::vl::reflection::description::IValueDictionary> __vwsnc4_Rpc_CollectionDict_PropDefault_rpcwrapper_RpcCollectionDict__PropDefault__IService__RpcCollectionDict_PropDefault_IRpcWrapper_IService::GetList()
	{
		...
		return ::vl::__vwsn::Unbox<::vl::Ptr<::vl::reflection::description::IValueDictionary>>(::vl::rpc_controller::RpcUnboxByval(::vl::__vwsn::This(::vl::__vwsn::This(::vl::__vwsn::This(_lc)->GetDispatcher())->SendToClient_ObjectOps(_ref.clientId))->InvokeMethod(_ref, GLOBAL_NAME rpcmethod_RpcCollectionDict__PropDefault__IService_GetList, arguments), _lc));
	}
	...
	void __vwsnc4_Rpc_CollectionDict_PropDefault_rpcwrapper_RpcCollectionDict__PropDefault__IService__RpcCollectionDict_PropDefault_IRpcWrapper_IService::SetList(::vl::Ptr<::vl::reflection::description::IValueDictionary> __vwsn_value_)
	{
		...
		::vl::__vwsn::This(::vl::__vwsn::This(::vl::__vwsn::This(_lc)->GetDispatcher())->SendToClient_ObjectOps(_ref.clientId))->InvokeMethod(_ref, GLOBAL_NAME rpcmethod_RpcCollectionDict__PropDefault__IService_SetList, arguments);
	}
