...
***********************************************************************/
	...
	{
		return ::vl::Ptr<::rpcops_IOps_Rpc_Collection_InByval_OutByref>(new ::vl_workflow_global::__vwsnc5_Rpc_Collection_InByval_OutByref_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_Collection_InByval_OutByref(lc));
	}
	...
	{
		auto proxy = ::vl::Ptr<::RpcCollection::InByval::OutByref::IRpcWrapper_IService>(new ::vl_workflow_global::__vwsnc6_Rpc_Collection_InByval_OutByref_rpcwrapper_RpcCollection__InByval__OutByref__IService__RpcCollection_InByval_OutByref_IRpcWrapper_IService(lc, ops, proxyRef));
	...
	{
		{
			...
			if ((__vwsn_switch_6 == GLOBAL_NAME rpctype_RpcCollection__InByval__OutByref__IService))
			{
...
***********************************************************************/
	...
	__vwsnc5_Rpc_Collection_InByval_OutByref_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_Collection_InByval_OutByref::__vwsnc5_Rpc_Collection_InByval_OutByref_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_Collection_InByval_OutByref(::vl::rpc_controller::IRpcLifecycle* __vwsnctor_lc)
	{
		this->_lc = __vwsnctor_lc;
	}

	::vl::Ptr<::vl::reflection::description::IValueList> __vwsnc5_Rpc_Collection_InByval_OutByref_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_Collection_InByval_OutByref::InvokeMethod_RpcCollection__InByval__OutByref__IService_DoList(::vl::rpc_controller::RpcObjectReference ref, ::vl::Ptr<::vl::reflection::description::IValueList> arg_xs)
	{
		auto arguments = ::vl::reflection::description::IValueArray::Create();
		::vl::__vwsn::This(arguments.Obj())->Resize(static_cast<::vl::vint32_t>(1));
	...
	void __vwsnc6_Rpc_Collection_InByval_OutByref_rpcwrapper_RpcCollection__InByval__OutByref__IService__RpcCollection_InByval_OutByref_IRpcWrapper_IService::DisconnectFromLifecycle()
	{
		(_lc = static_cast<::vl::rpc_controller::IRpcLifecycle*>(nullptr));
		(_ops = ::vl::Ptr<::rpcops_IOps_Rpc_Collection_InByval_OutByref>());
	}

	__vwsnc6_Rpc_Collection_InByval_OutByref_rpcwrapper_RpcCollection__InByval__OutByref__IService__RpcCollection_InByval_OutByref_IRpcWrapper_IService::~__vwsnc6_Rpc_Collection_InByval_OutByref_rpcwrapper_RpcCollection__InByval__OutByref__IService__RpcCollection_InByval_OutByref_IRpcWrapper_IService()
	{
		if ((_lc != nullptr))
		{
	...
	::vl::Ptr<::vl::reflection::description::IValueList> __vwsnc6_Rpc_Collection_InByval_OutByref_rpcwrapper_RpcCollection__InByval__OutByref__IService__RpcCollection_InByval_OutByref_IRpcWrapper_IService::DoList(::vl::Ptr<::vl::reflection::description::IValueList> xs)
	{
		if ((_lc == nullptr))
