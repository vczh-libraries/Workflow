...
***********************************************************************/
	...
	::vl::WString __vwsnc4_Rpc_PropDefault_rpcops_IOps_Create__rpcops_IOps_Rpc_PropDefault::InvokeMethod_RpcPropDefault__IService_GetValue(::vl::rpc_controller::RpcObjectReference ref)
	{
		auto arguments = ::vl::reflection::description::IValueArray::Create();
		::vl::__vwsn::This(arguments.Obj())->Resize(static_cast<::vl::vint32_t>(0));
		return ::vl::__vwsn::Unbox<::vl::WString>(::vl::__vwsn::This(::vl::__vwsn::This(::vl::__vwsn::This(_lc)->GetDispatcher())->SendToClient_ObjectOps(ref.clientId))->InvokeMethod(ref, GLOBAL_NAME rpcmethod_RpcPropDefault__IService_GetValue, arguments));
	}
	...
	void __vwsnc4_Rpc_PropDefault_rpcops_IOps_Create__rpcops_IOps_Rpc_PropDefault::InvokeMethod_RpcPropDefault__IService_SetValue(::vl::rpc_controller::RpcObjectReference ref, const ::vl::WString& arg_value)
	{
		...
		::vl::__vwsn::This(::vl::__vwsn::This(::vl::__vwsn::This(_lc)->GetDispatcher())->SendToClient_ObjectOps(ref.clientId))->InvokeMethod(ref, GLOBAL_NAME rpcmethod_RpcPropDefault__IService_SetValue, arguments);
	}
	...
	void __vwsnc4_Rpc_PropDefault_rpcops_IOps_Create__rpcops_IOps_Rpc_PropDefault::InvokeMethod_RpcPropDefault__IService_Signal(::vl::rpc_controller::RpcObjectReference ref)
	{
		auto arguments = ::vl::reflection::description::IValueArray::Create();
		::vl::__vwsn::This(arguments.Obj())->Resize(static_cast<::vl::vint32_t>(0));
		::vl::__vwsn::This(::vl::__vwsn::This(::vl::__vwsn::This(_lc)->GetDispatcher())->SendToClient_ObjectOps(ref.clientId))->InvokeMethod(ref, GLOBAL_NAME rpcmethod_RpcPropDefault__IService_Signal, arguments);
	}
	...
	{
		{
			...
			if ((__vwsn_switch_8 == GLOBAL_NAME rpcmethod_RpcPropDefault__IService_GetValue))
			{
				auto target = ::vl::__vwsn::Ensure(::vl::__vwsn::SharedPtrCast<::RpcPropDefault::IService>(::vl::__vwsn::This(_lc)->RefToPtr(ref).Obj()));
			...
			else if ((__vwsn_switch_8 == GLOBAL_NAME rpcmethod_RpcPropDefault__IService_SetValue))
			{
				auto target = ::vl::__vwsn::Ensure(::vl::__vwsn::SharedPtrCast<::RpcPropDefault::IService>(::vl::__vwsn::This(_lc)->RefToPtr(ref).Obj()));
			...
			else if ((__vwsn_switch_8 == GLOBAL_NAME rpcmethod_RpcPropDefault__IService_Signal))
			{
				auto target = ::vl::__vwsn::Ensure(::vl::__vwsn::SharedPtrCast<::RpcPropDefault::IService>(::vl::__vwsn::This(_lc)->RefToPtr(ref).Obj()));
				::vl::__vwsn::This(target.Obj())->Signal();
				return ::vl::reflection::description::Value();
			...
			{
				{
					...
					if ((__vwsn_switch_9 == GLOBAL_NAME rpcevent_RpcPropDefault__IService_ValueChanged))
					{
						auto target = ::vl::__vwsn::Ensure(::vl::__vwsn::SharedPtrCast<::RpcPropDefault::IService>(::vl::__vwsn::This(_lc)->RefToPtr(ref).Obj()));
						::vl::__vwsn::EventInvoke(::vl::__vwsn::This(target.Obj())->ValueChanged)();
					}
	...
	::vl::WString __vwsnc9_Rpc_PropDefault_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_PropDefault::InvokeMethod_RpcPropDefault__IService_GetValue(::vl::rpc_controller::RpcObjectReference ref)
	{
		auto arguments = ::vl::reflection::description::IValueArray::Create();
		::vl::__vwsn::This(arguments.Obj())->Resize(static_cast<::vl::vint32_t>(0));
		auto jsonResult = ::vl::__vwsn::Unbox<::vl::Ptr<::vl::glr::json::JsonNode>>(::vl::__vwsn::This(::vl::__vwsn::This(::vl::__vwsn::This(_lc)->GetDispatcher())->SendToClient_ObjectOps(ref.clientId))->InvokeMethod(ref, GLOBAL_NAME rpcmethod_RpcPropDefault__IService_GetValue, arguments));
