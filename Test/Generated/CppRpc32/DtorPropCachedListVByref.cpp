...
***********************************************************************/
	...
	::vl::Ptr<::vl::glr::json::JsonNode> Rpc_DtorPropCachedListVByref::rpcjson_NewNull()
	{
	...
	::vl::glr::ParsingToken Rpc_DtorPropCachedListVByref::rpcjson_NewToken(const ::vl::WString& value)
	{
		return [&](){ ::vl::glr::ParsingToken __vwsn_temp__; __vwsn_temp__.value = value; return __vwsn_temp__; }();
	}

	::vl::Ptr<::vl::glr::json::JsonString> Rpc_DtorPropCachedListVByref::rpcjson_NewString(const ::vl::WString& content)
	{
	...
	::vl::Ptr<::vl::glr::json::JsonNumber> Rpc_DtorPropCachedListVByref::rpcjson_NewNumber(const ::vl::WString& content)
	{
	...
	::vl::Ptr<::vl::glr::json::JsonNode> Rpc_DtorPropCachedListVByref::rpcjson_NewArray2(const ::vl::WString& keyword, ::vl::Ptr<::vl::glr::json::JsonNode> value)
	{
	...
	void Rpc_DtorPropCachedListVByref::rpcjson_ObjectAdd(::vl::Ptr<::vl::glr::json::JsonObject> object, const ::vl::WString& name, ::vl::Ptr<::vl::glr::json::JsonNode> value)
	{
	...
	::vl::Ptr<::vl::glr::json::JsonObject> Rpc_DtorPropCachedListVByref::rpcjson_NewObject(const ::vl::WString& keyword)
	{
	...
	::vl::Ptr<::vl::glr::json::JsonNode> Rpc_DtorPropCachedListVByref::rpcjson_ObjectGet(::vl::Ptr<::vl::glr::json::JsonObject> object, const ::vl::WString& name)
	{
		{
	...
	::vl::Ptr<::vl::glr::json::JsonNode> Rpc_DtorPropCachedListVByref::rpcjson_SerializeCollection(const ::vl::WString& keyword, ::vl::Ptr<::vl::reflection::description::IValueEnumerable> values)
	{
	...
	::vl::Ptr<::vl::glr::json::JsonNode> Rpc_DtorPropCachedListVByref::rpcjson_SerializeMap(::vl::Ptr<::vl::reflection::description::IValueReadonlyDictionary> values)
	{
	...
	{
		{
			...
			{
				return ::vl::Ptr<::vl::rpc_controller::IRpcWrapperBase>(GLOBAL_NAME rpcwrapper_RpcDtorPropCachedListVByref__IValue(lc, ref));
			}
			else if ((__vwsn_switch_7 == GLOBAL_NAME rpctype_RpcDtorPropCachedListVByref__IService))
			{
				return ::vl::Ptr<::vl::rpc_controller::IRpcWrapperBase>(GLOBAL_NAME rpcwrapper_RpcDtorPropCachedListVByref__IService(lc, ref));
			}
			else
...
***********************************************************************/
	...
	::vl::Ptr<::vl::reflection::description::IValueList> __vwsnc6_Rpc_DtorPropCachedListVByref_rpcwrapper_RpcDtorPropCachedListVByref__IService__RpcDtorPropCachedListVByref_IRpcWrapper_IService::GetValue()
	{
		...
		auto arguments = ::vl::reflection::description::IValueArray::Create();
		::vl::__vwsn::This(arguments.Obj())->Resize(static_cast<::vl::vint32_t>(0));
		(__vwsn_Cached_ = ::vl::__vwsn::Unbox<::vl::Ptr<::vl::reflection::description::IValueList>>(::vl::rpc_controller::RpcUnboxByref(::vl::__vwsn::This(::vl::__vwsn::This(::vl::__vwsn::This(_lc)->GetDispatcher())->SendToClient_ObjectOps(_ref.clientId))->InvokeMethod(_ref, GLOBAL_NAME rpcmethod_RpcDtorPropCachedListVByref__IService_GetValue, arguments), _lc)));
	...
	void __vwsnc6_Rpc_DtorPropCachedListVByref_rpcwrapper_RpcDtorPropCachedListVByref__IService__RpcDtorPropCachedListVByref_IRpcWrapper_IService::SetValue(::vl::Ptr<::vl::reflection::description::IValueList> value)
	{
		...
		::vl::__vwsn::This(::vl::__vwsn::This(::vl::__vwsn::This(_lc)->GetDispatcher())->SendToClient_ObjectOps(_ref.clientId))->InvokeMethod(_ref, GLOBAL_NAME rpcmethod_RpcDtorPropCachedListVByref__IService_SetValue, arguments);
	}
	...
	void __vwsnc6_Rpc_DtorPropCachedListVByref_rpcwrapper_RpcDtorPropCachedListVByref__IService__RpcDtorPropCachedListVByref_IRpcWrapper_IService::Signal()
	{
		...
		auto arguments = ::vl::reflection::description::IValueArray::Create();
		::vl::__vwsn::This(arguments.Obj())->Resize(static_cast<::vl::vint32_t>(0));
		::vl::__vwsn::This(::vl::__vwsn::This(::vl::__vwsn::This(_lc)->GetDispatcher())->SendToClient_ObjectOps(_ref.clientId))->InvokeMethod(_ref, GLOBAL_NAME rpcmethod_RpcDtorPropCachedListVByref__IService_Signal, arguments);
	}
