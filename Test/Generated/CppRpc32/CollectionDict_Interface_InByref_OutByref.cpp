...
***********************************************************************/
	...
	::vl::WString __vwsnc5_Rpc_CollectionDict_Interface_InByref_OutByref_rpcwrapper_RpcCollectionDict__Interface__InByref__OutByref__IValue__RpcCollectionDict_Interface_InByref_OutByref_IRpcWrapper_IValue::GetValue()
	{
		...
		return ::vl::__vwsn::Unbox<::vl::WString>(::vl::__vwsn::This(::vl::__vwsn::This(::vl::__vwsn::This(_lc)->GetDispatcher())->SendToClient_ObjectOps(_ref.clientId))->InvokeMethod(_ref, GLOBAL_NAME rpcmethod_RpcCollectionDict__Interface__InByref__OutByref__IValue_GetValue, arguments));
	}
	...
	::vl::Ptr<::vl::reflection::description::IValueDictionary> __vwsnc6_Rpc_CollectionDict_Interface_InByref_OutByref_rpcwrapper_RpcCollectionDict__Interface__InByref__OutByref__IService__RpcCollectionDict_Interface_InByref_OutByref_IRpcWrapper_IService::DoList(::vl::Ptr<::vl::reflection::description::IValueDictionary> xs)
	{
		...
		return ::vl::__vwsn::SharedPtrCast<::vl::reflection::description::IValueDictionary>(::vl::rpc_controller::RpcUnboxByref(::vl::__vwsn::Unbox<::vl::rpc_controller::RpcObjectReference>(::vl::__vwsn::This(::vl::__vwsn::This(::vl::__vwsn::This(_lc)->GetDispatcher())->SendToClient_ObjectOps(_ref.clientId))->InvokeMethod(_ref, GLOBAL_NAME rpcmethod_RpcCollectionDict__Interface__InByref__OutByref__IService_DoList, arguments)), _lc).Obj());
	}
