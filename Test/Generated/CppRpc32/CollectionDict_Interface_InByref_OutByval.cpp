...
***********************************************************************/
	...
	{
		return ::vl::Ptr<::rpcops_IOps_Rpc_CollectionDict_Interface_InByref_OutByval>(new ::vl_workflow_global::__vwsnc6_Rpc_CollectionDict_Interface_InByref_OutByval_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_CollectionDict_Interface_InByref_OutByval(lc));
	}
	...
	{
		auto proxy = ::vl::Ptr<::RpcCollectionDict::Interface::InByref::OutByval::IRpcWrapper_IValue>(new ::vl_workflow_global::__vwsnc7_Rpc_CollectionDict_Interface_InByref_OutByval_rpcwrapper_RpcCollectionDict__Interface__InByref__OutByval__IValue__RpcCollectionDict_Interface_InByref_OutByval_IRpcWrapper_IValue(lc, ops, proxyRef));
	...
	{
		auto proxy = ::vl::Ptr<::RpcCollectionDict::Interface::InByref::OutByval::IRpcWrapper_IService>(new ::vl_workflow_global::__vwsnc8_Rpc_CollectionDict_Interface_InByref_OutByval_rpcwrapper_RpcCollectionDict__Interface__InByref__OutByval__IService__RpcCollectionDict_Interface_InByref_OutByval_IRpcWrapper_IService(lc, ops, proxyRef));
		::vl::__vwsn::This(::vl::__vwsn::This(::vl::__vwsn::This(lc)->GetDispatcher())->SendToClient_ObjectOps(proxyRef.clientId))->ObjectHold(proxyRef, ::vl::__vwsn::This(lc)->GetClientId(), true);
		return proxy;
	}
	...
	{
		{
			...
			if ((__vwsn_switch_6 == GLOBAL_NAME rpctype_RpcCollectionDict__Interface__InByref__OutByval__IValue))
			{
			...
			else if ((__vwsn_switch_6 == GLOBAL_NAME rpctype_RpcCollectionDict__Interface__InByref__OutByval__IService))
			{
...
***********************************************************************/
	...
	void __vwsnc3_Rpc_CollectionDict_Interface_InByref_OutByval_rpc_IRpcObjectOps__vl_rpc_controller_IRpcObjectOps::RegisterService(::vl::vint32_t typeId, ::vl::Ptr<::vl::reflection::IDescriptable> service)
	{
		{
	...
	__vwsnc6_Rpc_CollectionDict_Interface_InByref_OutByval_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_CollectionDict_Interface_InByref_OutByval::__vwsnc6_Rpc_CollectionDict_Interface_InByref_OutByval_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_CollectionDict_Interface_InByref_OutByval(::vl::rpc_controller::IRpcLifecycle* __vwsnctor_lc)
	{
		this->_lc = __vwsnctor_lc;
	}

	::vl::WString __vwsnc6_Rpc_CollectionDict_Interface_InByref_OutByval_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_CollectionDict_Interface_InByref_OutByval::InvokeMethod_RpcCollectionDict__Interface__InByref__OutByval__IValue_GetValue(::vl::rpc_controller::RpcObjectReference ref)
	{
		auto arguments = ::vl::reflection::description::IValueArray::Create();
		::vl::__vwsn::This(arguments.Obj())->Resize(static_cast<::vl::vint32_t>(0));
	...
	::vl::Ptr<::vl::reflection::description::IValueDictionary> __vwsnc6_Rpc_CollectionDict_Interface_InByref_OutByval_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_CollectionDict_Interface_InByref_OutByval::InvokeMethod_RpcCollectionDict__Interface__InByref__OutByval__IService_DoList(::vl::rpc_controller::RpcObjectReference ref, ::vl::Ptr<::vl::reflection::description::IValueDictionary> arg_xs)
	{
		auto arguments = ::vl::reflection::description::IValueArray::Create();
		::vl::__vwsn::This(arguments.Obj())->Resize(static_cast<::vl::vint32_t>(1));
	...
	__vwsnc7_Rpc_CollectionDict_Interface_InByref_OutByval_rpcwrapper_RpcCollectionDict__Interface__InByref__OutByval__IValue__RpcCollectionDict_Interface_InByref_OutByval_IRpcWrapper_IValue::__vwsnc7_Rpc_CollectionDict_Interface_InByref_OutByval_rpcwrapper_RpcCollectionDict__Interface__InByref__OutByval__IValue__RpcCollectionDict_Interface_InByref_OutByval_IRpcWrapper_IValue(::vl::rpc_controller::IRpcLifecycle* __vwsnctor_lc, ::vl::Ptr<::rpcops_IOps_Rpc_CollectionDict_Interface_InByref_OutByval> __vwsnctor_ops, ::vl::rpc_controller::RpcObjectReference __vwsnctor_proxyRef)
	{
		this->_lc = __vwsnctor_lc;
	...
	void __vwsnc7_Rpc_CollectionDict_Interface_InByref_OutByval_rpcwrapper_RpcCollectionDict__Interface__InByref__OutByval__IValue__RpcCollectionDict_Interface_InByref_OutByval_IRpcWrapper_IValue::DisconnectFromLifecycle()
	{
	...
	::vl::WString __vwsnc7_Rpc_CollectionDict_Interface_InByref_OutByval_rpcwrapper_RpcCollectionDict__Interface__InByref__OutByval__IValue__RpcCollectionDict_Interface_InByref_OutByval_IRpcWrapper_IValue::GetValue()
	{
		if ((_lc == nullptr))
	...
	__vwsnc8_Rpc_CollectionDict_Interface_InByref_OutByval_rpcwrapper_RpcCollectionDict__Interface__InByref__OutByval__IService__RpcCollectionDict_Interface_InByref_OutByval_IRpcWrapper_IService::__vwsnc8_Rpc_CollectionDict_Interface_InByref_OutByval_rpcwrapper_RpcCollectionDict__Interface__InByref__OutByval__IService__RpcCollectionDict_Interface_InByref_OutByval_IRpcWrapper_IService(::vl::rpc_controller::IRpcLifecycle* __vwsnctor_lc, ::vl::Ptr<::rpcops_IOps_Rpc_CollectionDict_Interface_InByref_OutByval> __vwsnctor_ops, ::vl::rpc_controller::RpcObjectReference __vwsnctor_proxyRef)
	{
		this->_lc = __vwsnctor_lc;
		this->_ref = __vwsnctor_proxyRef;
		this->_ops = __vwsnctor_ops;
	...
	void __vwsnc8_Rpc_CollectionDict_Interface_InByref_OutByval_rpcwrapper_RpcCollectionDict__Interface__InByref__OutByval__IService__RpcCollectionDict_Interface_InByref_OutByval_IRpcWrapper_IService::DisconnectFromLifecycle()
	{
		(_lc = static_cast<::vl::rpc_controller::IRpcLifecycle*>(nullptr));
		(_ops = ::vl::Ptr<::rpcops_IOps_Rpc_CollectionDict_Interface_InByref_OutByval>());
	}
	...
	::vl::Ptr<::vl::reflection::description::IValueDictionary> __vwsnc8_Rpc_CollectionDict_Interface_InByref_OutByval_rpcwrapper_RpcCollectionDict__Interface__InByref__OutByval__IService__RpcCollectionDict_Interface_InByref_OutByval_IRpcWrapper_IService::DoList(::vl::Ptr<::vl::reflection::description::IValueDictionary> xs)
	{
		if ((_lc == nullptr))
			throw ::vl::Exception(::vl::WString::Unmanaged(L"RPC wrapper has been disconnected from lifecycle."));
