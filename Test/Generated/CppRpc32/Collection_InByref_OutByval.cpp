...
***********************************************************************/
	...
	{
		return ::vl::Ptr<::rpcops_IOps_Rpc_Collection_InByref_OutByval>(new ::vl_workflow_global::__vwsnc5_Rpc_Collection_InByref_OutByval_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_Collection_InByref_OutByval(lc));
	}
	...
	{
		auto proxy = ::vl::Ptr<::RpcCollection::InByref::OutByval::IRpcWrapper_IService>(new ::vl_workflow_global::__vwsnc6_Rpc_Collection_InByref_OutByval_rpcwrapper_RpcCollection__InByref__OutByval__IService__RpcCollection_InByref_OutByval_IRpcWrapper_IService(lc, ops, proxyRef));
	...
	{
		{
			...
			if ((__vwsn_switch_6 == GLOBAL_NAME rpctype_RpcCollection__InByref__OutByval__IService))
			{
...
***********************************************************************/
	...
	::vl::reflection::description::Value __vwsnc2_Rpc_Collection_InByref_OutByval_rpc_IRpcObjectOps__vl_rpc_controller_IRpcObjectOps::InvokeMethod(::vl::rpc_controller::RpcObjectReference ref, ::vl::vint32_t methodId, ::vl::Ptr<::vl::reflection::description::IValueArray> arguments)
	{
		{
	...
	void __vwsnc2_Rpc_Collection_InByref_OutByval_rpc_IRpcObjectOps__vl_rpc_controller_IRpcObjectOps::ObjectHold(::vl::rpc_controller::RpcObjectReference ref, ::vl::vint32_t remoteClientId, bool hold)
	{
		if (hold)
		{
	...
	void __vwsnc2_Rpc_Collection_InByref_OutByval_rpc_IRpcObjectOps__vl_rpc_controller_IRpcObjectOps::RegisterService(::vl::vint32_t typeId, ::vl::Ptr<::vl::reflection::IDescriptable> service)
	{
		{
	...
	void __vwsnc3_Rpc_Collection_InByref_OutByval_rpc_IRpcObjectEventOps__vl_rpc_controller_IRpcObjectEventOps::InvokeEvent(::vl::rpc_controller::RpcObjectReference ref, ::vl::vint32_t eventId, ::vl::Ptr<::vl::reflection::description::IValueArray> arguments)
	{
	...
	__vwsnc5_Rpc_Collection_InByref_OutByval_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_Collection_InByref_OutByval::__vwsnc5_Rpc_Collection_InByref_OutByval_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_Collection_InByref_OutByval(::vl::rpc_controller::IRpcLifecycle* __vwsnctor_lc)
	{
		this->_lc = __vwsnctor_lc;
	}

	::vl::Ptr<::vl::reflection::description::IValueList> __vwsnc5_Rpc_Collection_InByref_OutByval_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_Collection_InByref_OutByval::InvokeMethod_RpcCollection__InByref__OutByval__IService_DoList(::vl::rpc_controller::RpcObjectReference ref, ::vl::Ptr<::vl::reflection::description::IValueList> arg_xs)
	{
		auto arguments = ::vl::reflection::description::IValueArray::Create();
		::vl::__vwsn::This(arguments.Obj())->Resize(static_cast<::vl::vint32_t>(1));
	...
	void __vwsnc6_Rpc_Collection_InByref_OutByval_rpcwrapper_RpcCollection__InByref__OutByval__IService__RpcCollection_InByref_OutByval_IRpcWrapper_IService::DisconnectFromLifecycle()
	{
		(_lc = static_cast<::vl::rpc_controller::IRpcLifecycle*>(nullptr));
		(_ops = ::vl::Ptr<::rpcops_IOps_Rpc_Collection_InByref_OutByval>());
	}

	__vwsnc6_Rpc_Collection_InByref_OutByval_rpcwrapper_RpcCollection__InByref__OutByval__IService__RpcCollection_InByref_OutByval_IRpcWrapper_IService::~__vwsnc6_Rpc_Collection_InByref_OutByval_rpcwrapper_RpcCollection__InByref__OutByval__IService__RpcCollection_InByref_OutByval_IRpcWrapper_IService()
	{
		if ((_lc != nullptr))
		{
	...
	::vl::Ptr<::vl::reflection::description::IValueList> __vwsnc6_Rpc_Collection_InByref_OutByval_rpcwrapper_RpcCollection__InByref__OutByval__IService__RpcCollection_InByref_OutByval_IRpcWrapper_IService::DoList(::vl::Ptr<::vl::reflection::description::IValueList> xs)
	{
		if ((_lc == nullptr))
