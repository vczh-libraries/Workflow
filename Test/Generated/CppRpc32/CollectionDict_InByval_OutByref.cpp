...
***********************************************************************/
	...
	bool Rpc_CollectionDict_InByval_OutByref::rpcwrapper_IsInterfaceTypeId(::vl::vint32_t typeId)
	{
			...
			return true;
		{
			...
			if ((__vwsn_switch_2 == GLOBAL_NAME rpctype_RpcCollectionDict__InByval__OutByref__IService))
				return true;
			else
				return false;
		}
	...
	{
		return ::vl::Ptr<::vl::rpc_controller::IRpcObjectOps>(new ::vl_workflow_global::__vwsnc4_Rpc_CollectionDict_InByval_OutByref_rpcops_IRpcObjectOpsJson__vl_rpc_controller_IRpcObjectOps(lc));
	}
	...
	{
		return ::vl::Ptr<::vl::rpc_controller::IRpcObjectEventOps>(new ::vl_workflow_global::__vwsnc5_Rpc_CollectionDict_InByval_OutByref_rpcops_IRpcObjectEventOpsJson__vl_rpc_controller_IRpcObjectEventOps(lc));
	}
	...
	{
		return ::vl::Ptr<::rpcops_IOps_Rpc_CollectionDict_InByval_OutByref>(new ::vl_workflow_global::__vwsnc6_Rpc_CollectionDict_InByval_OutByref_rpcops_IOps_Create__rpcops_IOps_Rpc_CollectionDict_InByval_OutByref(lc));
	}
	...
	{
		return ::vl::Ptr<::rpcops_IOps_Rpc_CollectionDict_InByval_OutByref>(new ::vl_workflow_global::__vwsnc7_Rpc_CollectionDict_InByval_OutByref_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_CollectionDict_InByval_OutByref(lc));
	}
	...
	{
		auto proxy = ::vl::Ptr<::RpcCollectionDict::InByval::OutByref::IRpcWrapper_IService>(new ::vl_workflow_global::__vwsnc8_Rpc_CollectionDict_InByval_OutByref_rpcwrapper_RpcCollectionDict__InByval__OutByref__IService__RpcCollectionDict_InByval_OutByref_IRpcWrapper_IService(lc, ops, proxyRef));
	...
	{
		{
			...
			if ((__vwsn_switch_8 == GLOBAL_NAME rpctype_RpcCollectionDict__InByval__OutByref__IService))
			{
...
***********************************************************************/
	...
	{
		{
			...
			if ((__vwsn_switch_4 == GLOBAL_NAME rpcmethod_RpcCollectionDict__InByval__OutByref__IService_DoList))
			{
	...
	__vwsnc4_Rpc_CollectionDict_InByval_OutByref_rpcops_IRpcObjectOpsJson__vl_rpc_controller_IRpcObjectOps::__vwsnc4_Rpc_CollectionDict_InByval_OutByref_rpcops_IRpcObjectOpsJson__vl_rpc_controller_IRpcObjectOps(::vl::rpc_controller::IRpcLifecycle* __vwsnctor_lc)
	{
		this->_lc = __vwsnctor_lc;
	}

	::vl::reflection::description::Value __vwsnc4_Rpc_CollectionDict_InByval_OutByref_rpcops_IRpcObjectOpsJson__vl_rpc_controller_IRpcObjectOps::InvokeMethod(::vl::rpc_controller::RpcObjectReference ref, ::vl::vint32_t methodId, ::vl::Ptr<::vl::reflection::description::IValueArray> arguments)
	{
		{
	...
	void __vwsnc4_Rpc_CollectionDict_InByval_OutByref_rpcops_IRpcObjectOpsJson__vl_rpc_controller_IRpcObjectOps::ObjectHold(::vl::rpc_controller::RpcObjectReference ref, ::vl::vint32_t remoteClientId, bool hold)
	{
		if (hold)
		{
			::vl::__vwsn::This(_lc)->LocalObjectHold(ref, remoteClientId);
	...
	void __vwsnc4_Rpc_CollectionDict_InByval_OutByref_rpcops_IRpcObjectOpsJson__vl_rpc_controller_IRpcObjectOps::RegisterService(::vl::vint32_t typeId, ::vl::Ptr<::vl::reflection::IDescriptable> service)
	{
		{
			if (GLOBAL_NAME rpcwrapper_IsCtorInterfaceTypeId(typeId))
			{
	...
	__vwsnc5_Rpc_CollectionDict_InByval_OutByref_rpcops_IRpcObjectEventOpsJson__vl_rpc_controller_IRpcObjectEventOps::__vwsnc5_Rpc_CollectionDict_InByval_OutByref_rpcops_IRpcObjectEventOpsJson__vl_rpc_controller_IRpcObjectEventOps(::vl::rpc_controller::IRpcLifecycle* __vwsnctor_lc)
	{
		this->_lc = __vwsnctor_lc;
	}

	void __vwsnc5_Rpc_CollectionDict_InByval_OutByref_rpcops_IRpcObjectEventOpsJson__vl_rpc_controller_IRpcObjectEventOps::InvokeEvent(::vl::rpc_controller::RpcObjectReference ref, ::vl::vint32_t eventId, ::vl::Ptr<::vl::reflection::description::IValueArray> arguments)
	{
		::vl::__vwsn::This(::vl::__vwsn::This(_lc)->GetController())->SetEventSuppressedFlag(ref, eventId, true);
		{
			auto __vwsnb_0 = [&]()
	...
	__vwsnc6_Rpc_CollectionDict_InByval_OutByref_rpcops_IOps_Create__rpcops_IOps_Rpc_CollectionDict_InByval_OutByref::__vwsnc6_Rpc_CollectionDict_InByval_OutByref_rpcops_IOps_Create__rpcops_IOps_Rpc_CollectionDict_InByval_OutByref(::vl::rpc_controller::IRpcLifecycle* __vwsnctor_lc)
	{
		this->_lc = __vwsnctor_lc;
	}

	::vl::Ptr<::vl::reflection::description::IValueDictionary> __vwsnc6_Rpc_CollectionDict_InByval_OutByref_rpcops_IOps_Create__rpcops_IOps_Rpc_CollectionDict_InByval_OutByref::InvokeMethod_RpcCollectionDict__InByval__OutByref__IService_DoList(::vl::rpc_controller::RpcObjectReference ref, ::vl::Ptr<::vl::reflection::description::IValueDictionary> arg_xs)
	{
		...
		return ::vl::__vwsn::SharedPtrCast<::vl::reflection::description::IValueDictionary>(::vl::rpc_controller::RpcUnboxByref(::vl::__vwsn::Unbox<::vl::rpc_controller::RpcObjectReference>(::vl::__vwsn::This(::vl::__vwsn::This(::vl::__vwsn::This(_lc)->GetDispatcher())->SendToClient_ObjectOps(ref.clientId))->InvokeMethod(ref, GLOBAL_NAME rpcmethod_RpcCollectionDict__InByval__OutByref__IService_DoList, arguments)), _lc).Obj());
	}

	//-------------------------------------------------------------------

	__vwsnc7_Rpc_CollectionDict_InByval_OutByref_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_CollectionDict_InByval_OutByref::__vwsnc7_Rpc_CollectionDict_InByval_OutByref_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_CollectionDict_InByval_OutByref(::vl::rpc_controller::IRpcLifecycle* __vwsnctor_lc)
	{
		this->_lc = __vwsnctor_lc;
	}

	::vl::Ptr<::vl::reflection::description::IValueDictionary> __vwsnc7_Rpc_CollectionDict_InByval_OutByref_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_CollectionDict_InByval_OutByref::InvokeMethod_RpcCollectionDict__InByval__OutByref__IService_DoList(::vl::rpc_controller::RpcObjectReference ref, ::vl::Ptr<::vl::reflection::description::IValueDictionary> arg_xs)
	{
		auto arguments = ::vl::reflection::description::IValueArray::Create();
		::vl::__vwsn::This(arguments.Obj())->Resize(static_cast<::vl::vint32_t>(1));
	...
	__vwsnc8_Rpc_CollectionDict_InByval_OutByref_rpcwrapper_RpcCollectionDict__InByval__OutByref__IService__RpcCollectionDict_InByval_OutByref_IRpcWrapper_IService::__vwsnc8_Rpc_CollectionDict_InByval_OutByref_rpcwrapper_RpcCollectionDict__InByval__OutByref__IService__RpcCollectionDict_InByval_OutByref_IRpcWrapper_IService(::vl::rpc_controller::IRpcLifecycle* __vwsnctor_lc, ::vl::Ptr<::rpcops_IOps_Rpc_CollectionDict_InByval_OutByref> __vwsnctor_ops, ::vl::rpc_controller::RpcObjectReference __vwsnctor_proxyRef)
	{
		this->_lc = __vwsnctor_lc;
	...
	void __vwsnc8_Rpc_CollectionDict_InByval_OutByref_rpcwrapper_RpcCollectionDict__InByval__OutByref__IService__RpcCollectionDict_InByval_OutByref_IRpcWrapper_IService::DisconnectFromLifecycle()
	{
	...
	::vl::Ptr<::vl::reflection::description::IValueDictionary> __vwsnc8_Rpc_CollectionDict_InByval_OutByref_rpcwrapper_RpcCollectionDict__InByval__OutByref__IService__RpcCollectionDict_InByval_OutByref_IRpcWrapper_IService::DoList(::vl::Ptr<::vl::reflection::description::IValueDictionary> xs)
	{
		if ((_lc == nullptr))
