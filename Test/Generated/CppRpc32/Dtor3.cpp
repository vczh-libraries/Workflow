...
***********************************************************************/
	...
	{
		{
			...
			if ((__vwsn_switch_7 == GLOBAL_NAME rpcmethod_RpcDtor3Test__IContainer_GetValue))
			{
			...
			else if ((__vwsn_switch_7 == GLOBAL_NAME rpcmethod_RpcDtor3Test__IService_ContainValue))
			{
				...
				auto jsonNode1 = GLOBAL_NAME rpcjson_Serialize(::vl::rpc_controller::RpcBoxByval(::vl::Ptr<::vl::reflection::IDescriptable>(::vl::__vwsn::This(target.Obj())->ContainValue(::vl::__vwsn::SharedPtrCast<::RpcDtor3Test::IValue>(::vl::rpc_controller::RpcUnboxByval(jsonValue0, _lc).Obj()))), _lc));
	...
	::vl::Ptr<::RpcDtor3Test::IContainer> __vwsnc13_Rpc_Dtor3_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_Dtor3::InvokeMethod_RpcDtor3Test__IService_ContainValue(::vl::rpc_controller::RpcObjectReference ref, ::vl::Ptr<::RpcDtor3Test::IValue> arg_value)
	{
		...
		return ::vl::__vwsn::SharedPtrCast<::RpcDtor3Test::IContainer>(::vl::rpc_controller::RpcUnboxByval(jsonValue1, _lc).Obj());
	}
	...
	{
		{
			...
			{
				auto target = ::vl::__vwsn::Ensure(::vl::__vwsn::SharedPtrCast<::RpcDtor3Test::IService>(::vl::__vwsn::This(_lc)->RefToPtr(ref).Obj()));
				return ::vl::rpc_controller::RpcBoxByval(::vl::Ptr<::vl::reflection::IDescriptable>(::vl::__vwsn::This(target.Obj())->ContainValue(::vl::__vwsn::SharedPtrCast<::RpcDtor3Test::IValue>(::vl::rpc_controller::RpcUnboxByval(::vl::__vwsn::Unbox<::vl::reflection::description::Value>(::vl::__vwsn::This(arguments.Obj())->Get(static_cast<::vl::vint32_t>(0))), _lc).Obj()))), _lc);
			}
			else
				throw ::vl::Exception(::vl::WString::Unmanaged(L"Unknown RPC method id."));
		}
