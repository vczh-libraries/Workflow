...
***********************************************************************/
	...
	{
		return ::vl::Ptr<::vl::rpc_controller::IRpcObjectOps>(new ::vl_workflow_global::__vwsnc10_Rpc_Dtor3_rpcops_IRpcObjectOpsJson__vl_rpc_controller_IRpcObjectOps(lc));
	}

	::vl::Ptr<::vl::rpc_controller::IRpcObjectEventOps> Rpc_Dtor3::rpcops_IRpcObjectEventOpsJson(::vl::rpc_controller::IRpcLifecycle* lc)
	{
		return ::vl::Ptr<::vl::rpc_controller::IRpcObjectEventOps>(new ::vl_workflow_global::__vwsnc11_Rpc_Dtor3_rpcops_IRpcObjectEventOpsJson__vl_rpc_controller_IRpcObjectEventOps(lc));
	}

	::vl::Ptr<::rpcops_IOps_Rpc_Dtor3> Rpc_Dtor3::rpcops_IOps_CreateJson(::vl::rpc_controller::IRpcLifecycle* lc)
	{
		return ::vl::Ptr<::rpcops_IOps_Rpc_Dtor3>(new ::vl_workflow_global::__vwsnc12_Rpc_Dtor3_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_Dtor3(lc));
	}
...
***********************************************************************/
	...
	__vwsnc10_Rpc_Dtor3_rpcops_IRpcObjectOpsJson__vl_rpc_controller_IRpcObjectOps::__vwsnc10_Rpc_Dtor3_rpcops_IRpcObjectOpsJson__vl_rpc_controller_IRpcObjectOps(::vl::rpc_controller::IRpcLifecycle* __vwsnctor_lc)
	{
		this->_lc = __vwsnctor_lc;
	}

	::vl::reflection::description::Value __vwsnc10_Rpc_Dtor3_rpcops_IRpcObjectOpsJson__vl_rpc_controller_IRpcObjectOps::InvokeMethod(::vl::rpc_controller::RpcObjectReference ref, ::vl::vint32_t methodId, ::vl::Ptr<::vl::reflection::description::IValueArray> arguments)
	{
		{
	...
	void __vwsnc10_Rpc_Dtor3_rpcops_IRpcObjectOpsJson__vl_rpc_controller_IRpcObjectOps::ObjectHold(::vl::rpc_controller::RpcObjectReference ref, ::vl::vint32_t remoteClientId, bool hold)
	{
		if (hold)
		{
	...
	void __vwsnc10_Rpc_Dtor3_rpcops_IRpcObjectOpsJson__vl_rpc_controller_IRpcObjectOps::RegisterService(::vl::vint32_t typeId, ::vl::Ptr<::vl::reflection::IDescriptable> service)
	{
		{
	...
	__vwsnc11_Rpc_Dtor3_rpcops_IRpcObjectEventOpsJson__vl_rpc_controller_IRpcObjectEventOps::__vwsnc11_Rpc_Dtor3_rpcops_IRpcObjectEventOpsJson__vl_rpc_controller_IRpcObjectEventOps(::vl::rpc_controller::IRpcLifecycle* __vwsnctor_lc)
	{
		this->_lc = __vwsnctor_lc;
	}

	void __vwsnc11_Rpc_Dtor3_rpcops_IRpcObjectEventOpsJson__vl_rpc_controller_IRpcObjectEventOps::InvokeEvent(::vl::rpc_controller::RpcObjectReference ref, ::vl::vint32_t eventId, ::vl::Ptr<::vl::reflection::description::IValueArray> arguments)
	{
	...
	__vwsnc12_Rpc_Dtor3_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_Dtor3::__vwsnc12_Rpc_Dtor3_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_Dtor3(::vl::rpc_controller::IRpcLifecycle* __vwsnctor_lc)
	{
		this->_lc = __vwsnctor_lc;
	}

	::vl::Ptr<::RpcDtor3Test::IValue> __vwsnc12_Rpc_Dtor3_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_Dtor3::InvokeMethod_RpcDtor3Test__IContainer_GetValue(::vl::rpc_controller::RpcObjectReference ref)
	{
	...
	::vl::Ptr<::RpcDtor3Test::IContainer> __vwsnc12_Rpc_Dtor3_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_Dtor3::InvokeMethod_RpcDtor3Test__IService_ContainValue(::vl::rpc_controller::RpcObjectReference ref, ::vl::Ptr<::RpcDtor3Test::IValue> arg_value)
	{
		auto arguments = ::vl::reflection::description::IValueArray::Create();
