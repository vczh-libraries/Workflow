	...
	{
		{
			...
			{
				auto target = ::vl::__vwsn::Ensure(::vl::__vwsn::SharedPtrCast<::RpcDtor2Test::IService>(::vl::__vwsn::This(_lc)->RefToPtr(ref).Obj()));
				auto jsonValue0 = ::vl::rpc_controller::RpcBoxByval(::vl::Ptr<::vl::reflection::IDescriptable>(::vl::__vwsn::This(target.Obj())->MakeValue()), _lc);
				auto jsonNode1 = GLOBAL_NAME rpcjson_Serialize(jsonValue0);
				::vl::rpc_controller::RpcTransferByvalKeepAlive(jsonValue0, ::vl::__vwsn::Box(jsonNode1));
			...
			else if ((__vwsn_switch_7 == GLOBAL_NAME rpcmethod_RpcDtor2Test__IService_ReviewValue))
			{
				...
				auto jsonValue1 = ::vl::rpc_controller::RpcBoxByval(::vl::Ptr<::vl::reflection::IDescriptable>(::vl::__vwsn::This(target.Obj())->ReviewValue(::vl::__vwsn::SharedPtrCast<::RpcDtor2Test::IValue>(::vl::rpc_controller::RpcUnboxByval(jsonValue0, _lc).Obj()))), _lc);
