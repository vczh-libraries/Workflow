...
***********************************************************************/
	...
	bool Rpc_Dtor2::rpcwrapper_IsInterfaceTypeId(::vl::vint32_t typeId)
	{
			...
			return true;
		{
			...
			if ((__vwsn_switch_2 == GLOBAL_NAME rpctype_RpcDtor2Test__IValue))
				return true;
			else if ((__vwsn_switch_2 == GLOBAL_NAME rpctype_RpcDtor2Test__IService))
				return true;
			else
				return false;
		}
	...
	{
		return ::vl::Ptr<::vl::rpc_controller::IRpcObjectOps>(new ::vl_workflow_global::__vwsnc5_Rpc_Dtor2_rpcops_IRpcObjectOpsJson__vl_rpc_controller_IRpcObjectOps(lc));
	}

	::vl::Ptr<::vl::rpc_controller::IRpcObjectEventOps> Rpc_Dtor2::rpcops_IRpcObjectEventOpsJson(::vl::rpc_controller::IRpcLifecycle* lc)
	{
		return ::vl::Ptr<::vl::rpc_controller::IRpcObjectEventOps>(new ::vl_workflow_global::__vwsnc6_Rpc_Dtor2_rpcops_IRpcObjectEventOpsJson__vl_rpc_controller_IRpcObjectEventOps(lc));
	}

	::vl::Ptr<::rpcops_IOps_Rpc_Dtor2> Rpc_Dtor2::rpcops_IOps_Create(::vl::rpc_controller::IRpcLifecycle* lc)
	{
		return ::vl::Ptr<::rpcops_IOps_Rpc_Dtor2>(new ::vl_workflow_global::__vwsnc7_Rpc_Dtor2_rpcops_IOps_Create__rpcops_IOps_Rpc_Dtor2(lc));
	}

	::vl::Ptr<::rpcops_IOps_Rpc_Dtor2> Rpc_Dtor2::rpcops_IOps_CreateJson(::vl::rpc_controller::IRpcLifecycle* lc)
	{
		return ::vl::Ptr<::rpcops_IOps_Rpc_Dtor2>(new ::vl_workflow_global::__vwsnc8_Rpc_Dtor2_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_Dtor2(lc));
	}
	...
	{
		auto proxy = ::vl::Ptr<::RpcDtor2Test::IRpcWrapper_IValue>(new ::vl_workflow_global::__vwsnc9_Rpc_Dtor2_rpcwrapper_RpcDtor2Test__IValue__RpcDtor2Test_IRpcWrapper_IValue(lc, ops, proxyRef));
	...
	{
		auto proxy = ::vl::Ptr<::RpcDtor2Test::IRpcWrapper_IService>(new ::vl_workflow_global::__vwsnc10_Rpc_Dtor2_rpcwrapper_RpcDtor2Test__IService__RpcDtor2Test_IRpcWrapper_IService(lc, ops, proxyRef));
		::vl::__vwsn::This(::vl::__vwsn::This(::vl::__vwsn::This(lc)->GetDispatcher())->SendToClient_ObjectOps(proxyRef.clientId))->ObjectHold(proxyRef, ::vl::__vwsn::This(lc)->GetClientId(), true);
		return proxy;
	}
	...
	{
		{
			...
			if ((__vwsn_switch_8 == GLOBAL_NAME rpctype_RpcDtor2Test__IValue))
			{
				return ::vl::Ptr<::vl::rpc_controller::IRpcWrapperBase>(GLOBAL_NAME rpcwrapper_RpcDtor2Test__IValue(lc, ref, ops));
			}
			else if ((__vwsn_switch_8 == GLOBAL_NAME rpctype_RpcDtor2Test__IService))
			{
...
***********************************************************************/
	...
	void __vwsnc10_Rpc_Dtor2_rpcwrapper_RpcDtor2Test__IService__RpcDtor2Test_IRpcWrapper_IService::DisconnectFromLifecycle()
	{
		(_lc = static_cast<::vl::rpc_controller::IRpcLifecycle*>(nullptr));
		(_ops = ::vl::Ptr<::rpcops_IOps_Rpc_Dtor2>());
	}

	__vwsnc10_Rpc_Dtor2_rpcwrapper_RpcDtor2Test__IService__RpcDtor2Test_IRpcWrapper_IService::~__vwsnc10_Rpc_Dtor2_rpcwrapper_RpcDtor2Test__IService__RpcDtor2Test_IRpcWrapper_IService()
	{
		if ((_lc != nullptr))
		{
	...
	::vl::Ptr<::RpcDtor2Test::IValue> __vwsnc10_Rpc_Dtor2_rpcwrapper_RpcDtor2Test__IService__RpcDtor2Test_IRpcWrapper_IService::MakeValue()
	{
		if ((_lc == nullptr))
	...
	::vl::Ptr<::RpcDtor2Test::IValue> __vwsnc10_Rpc_Dtor2_rpcwrapper_RpcDtor2Test__IService__RpcDtor2Test_IRpcWrapper_IService::ReviewValue(::vl::Ptr<::RpcDtor2Test::IValue> value)
	{
		if ((_lc == nullptr))
			throw ::vl::Exception(::vl::WString::Unmanaged(L"RPC wrapper has been disconnected from lifecycle."));
	...
	{
		{
			...
			if ((__vwsn_switch_4 == GLOBAL_NAME rpcmethod_RpcDtor2Test__IService_MakeValue))
			{
				auto target = ::vl::__vwsn::Ensure(::vl::__vwsn::SharedPtrCast<::RpcDtor2Test::IService>(::vl::__vwsn::This(_lc)->RefToPtr(ref).Obj()));
				return ::vl::rpc_controller::RpcBoxByval(::vl::Ptr<::vl::reflection::IDescriptable>(::vl::__vwsn::This(target.Obj())->MakeValue()), _lc);
			}
			else if ((__vwsn_switch_4 == GLOBAL_NAME rpcmethod_RpcDtor2Test__IService_ReviewValue))
			{
				auto target = ::vl::__vwsn::Ensure(::vl::__vwsn::SharedPtrCast<::RpcDtor2Test::IService>(::vl::__vwsn::This(_lc)->RefToPtr(ref).Obj()));
				return ::vl::rpc_controller::RpcBoxByval(::vl::Ptr<::vl::reflection::IDescriptable>(::vl::__vwsn::This(target.Obj())->ReviewValue(::vl::__vwsn::SharedPtrCast<::RpcDtor2Test::IValue>(::vl::rpc_controller::RpcUnboxByval(::vl::__vwsn::Unbox<::vl::reflection::description::Value>(::vl::__vwsn::This(arguments.Obj())->Get(static_cast<::vl::vint32_t>(0))), _lc).Obj()))), _lc);
			}
			else
	...
	__vwsnc5_Rpc_Dtor2_rpcops_IRpcObjectOpsJson__vl_rpc_controller_IRpcObjectOps::__vwsnc5_Rpc_Dtor2_rpcops_IRpcObjectOpsJson__vl_rpc_controller_IRpcObjectOps(::vl::rpc_controller::IRpcLifecycle* __vwsnctor_lc)
	{
		this->_lc = __vwsnctor_lc;
	}

	::vl::reflection::description::Value __vwsnc5_Rpc_Dtor2_rpcops_IRpcObjectOpsJson__vl_rpc_controller_IRpcObjectOps::InvokeMethod(::vl::rpc_controller::RpcObjectReference ref, ::vl::vint32_t methodId, ::vl::Ptr<::vl::reflection::description::IValueArray> arguments)
	{
		{
			...
			{
				auto target = ::vl::__vwsn::Ensure(::vl::__vwsn::SharedPtrCast<::RpcDtor2Test::IService>(::vl::__vwsn::This(_lc)->RefToPtr(ref).Obj()));
				auto jsonNode0 = GLOBAL_NAME rpcjson_Serialize(::vl::rpc_controller::RpcBoxByval(::vl::Ptr<::vl::reflection::IDescriptable>(::vl::__vwsn::This(target.Obj())->MakeValue()), _lc));
			...
			else if ((__vwsn_switch_6 == GLOBAL_NAME rpcmethod_RpcDtor2Test__IService_ReviewValue))
			{
				...
				auto jsonNode1 = GLOBAL_NAME rpcjson_Serialize(::vl::rpc_controller::RpcBoxByval(::vl::Ptr<::vl::reflection::IDescriptable>(::vl::__vwsn::This(target.Obj())->ReviewValue(::vl::__vwsn::SharedPtrCast<::RpcDtor2Test::IValue>(::vl::rpc_controller::RpcUnboxByval(jsonValue0, _lc).Obj()))), _lc));
	...
	void __vwsnc5_Rpc_Dtor2_rpcops_IRpcObjectOpsJson__vl_rpc_controller_IRpcObjectOps::ObjectHold(::vl::rpc_controller::RpcObjectReference ref, ::vl::vint32_t remoteClientId, bool hold)
	{
		if (hold)
		{
			::vl::__vwsn::This(_lc)->LocalObjectHold(ref, remoteClientId);
	...
	void __vwsnc5_Rpc_Dtor2_rpcops_IRpcObjectOpsJson__vl_rpc_controller_IRpcObjectOps::RegisterService(::vl::vint32_t typeId, ::vl::Ptr<::vl::reflection::IDescriptable> service)
	{
		{
			if (GLOBAL_NAME rpcwrapper_IsCtorInterfaceTypeId(typeId))
			{
	...
	__vwsnc6_Rpc_Dtor2_rpcops_IRpcObjectEventOpsJson__vl_rpc_controller_IRpcObjectEventOps::__vwsnc6_Rpc_Dtor2_rpcops_IRpcObjectEventOpsJson__vl_rpc_controller_IRpcObjectEventOps(::vl::rpc_controller::IRpcLifecycle* __vwsnctor_lc)
	{
		this->_lc = __vwsnctor_lc;
	}

	void __vwsnc6_Rpc_Dtor2_rpcops_IRpcObjectEventOpsJson__vl_rpc_controller_IRpcObjectEventOps::InvokeEvent(::vl::rpc_controller::RpcObjectReference ref, ::vl::vint32_t eventId, ::vl::Ptr<::vl::reflection::description::IValueArray> arguments)
	{
		::vl::__vwsn::This(::vl::__vwsn::This(_lc)->GetController())->SetEventSuppressedFlag(ref, eventId, true);
		{
			auto __vwsnb_0 = [&]()
	...
	__vwsnc7_Rpc_Dtor2_rpcops_IOps_Create__rpcops_IOps_Rpc_Dtor2::__vwsnc7_Rpc_Dtor2_rpcops_IOps_Create__rpcops_IOps_Rpc_Dtor2(::vl::rpc_controller::IRpcLifecycle* __vwsnctor_lc)
	{
		this->_lc = __vwsnctor_lc;
	}

	::vl::Ptr<::RpcDtor2Test::IValue> __vwsnc7_Rpc_Dtor2_rpcops_IOps_Create__rpcops_IOps_Rpc_Dtor2::InvokeMethod_RpcDtor2Test__IService_MakeValue(::vl::rpc_controller::RpcObjectReference ref)
	{
	...
	::vl::Ptr<::RpcDtor2Test::IValue> __vwsnc7_Rpc_Dtor2_rpcops_IOps_Create__rpcops_IOps_Rpc_Dtor2::InvokeMethod_RpcDtor2Test__IService_ReviewValue(::vl::rpc_controller::RpcObjectReference ref, ::vl::Ptr<::RpcDtor2Test::IValue> arg_value)
	{
		auto arguments = ::vl::reflection::description::IValueArray::Create();
	...
	__vwsnc8_Rpc_Dtor2_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_Dtor2::__vwsnc8_Rpc_Dtor2_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_Dtor2(::vl::rpc_controller::IRpcLifecycle* __vwsnctor_lc)
	{
		this->_lc = __vwsnctor_lc;
	}

	::vl::Ptr<::RpcDtor2Test::IValue> __vwsnc8_Rpc_Dtor2_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_Dtor2::InvokeMethod_RpcDtor2Test__IService_MakeValue(::vl::rpc_controller::RpcObjectReference ref)
	{
		auto arguments = ::vl::reflection::description::IValueArray::Create();
		::vl::__vwsn::This(arguments.Obj())->Resize(static_cast<::vl::vint32_t>(0));
	...
	::vl::Ptr<::RpcDtor2Test::IValue> __vwsnc8_Rpc_Dtor2_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_Dtor2::InvokeMethod_RpcDtor2Test__IService_ReviewValue(::vl::rpc_controller::RpcObjectReference ref, ::vl::Ptr<::RpcDtor2Test::IValue> arg_value)
	{
		auto arguments = ::vl::reflection::description::IValueArray::Create();
		::vl::__vwsn::This(arguments.Obj())->Resize(static_cast<::vl::vint32_t>(1));
		...
		return ::vl::__vwsn::SharedPtrCast<::RpcDtor2Test::IValue>(::vl::rpc_controller::RpcUnboxByval(jsonValue1, _lc).Obj());
	}

	//-------------------------------------------------------------------

	__vwsnc9_Rpc_Dtor2_rpcwrapper_RpcDtor2Test__IValue__RpcDtor2Test_IRpcWrapper_IValue::__vwsnc9_Rpc_Dtor2_rpcwrapper_RpcDtor2Test__IValue__RpcDtor2Test_IRpcWrapper_IValue(::vl::rpc_controller::IRpcLifecycle* __vwsnctor_lc, ::vl::Ptr<::rpcops_IOps_Rpc_Dtor2> __vwsnctor_ops, ::vl::rpc_controller::RpcObjectReference __vwsnctor_proxyRef)
	{
		this->_lc = __vwsnctor_lc;
		this->_ref = __vwsnctor_proxyRef;
		this->_ops = __vwsnctor_ops;
	...
	void __vwsnc9_Rpc_Dtor2_rpcwrapper_RpcDtor2Test__IValue__RpcDtor2Test_IRpcWrapper_IValue::DisconnectFromLifecycle()
	{
		(_lc = static_cast<::vl::rpc_controller::IRpcLifecycle*>(nullptr));
		(_ops = ::vl::Ptr<::rpcops_IOps_Rpc_Dtor2>());
	}

	__vwsnc9_Rpc_Dtor2_rpcwrapper_RpcDtor2Test__IValue__RpcDtor2Test_IRpcWrapper_IValue::~__vwsnc9_Rpc_Dtor2_rpcwrapper_RpcDtor2Test__IValue__RpcDtor2Test_IRpcWrapper_IValue()
	{
		if ((_lc != nullptr))
		{
			::vl::__vwsn::This(::vl::__vwsn::This(::vl::__vwsn::This(_lc)->GetDispatcher())->SendToClient_ObjectOps(_ref.clientId))->ObjectHold(_ref, ::vl::__vwsn::This(_lc)->GetClientId(), false);
