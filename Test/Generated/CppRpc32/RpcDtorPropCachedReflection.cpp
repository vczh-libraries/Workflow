...
namespace vl
{
	namespace reflection
	{
		namespace description
		{
			...
			IMPL_CPP_TYPE_INFO(RpcDtorPropCached::IRpcWrapper_IService)
...
#define _ ,
			BEGIN_INTERFACE_MEMBER(::RpcDtorPropCached::IRpcWrapper_IService)
				CLASS_MEMBER_BASE(::RpcDtorPropCached::IService)
				CLASS_MEMBER_BASE(::vl::rpc_controller::IRpcWrapperBase)
				CLASS_MEMBER_METHOD(_rpcInvalidate_Value, NO_PARAMETER)
			END_INTERFACE_MEMBER(::RpcDtorPropCached::IRpcWrapper_IService)

			BEGIN_INTERFACE_MEMBER(::RpcDtorPropCached::IRpcWrapper_IValue)
				CLASS_MEMBER_BASE(::RpcDtorPropCached::IValue)
				CLASS_MEMBER_BASE(::vl::rpc_controller::IRpcWrapperBase)
			END_INTERFACE_MEMBER(::RpcDtorPropCached::IRpcWrapper_IValue)

			BEGIN_INTERFACE_MEMBER(::RpcDtorPropCached::IService)
			...
			END_INTERFACE_MEMBER(::RpcDtorPropCached::IService)

			BEGIN_INTERFACE_MEMBER(::RpcDtorPropCached::IValue)
				ATTRIBUTE_TYPE(::vl::__vwsn::att_rpc_Interface)
				CLASS_MEMBER_BASE(::vl::reflection::IDescriptable)
			...
			BEGIN_INTERFACE_MEMBER(::rpcops_IOps_Rpc_DtorPropCached)
				...
				CLASS_MEMBER_METHOD(InvokeMethod_RpcDtorPropCached__IService_ConsumeServiceResult, { L"ref" })
...
#undef _
			...
			public:
				...
				{
					ADD_TYPE_INFO(::RpcDtorPropCached::IRpcWrapper_IService)
			...
			bool LoadRpc_DtorPropCachedTypes()
			{
#ifdef VCZH_DESCRIPTABLEOBJECT_WITH_METADATA
				if (auto manager = GetGlobalTypeManager())
				{
					return manager->AddTypeLoader(Ptr(new Rpc_DtorPropCachedTypeLoader));
				}
#endif
				return false;
			}
