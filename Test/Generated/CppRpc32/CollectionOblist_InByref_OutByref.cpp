...
***********************************************************************/
	...
	::vl::Ptr<::vl::glr::json::JsonNode> Rpc_CollectionOblist_InByref_OutByref::rpcjson_NewNull()
	{
	...
	::vl::glr::ParsingToken Rpc_CollectionOblist_InByref_OutByref::rpcjson_NewToken(const ::vl::WString& value)
	{
		return [&](){ ::vl::glr::ParsingToken __vwsn_temp__; __vwsn_temp__.value = value; return __vwsn_temp__; }();
	}

	::vl::Ptr<::vl::glr::json::JsonString> Rpc_CollectionOblist_InByref_OutByref::rpcjson_NewString(const ::vl::WString& content)
	{
	...
	::vl::Ptr<::vl::glr::json::JsonNumber> Rpc_CollectionOblist_InByref_OutByref::rpcjson_NewNumber(const ::vl::WString& content)
	{
	...
	::vl::Ptr<::vl::glr::json::JsonNode> Rpc_CollectionOblist_InByref_OutByref::rpcjson_NewArray2(const ::vl::WString& keyword, ::vl::Ptr<::vl::glr::json::JsonNode> value)
	{
	...
	void Rpc_CollectionOblist_InByref_OutByref::rpcjson_ObjectAdd(::vl::Ptr<::vl::glr::json::JsonObject> object, const ::vl::WString& name, ::vl::Ptr<::vl::glr::json::JsonNode> value)
	{
	...
	::vl::Ptr<::vl::glr::json::JsonObject> Rpc_CollectionOblist_InByref_OutByref::rpcjson_NewObject(const ::vl::WString& keyword)
	{
	...
	::vl::Ptr<::vl::glr::json::JsonNode> Rpc_CollectionOblist_InByref_OutByref::rpcjson_ObjectGet(::vl::Ptr<::vl::glr::json::JsonObject> object, const ::vl::WString& name)
	{
		{
	...
	::vl::Ptr<::vl::glr::json::JsonNode> Rpc_CollectionOblist_InByref_OutByref::rpcjson_SerializeCollection(const ::vl::WString& keyword, ::vl::Ptr<::vl::reflection::description::IValueEnumerable> values)
	{
	...
	::vl::Ptr<::vl::glr::json::JsonNode> Rpc_CollectionOblist_InByref_OutByref::rpcjson_SerializeMap(::vl::Ptr<::vl::reflection::description::IValueReadonlyDictionary> values)
	{
	...
	::vl::Ptr<::RpcCollectionOblist::InByref::OutByref::IRpcWrapper_IService> Rpc_CollectionOblist_InByref_OutByref::rpcwrapper_RpcCollectionOblist__InByref__OutByref__IService(::vl::rpc_controller::IRpcLifecycle* lc, ::vl::rpc_controller::RpcObjectReference proxyRef)
	{
	...
	::vl::Ptr<::vl::rpc_controller::IRpcWrapperBase> Rpc_CollectionOblist_InByref_OutByref::rpcwrapper_Create(::vl::rpc_controller::RpcObjectReference ref, ::vl::rpc_controller::IRpcLifecycle* lc)
	{
		{
			auto __vwsn_switch_6 = ref.typeId;
			if ((__vwsn_switch_6 == GLOBAL_NAME rpctype_RpcCollectionOblist__InByref__OutByref__IService))
			{
				return ::vl::Ptr<::vl::rpc_controller::IRpcWrapperBase>(GLOBAL_NAME rpcwrapper_RpcCollectionOblist__InByref__OutByref__IService(lc, ref));
			}
			else
...
***********************************************************************/
	...
	::vl::Ptr<::vl::reflection::description::IValueObservableList> __vwsnc4_Rpc_CollectionOblist_InByref_OutByref_rpcwrapper_RpcCollectionOblist__InByref__OutByref__IService__RpcCollectionOblist_InByref_OutByref_IRpcWrapper_IService::DoList(::vl::Ptr<::vl::reflection::description::IValueObservableList> xs)
	{
		...
		return ::vl::__vwsn::Unbox<::vl::Ptr<::vl::reflection::description::IValueObservableList>>(::vl::rpc_controller::RpcUnboxByref(::vl::__vwsn::This(::vl::__vwsn::This(::vl::__vwsn::This(_lc)->GetDispatcher())->SendToClient_ObjectOps(_ref.clientId))->InvokeMethod(_ref, GLOBAL_NAME rpcmethod_RpcCollectionOblist__InByref__OutByref__IService_DoList, arguments), _lc));
	}
