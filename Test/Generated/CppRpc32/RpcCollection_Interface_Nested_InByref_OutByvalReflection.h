...
#ifndef VCZH_WORKFLOW_COMPILER_GENERATED_RPCCOLLECTION_INTERFACE_NESTED_INBYREF_OUTBYVALREFLECTION
#define VCZH_WORKFLOW_COMPILER_GENERATED_RPCCOLLECTION_INTERFACE_NESTED_INBYREF_OUTBYVALREFLECTION
	...
	namespace reflection
	{
		namespace description
		{
			...
			BEGIN_INTERFACE_PROXY_NOPARENT_SHAREDPTR(::rpcops_IOps_Rpc_Collection_Interface_Nested_InByref_OutByval)
				...
				{
					INVOKEGET_INTERFACE_PROXY(InvokeMethod_RpcCollection__Interface__Nested__InByref__OutByval__IService_GetServiceResult, ref);
				}
