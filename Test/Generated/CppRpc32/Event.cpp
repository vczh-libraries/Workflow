...
***********************************************************************/
	...
	{
		return ::vl::Ptr<::vl::rpc_controller::IRpcObjectOps>(new ::vl_workflow_global::__vwsnc4_Rpc_Event_rpcops_IRpcObjectOpsJson__vl_rpc_controller_IRpcObjectOps(lc));
	}

	::vl::Ptr<::vl::rpc_controller::IRpcObjectEventOps> Rpc_Event::rpcops_IRpcObjectEventOpsJson(::vl::rpc_controller::IRpcLifecycle* lc)
	{
		return ::vl::Ptr<::vl::rpc_controller::IRpcObjectEventOps>(new ::vl_workflow_global::__vwsnc5_Rpc_Event_rpcops_IRpcObjectEventOpsJson__vl_rpc_controller_IRpcObjectEventOps(lc));
	}

	::vl::Ptr<::rpcops_IOps_Rpc_Event> Rpc_Event::rpcops_IOps_Create(::vl::rpc_controller::IRpcLifecycle* lc)
	{
		return ::vl::Ptr<::rpcops_IOps_Rpc_Event>(new ::vl_workflow_global::__vwsnc6_Rpc_Event_rpcops_IOps_Create__rpcops_IOps_Rpc_Event(lc));
	}

	::vl::Ptr<::rpcops_IOps_Rpc_Event> Rpc_Event::rpcops_IOps_CreateJson(::vl::rpc_controller::IRpcLifecycle* lc)
	{
		return ::vl::Ptr<::rpcops_IOps_Rpc_Event>(new ::vl_workflow_global::__vwsnc7_Rpc_Event_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_Event(lc));
	}
	...
	{
		{
			...
			if ((__vwsn_switch_8 == GLOBAL_NAME rpctype_RpcEvent__IService))
			{
	...
	{
		auto proxy = ::vl::Ptr<::RpcEvent::IRpcWrapper_IService>(new ::vl_workflow_global::__vwsnc8_Rpc_Event_rpcwrapper_RpcEvent__IService__RpcEvent_IRpcWrapper_IService(lc, ops, proxyRef));
	...
	{
		{
			...
			if ((__vwsn_switch_9 == GLOBAL_NAME rpctype_RpcEvent__IService))
			{
...
***********************************************************************/
	...
	{
		{
			...
			if ((__vwsn_switch_4 == GLOBAL_NAME rpcmethod_RpcEvent__IService_MakeItHappen))
			{
			...
			else if ((__vwsn_switch_4 == GLOBAL_NAME rpcmethod_RpcEvent__IService_Watch))
			{
				auto target = ::vl::__vwsn::Ensure(::vl::__vwsn::SharedPtrCast<::RpcEvent::IService>(::vl::__vwsn::This(_lc)->RefToPtr(ref).Obj()));
			...
			{
				{
					...
					if ((__vwsn_switch_5 == GLOBAL_NAME rpcevent_RpcEvent__IService_SomethingHappened))
					{
						auto target = ::vl::__vwsn::Ensure(::vl::__vwsn::SharedPtrCast<::RpcEvent::IService>(::vl::__vwsn::This(_lc)->RefToPtr(ref).Obj()));
	...
	__vwsnc4_Rpc_Event_rpcops_IRpcObjectOpsJson__vl_rpc_controller_IRpcObjectOps::__vwsnc4_Rpc_Event_rpcops_IRpcObjectOpsJson__vl_rpc_controller_IRpcObjectOps(::vl::rpc_controller::IRpcLifecycle* __vwsnctor_lc)
	{
		this->_lc = __vwsnctor_lc;
	}

	::vl::reflection::description::Value __vwsnc4_Rpc_Event_rpcops_IRpcObjectOpsJson__vl_rpc_controller_IRpcObjectOps::InvokeMethod(::vl::rpc_controller::RpcObjectReference ref, ::vl::vint32_t methodId, ::vl::Ptr<::vl::reflection::description::IValueArray> arguments)
	{
		{
			auto __vwsn_switch_6 = methodId;
			if ((__vwsn_switch_6 == GLOBAL_NAME rpcmethod_RpcEvent__IService_MakeItHappen))
			{
				auto target = ::vl::__vwsn::Ensure(::vl::__vwsn::SharedPtrCast<::RpcEvent::IService>(::vl::__vwsn::This(_lc)->RefToPtr(ref).Obj()));
				::vl::__vwsn::This(target.Obj())->MakeItHappen();
				return ::vl::reflection::description::Value();
			}
			else if ((__vwsn_switch_6 == GLOBAL_NAME rpcmethod_RpcEvent__IService_Watch))
			{
				auto target = ::vl::__vwsn::Ensure(::vl::__vwsn::SharedPtrCast<::RpcEvent::IService>(::vl::__vwsn::This(_lc)->RefToPtr(ref).Obj()));
				::vl::__vwsn::This(target.Obj())->Watch();
				return ::vl::reflection::description::Value();
	...
	void __vwsnc4_Rpc_Event_rpcops_IRpcObjectOpsJson__vl_rpc_controller_IRpcObjectOps::ObjectHold(::vl::rpc_controller::RpcObjectReference ref, ::vl::vint32_t remoteClientId, bool hold)
	{
		if (hold)
		{
			::vl::__vwsn::This(_lc)->LocalObjectHold(ref, remoteClientId);
	...
	void __vwsnc4_Rpc_Event_rpcops_IRpcObjectOpsJson__vl_rpc_controller_IRpcObjectOps::RegisterService(::vl::vint32_t typeId, ::vl::Ptr<::vl::reflection::IDescriptable> service)
	{
		{
			if (GLOBAL_NAME rpcwrapper_IsCtorInterfaceTypeId(typeId))
			{
	...
	__vwsnc5_Rpc_Event_rpcops_IRpcObjectEventOpsJson__vl_rpc_controller_IRpcObjectEventOps::__vwsnc5_Rpc_Event_rpcops_IRpcObjectEventOpsJson__vl_rpc_controller_IRpcObjectEventOps(::vl::rpc_controller::IRpcLifecycle* __vwsnctor_lc)
	{
		this->_lc = __vwsnctor_lc;
	}

	void __vwsnc5_Rpc_Event_rpcops_IRpcObjectEventOpsJson__vl_rpc_controller_IRpcObjectEventOps::InvokeEvent(::vl::rpc_controller::RpcObjectReference ref, ::vl::vint32_t eventId, ::vl::Ptr<::vl::reflection::description::IValueArray> arguments)
	{
		::vl::__vwsn::This(::vl::__vwsn::This(_lc)->GetController())->SetEventSuppressedFlag(ref, eventId, true);
		{
			auto __vwsnb_0 = [&]()
			...
			{
				{
					...
					if ((__vwsn_switch_7 == GLOBAL_NAME rpcevent_RpcEvent__IService_SomethingHappened))
					{
						auto target = ::vl::__vwsn::Ensure(::vl::__vwsn::SharedPtrCast<::RpcEvent::IService>(::vl::__vwsn::This(_lc)->RefToPtr(ref).Obj()));
	...
	__vwsnc6_Rpc_Event_rpcops_IOps_Create__rpcops_IOps_Rpc_Event::__vwsnc6_Rpc_Event_rpcops_IOps_Create__rpcops_IOps_Rpc_Event(::vl::rpc_controller::IRpcLifecycle* __vwsnctor_lc)
	{
		this->_lc = __vwsnctor_lc;
	}

	void __vwsnc6_Rpc_Event_rpcops_IOps_Create__rpcops_IOps_Rpc_Event::InvokeMethod_RpcEvent__IService_MakeItHappen(::vl::rpc_controller::RpcObjectReference ref)
	{
		auto arguments = ::vl::reflection::description::IValueArray::Create();
	...
	void __vwsnc6_Rpc_Event_rpcops_IOps_Create__rpcops_IOps_Rpc_Event::InvokeMethod_RpcEvent__IService_Watch(::vl::rpc_controller::RpcObjectReference ref)
	{
		auto arguments = ::vl::reflection::description::IValueArray::Create();
		::vl::__vwsn::This(arguments.Obj())->Resize(static_cast<::vl::vint32_t>(0));
	...
	void __vwsnc6_Rpc_Event_rpcops_IOps_Create__rpcops_IOps_Rpc_Event::InvokeEvent_RpcEvent__IService_SomethingHappened(::vl::rpc_controller::RpcObjectReference ref, const ::vl::WString& arg_arg0)
	{
		auto arguments = ::vl::reflection::description::IValueArray::Create();
		::vl::__vwsn::This(arguments.Obj())->Resize(static_cast<::vl::vint32_t>(1));
	...
	__vwsnc7_Rpc_Event_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_Event::__vwsnc7_Rpc_Event_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_Event(::vl::rpc_controller::IRpcLifecycle* __vwsnctor_lc)
	{
		this->_lc = __vwsnctor_lc;
	}

	void __vwsnc7_Rpc_Event_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_Event::InvokeMethod_RpcEvent__IService_MakeItHappen(::vl::rpc_controller::RpcObjectReference ref)
	{
		auto arguments = ::vl::reflection::description::IValueArray::Create();
		::vl::__vwsn::This(arguments.Obj())->Resize(static_cast<::vl::vint32_t>(0));
		::vl::__vwsn::This(::vl::__vwsn::This(::vl::__vwsn::This(_lc)->GetDispatcher())->SendToClient_ObjectOps(ref.clientId))->InvokeMethod(ref, GLOBAL_NAME rpcmethod_RpcEvent__IService_MakeItHappen, arguments);
	...
	void __vwsnc7_Rpc_Event_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_Event::InvokeMethod_RpcEvent__IService_Watch(::vl::rpc_controller::RpcObjectReference ref)
	{
		auto arguments = ::vl::reflection::description::IValueArray::Create();
		::vl::__vwsn::This(arguments.Obj())->Resize(static_cast<::vl::vint32_t>(0));
		::vl::__vwsn::This(::vl::__vwsn::This(::vl::__vwsn::This(_lc)->GetDispatcher())->SendToClient_ObjectOps(ref.clientId))->InvokeMethod(ref, GLOBAL_NAME rpcmethod_RpcEvent__IService_Watch, arguments);
	...
	void __vwsnc7_Rpc_Event_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_Event::InvokeEvent_RpcEvent__IService_SomethingHappened(::vl::rpc_controller::RpcObjectReference ref, const ::vl::WString& arg_arg0)
	{
		auto arguments = ::vl::reflection::description::IValueArray::Create();
		::vl::__vwsn::This(arguments.Obj())->Resize(static_cast<::vl::vint32_t>(1));
	...
	void __vwsnc8_Rpc_Event_rpcwrapper_RpcEvent__IService__RpcEvent_IRpcWrapper_IService::DisconnectFromLifecycle()
	{
		(_lc = static_cast<::vl::rpc_controller::IRpcLifecycle*>(nullptr));
		(_ops = ::vl::Ptr<::rpcops_IOps_Rpc_Event>());
	}

	__vwsnc8_Rpc_Event_rpcwrapper_RpcEvent__IService__RpcEvent_IRpcWrapper_IService::~__vwsnc8_Rpc_Event_rpcwrapper_RpcEvent__IService__RpcEvent_IRpcWrapper_IService()
	{
		if ((_lc != nullptr))
		{
	...
	void __vwsnc8_Rpc_Event_rpcwrapper_RpcEvent__IService__RpcEvent_IRpcWrapper_IService::MakeItHappen()
	{
		if ((_lc == nullptr))
	...
	void __vwsnc8_Rpc_Event_rpcwrapper_RpcEvent__IService__RpcEvent_IRpcWrapper_IService::Watch()
	{
		if ((_lc == nullptr))
			throw ::vl::Exception(::vl::WString::Unmanaged(L"RPC wrapper has been disconnected from lifecycle."));
