...
***********************************************************************/
	...
	::vl::Ptr<::vl::reflection::description::IValueList> __vwsnc4_Rpc_Collection_Nested_Default_rpcops_IOps_Create__rpcops_IOps_Rpc_Collection_Nested_Default::InvokeMethod_RpcCollection__Nested__Default__IService_DoList(::vl::rpc_controller::RpcObjectReference ref, ::vl::Ptr<::vl::reflection::description::IValueList> arg_xs)
	{
		...
		return ::vl::__vwsn::Ensure(::vl::__vwsn::SharedPtrCast<::vl::reflection::description::IValueList>(::vl::rpc_controller::RpcUnboxByval(::vl::__vwsn::This(::vl::__vwsn::This(::vl::__vwsn::This(_lc)->GetDispatcher())->SendToClient_ObjectOps(ref.clientId))->InvokeMethod(ref, GLOBAL_NAME rpcmethod_RpcCollection__Nested__Default__IService_DoList, arguments), _lc).Obj()));
	}
	...
	::vl::Ptr<::vl::reflection::description::IValueList> __vwsnc9_Rpc_Collection_Nested_Default_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_Collection_Nested_Default::InvokeMethod_RpcCollection__Nested__Default__IService_DoList(::vl::rpc_controller::RpcObjectReference ref, ::vl::Ptr<::vl::reflection::description::IValueList> arg_xs)
	{
		...
		auto jsonResult = ::vl::__vwsn::Unbox<::vl::Ptr<::vl::glr::json::JsonNode>>(::vl::__vwsn::This(::vl::__vwsn::This(::vl::__vwsn::This(_lc)->GetDispatcher())->SendToClient_ObjectOps(ref.clientId))->InvokeMethod(ref, GLOBAL_NAME rpcmethod_RpcCollection__Nested__Default__IService_DoList, arguments));
