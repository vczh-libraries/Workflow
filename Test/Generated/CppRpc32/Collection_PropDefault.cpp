...
***********************************************************************/
	...
	::vl::Ptr<::vl::reflection::description::IValueList> __vwsnc4_Rpc_Collection_PropDefault_rpcops_IOps_Create__rpcops_IOps_Rpc_Collection_PropDefault::InvokeMethod_RpcCollection__PropDefault__IService_GetList(::vl::rpc_controller::RpcObjectReference ref)
	{
		...
		return ::vl::__vwsn::Ensure(::vl::__vwsn::SharedPtrCast<::vl::reflection::description::IValueList>(::vl::rpc_controller::RpcUnboxByval(::vl::__vwsn::This(::vl::__vwsn::This(::vl::__vwsn::This(_lc)->GetDispatcher())->SendToClient_ObjectOps(ref.clientId))->InvokeMethod(ref, GLOBAL_NAME rpcmethod_RpcCollection__PropDefault__IService_GetList, arguments), _lc).Obj()));
	}
	...
	{
		{
			...
			if ((__vwsn_switch_7 == GLOBAL_NAME rpcmethod_RpcCollection__PropDefault__IService_GetList))
			{
				auto target = ::vl::__vwsn::Ensure(::vl::__vwsn::SharedPtrCast<::RpcCollection::PropDefault::IService>(::vl::__vwsn::This(_lc)->RefToPtr(ref).Obj()));
			...
			else if ((__vwsn_switch_7 == GLOBAL_NAME rpcmethod_RpcCollection__PropDefault__IService_SetList))
			{
				auto target = ::vl::__vwsn::Ensure(::vl::__vwsn::SharedPtrCast<::RpcCollection::PropDefault::IService>(::vl::__vwsn::This(_lc)->RefToPtr(ref).Obj()));
	...
	::vl::Ptr<::vl::reflection::description::IValueList> __vwsnc9_Rpc_Collection_PropDefault_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_Collection_PropDefault::InvokeMethod_RpcCollection__PropDefault__IService_GetList(::vl::rpc_controller::RpcObjectReference ref)
	{
		auto arguments = ::vl::reflection::description::IValueArray::Create();
		::vl::__vwsn::This(arguments.Obj())->Resize(static_cast<::vl::vint32_t>(0));
		auto jsonResult = ::vl::__vwsn::Unbox<::vl::Ptr<::vl::glr::json::JsonNode>>(::vl::__vwsn::This(::vl::__vwsn::This(::vl::__vwsn::This(_lc)->GetDispatcher())->SendToClient_ObjectOps(ref.clientId))->InvokeMethod(ref, GLOBAL_NAME rpcmethod_RpcCollection__PropDefault__IService_GetList, arguments));
