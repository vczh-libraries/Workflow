...
***********************************************************************/
	...
	::vl::Ptr<::vl::rpc_controller::IRpcObjectOps> Rpc_DtorPropCached::rpc_IRpcObjectOps(::vl::rpc_controller::IRpcLifecycle* lc)
	{
		return ::vl::Ptr<::vl::rpc_controller::IRpcObjectOps>(new ::vl_workflow_global::__vwsnc3_Rpc_DtorPropCached_rpc_IRpcObjectOps__vl_rpc_controller_IRpcObjectOps(lc));
	}

	::vl::Ptr<::vl::rpc_controller::IRpcObjectEventOps> Rpc_DtorPropCached::rpc_IRpcObjectEventOps(::vl::rpc_controller::IRpcLifecycle* lc)
	{
		return ::vl::Ptr<::vl::rpc_controller::IRpcObjectEventOps>(new ::vl_workflow_global::__vwsnc4_Rpc_DtorPropCached_rpc_IRpcObjectEventOps__vl_rpc_controller_IRpcObjectEventOps(lc));
	}
	...
	{
		return ::vl::Ptr<::rpcops_IOps_Rpc_DtorPropCached>(new ::vl_workflow_global::__vwsnc6_Rpc_DtorPropCached_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_DtorPropCached(lc));
	}
	...
	{
		{
			...
			if ((__vwsn_switch_6 == GLOBAL_NAME rpctype_RpcDtorPropCached__IValue))
			{
				return;
			}
			else if ((__vwsn_switch_6 == GLOBAL_NAME rpctype_RpcDtorPropCached__IService))
			{
	...
	{
		{
			...
			if ((__vwsn_switch_7 == GLOBAL_NAME rpctype_RpcDtorPropCached__IValue))
			{
				return ::vl::Ptr<::vl::rpc_controller::IRpcWrapperBase>(GLOBAL_NAME rpcwrapper_RpcDtorPropCached__IValue(lc, ref, ops));
			}
			else if ((__vwsn_switch_7 == GLOBAL_NAME rpctype_RpcDtorPropCached__IService))
			{
...
***********************************************************************/
	...
	__vwsnc3_Rpc_DtorPropCached_rpc_IRpcObjectOps__vl_rpc_controller_IRpcObjectOps::__vwsnc3_Rpc_DtorPropCached_rpc_IRpcObjectOps__vl_rpc_controller_IRpcObjectOps(::vl::rpc_controller::IRpcLifecycle* __vwsnctor_lc)
	{
		this->_lc = __vwsnctor_lc;
	}

	::vl::reflection::description::Value __vwsnc3_Rpc_DtorPropCached_rpc_IRpcObjectOps__vl_rpc_controller_IRpcObjectOps::InvokeMethod(::vl::rpc_controller::RpcObjectReference ref, ::vl::vint32_t methodId, ::vl::Ptr<::vl::reflection::description::IValueArray> arguments)
	{
		{
	...
	void __vwsnc3_Rpc_DtorPropCached_rpc_IRpcObjectOps__vl_rpc_controller_IRpcObjectOps::ObjectHold(::vl::rpc_controller::RpcObjectReference ref, ::vl::vint32_t remoteClientId, bool hold)
	{
		if (hold)
		{
	...
	void __vwsnc3_Rpc_DtorPropCached_rpc_IRpcObjectOps__vl_rpc_controller_IRpcObjectOps::RegisterService(::vl::vint32_t typeId, ::vl::Ptr<::vl::reflection::IDescriptable> service)
	{
		{
	...
	__vwsnc4_Rpc_DtorPropCached_rpc_IRpcObjectEventOps__vl_rpc_controller_IRpcObjectEventOps::__vwsnc4_Rpc_DtorPropCached_rpc_IRpcObjectEventOps__vl_rpc_controller_IRpcObjectEventOps(::vl::rpc_controller::IRpcLifecycle* __vwsnctor_lc)
	{
		this->_lc = __vwsnctor_lc;
	}

	void __vwsnc4_Rpc_DtorPropCached_rpc_IRpcObjectEventOps__vl_rpc_controller_IRpcObjectEventOps::InvokeEvent(::vl::rpc_controller::RpcObjectReference ref, ::vl::vint32_t eventId, ::vl::Ptr<::vl::reflection::description::IValueArray> arguments)
	{
	...
	__vwsnc6_Rpc_DtorPropCached_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_DtorPropCached::__vwsnc6_Rpc_DtorPropCached_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_DtorPropCached(::vl::rpc_controller::IRpcLifecycle* __vwsnctor_lc)
	{
		this->_lc = __vwsnctor_lc;
	}

	::vl::Ptr<::RpcDtorPropCached::IValue> __vwsnc6_Rpc_DtorPropCached_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_DtorPropCached::InvokeMethod_RpcDtorPropCached__IService_GetValue(::vl::rpc_controller::RpcObjectReference ref)
	{
		auto arguments = ::vl::reflection::description::IValueArray::Create();
		::vl::__vwsn::This(arguments.Obj())->Resize(static_cast<::vl::vint32_t>(0));
	...
	void __vwsnc6_Rpc_DtorPropCached_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_DtorPropCached::InvokeMethod_RpcDtorPropCached__IService_SetValue(::vl::rpc_controller::RpcObjectReference ref, ::vl::Ptr<::RpcDtorPropCached::IValue> arg_value)
	{
		auto arguments = ::vl::reflection::description::IValueArray::Create();
		::vl::__vwsn::This(arguments.Obj())->Resize(static_cast<::vl::vint32_t>(1));
	...
	void __vwsnc6_Rpc_DtorPropCached_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_DtorPropCached::InvokeMethod_RpcDtorPropCached__IService_Signal(::vl::rpc_controller::RpcObjectReference ref)
	{
		auto arguments = ::vl::reflection::description::IValueArray::Create();
		::vl::__vwsn::This(arguments.Obj())->Resize(static_cast<::vl::vint32_t>(0));
		::vl::__vwsn::This(::vl::__vwsn::This(::vl::__vwsn::This(_lc)->GetDispatcher())->SendToClient_ObjectOps(ref.clientId))->InvokeMethod(ref, GLOBAL_NAME rpcmethod_RpcDtorPropCached__IService_Signal, arguments);
	...
	void __vwsnc6_Rpc_DtorPropCached_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_DtorPropCached::InvokeEvent_RpcDtorPropCached__IService_ValueChanged(::vl::rpc_controller::RpcObjectReference ref)
	{
		auto arguments = ::vl::reflection::description::IValueArray::Create();
		::vl::__vwsn::This(arguments.Obj())->Resize(static_cast<::vl::vint32_t>(0));
		::vl::__vwsn::This(::vl::__vwsn::This(::vl::__vwsn::This(_lc)->GetDispatcher())->BroadcastFromClient_ObjectEventOps(::vl::__vwsn::This(_lc)->GetClientId()))->InvokeEvent(ref, GLOBAL_NAME rpcevent_RpcDtorPropCached__IService_ValueChanged, arguments);
