...
***********************************************************************/
	...
	::vl::Ptr<::RpcPropDefaultInterfaceList::IRpcWrapper_IValue> Rpc_PropDefaultInterfaceList::rpcwrapper_RpcPropDefaultInterfaceList__IValue(::vl::rpc_controller::IRpcLifecycle* lc, ::vl::rpc_controller::RpcObjectReference proxyRef)
	{
	...
	::vl::Ptr<::RpcPropDefaultInterfaceList::IRpcWrapper_IService> Rpc_PropDefaultInterfaceList::rpcwrapper_RpcPropDefaultInterfaceList__IService(::vl::rpc_controller::IRpcLifecycle* lc, ::vl::rpc_controller::RpcObjectReference proxyRef)
	{
...
***********************************************************************/
	...
	::vl::Ptr<::vl::reflection::description::IAsync> __vwsnc3_Rpc_PropDefaultInterfaceList_rpc_IRpcObjectOps__vl_rpc_controller_IRpcObjectOps::InvokeMethodAsync(::vl::rpc_controller::RpcObjectReference ref, ::vl::vint32_t methodId, ::vl::Ptr<::vl::reflection::description::IValueArray> arguments)
	{
	...
	::vl::WString __vwsnc5_Rpc_PropDefaultInterfaceList_rpcwrapper_RpcPropDefaultInterfaceList__IValue__RpcPropDefaultInterfaceList_IRpcWrapper_IValue::GetValue()
	{
		...
		auto arguments = ::vl::reflection::description::IValueArray::Create();
		::vl::__vwsn::This(arguments.Obj())->Resize(static_cast<::vl::vint32_t>(0));
		return ::vl::__vwsn::Unbox<::vl::WString>(::vl::__vwsn::This(::vl::__vwsn::This(::vl::__vwsn::This(_lc)->GetDispatcher())->SendToClient_ObjectOps(_ref.clientId))->InvokeMethod(_ref, GLOBAL_NAME rpcmethod_RpcPropDefaultInterfaceList__IValue_GetValue, arguments));
	}
	...
	::vl::Ptr<::vl::reflection::description::IValueList> __vwsnc6_Rpc_PropDefaultInterfaceList_rpcwrapper_RpcPropDefaultInterfaceList__IService__RpcPropDefaultInterfaceList_IRpcWrapper_IService::GetValue()
	{
		...
		auto arguments = ::vl::reflection::description::IValueArray::Create();
		::vl::__vwsn::This(arguments.Obj())->Resize(static_cast<::vl::vint32_t>(0));
		(__vwsn_Cached_ = ::vl::__vwsn::SharedPtrCast<::vl::reflection::description::IValueList>(::vl::rpc_controller::RpcUnboxByref(::vl::__vwsn::Unbox<::vl::rpc_controller::RpcObjectReference>(::vl::__vwsn::This(::vl::__vwsn::This(::vl::__vwsn::This(_lc)->GetDispatcher())->SendToClient_ObjectOps(_ref.clientId))->InvokeMethod(_ref, GLOBAL_NAME rpcmethod_RpcPropDefaultInterfaceList__IService_GetValue, arguments)), _lc).Obj()));
	...
	void __vwsnc6_Rpc_PropDefaultInterfaceList_rpcwrapper_RpcPropDefaultInterfaceList__IService__RpcPropDefaultInterfaceList_IRpcWrapper_IService::SetValue(::vl::Ptr<::vl::reflection::description::IValueList> value)
	{
		...
		::vl::__vwsn::This(arguments.Obj())->Set(static_cast<::vl::vint32_t>(0), ::vl::__vwsn::Box(::vl::rpc_controller::RpcBoxByref(::vl::Ptr<::vl::reflection::IDescriptable>(value), _lc)));
		::vl::__vwsn::This(::vl::__vwsn::This(::vl::__vwsn::This(_lc)->GetDispatcher())->SendToClient_ObjectOps(_ref.clientId))->InvokeMethod(_ref, GLOBAL_NAME rpcmethod_RpcPropDefaultInterfaceList__IService_SetValue, arguments);
	}
	...
	void __vwsnc6_Rpc_PropDefaultInterfaceList_rpcwrapper_RpcPropDefaultInterfaceList__IService__RpcPropDefaultInterfaceList_IRpcWrapper_IService::Signal()
	{
		...
		auto arguments = ::vl::reflection::description::IValueArray::Create();
		::vl::__vwsn::This(arguments.Obj())->Resize(static_cast<::vl::vint32_t>(0));
		::vl::__vwsn::This(::vl::__vwsn::This(::vl::__vwsn::This(_lc)->GetDispatcher())->SendToClient_ObjectOps(_ref.clientId))->InvokeMethod(_ref, GLOBAL_NAME rpcmethod_RpcPropDefaultInterfaceList__IService_Signal, arguments);
	}
