...
***********************************************************************/
	...
	::vl::Ptr<::vl::glr::json::JsonNode> Rpc_FailDoubleRegistration::rpcjson_NewNull()
	{
	...
	::vl::glr::ParsingToken Rpc_FailDoubleRegistration::rpcjson_NewToken(const ::vl::WString& value)
	{
		return [&](){ ::vl::glr::ParsingToken __vwsn_temp__; __vwsn_temp__.value = value; return __vwsn_temp__; }();
	}

	::vl::Ptr<::vl::glr::json::JsonString> Rpc_FailDoubleRegistration::rpcjson_NewString(const ::vl::WString& content)
	{
	...
	::vl::Ptr<::vl::glr::json::JsonNumber> Rpc_FailDoubleRegistration::rpcjson_NewNumber(const ::vl::WString& content)
	{
	...
	::vl::Ptr<::vl::glr::json::JsonNode> Rpc_FailDoubleRegistration::rpcjson_NewArray2(const ::vl::WString& keyword, ::vl::Ptr<::vl::glr::json::JsonNode> value)
	{
	...
	void Rpc_FailDoubleRegistration::rpcjson_ObjectAdd(::vl::Ptr<::vl::glr::json::JsonObject> object, const ::vl::WString& name, ::vl::Ptr<::vl::glr::json::JsonNode> value)
	{
	...
	::vl::Ptr<::vl::glr::json::JsonObject> Rpc_FailDoubleRegistration::rpcjson_NewObject(const ::vl::WString& keyword)
	{
	...
	::vl::Ptr<::vl::glr::json::JsonNode> Rpc_FailDoubleRegistration::rpcjson_ObjectGet(::vl::Ptr<::vl::glr::json::JsonObject> object, const ::vl::WString& name)
	{
		{
	...
	::vl::Ptr<::vl::glr::json::JsonNode> Rpc_FailDoubleRegistration::rpcjson_SerializeCollection(const ::vl::WString& keyword, ::vl::Ptr<::vl::reflection::description::IValueEnumerable> values)
	{
	...
	::vl::Ptr<::vl::glr::json::JsonNode> Rpc_FailDoubleRegistration::rpcjson_SerializeMap(::vl::Ptr<::vl::reflection::description::IValueReadonlyDictionary> values)
	{
...
***********************************************************************/
	...
	{
		{
			...
			else if ((__vwsn_switch_4 == GLOBAL_NAME rpcmethod_RpcFailDoubleRegistrationTest__IService_SetObject))
			{
				...
				return ::vl::rpc_controller::RpcBoxByval(::vl::__vwsn::Box(::vl::__vwsn::This(target.Obj())->SetObject(::vl::__vwsn::Unbox<::vl::Ptr<::RpcFailDoubleRegistrationTest::IObject>>(::vl::rpc_controller::RpcUnboxByval(::vl::__vwsn::Unbox<::vl::reflection::description::Value>(::vl::__vwsn::This(arguments.Obj())->Get(static_cast<::vl::vint32_t>(0))), _lc)), ::vl::__vwsn::Unbox<::vl::vint32_t>(::vl::rpc_controller::RpcUnboxByval(::vl::__vwsn::Unbox<::vl::reflection::description::Value>(::vl::__vwsn::This(arguments.Obj())->Get(static_cast<::vl::vint32_t>(1))), _lc)))), _lc);
			}
			else
	...
	::vl::Ptr<::vl::reflection::description::IAsync> __vwsnc3_Rpc_FailDoubleRegistration_rpc_IRpcObjectOps__vl_rpc_controller_IRpcObjectOps::InvokeMethodAsync(::vl::rpc_controller::RpcObjectReference ref, ::vl::vint32_t methodId, ::vl::Ptr<::vl::reflection::description::IValueArray> arguments)
	{
	...
	::vl::Ptr<::RpcFailDoubleRegistrationTest::IObject> __vwsnc6_Rpc_FailDoubleRegistration_rpcwrapper_RpcFailDoubleRegistrationTest__IService__RpcFailDoubleRegistrationTest_IRpcWrapper_IService::SetObject(::vl::Ptr<::RpcFailDoubleRegistrationTest::IObject> obj, ::vl::vint32_t index)
	{
		if ((_lc == nullptr))
			throw ::vl::Exception(::vl::WString::Unmanaged(L"RPC wrapper has been disconnected from lifecycle."));
		auto arguments = ::vl::reflection::description::IValueArray::Create();
		...
		::vl::__vwsn::This(arguments.Obj())->Set(static_cast<::vl::vint32_t>(1), ::vl::rpc_controller::RpcBoxByval(::vl::__vwsn::Box(index), _lc));
