	...
	{
		{
			...
			if ((__vwsn_switch_7 == GLOBAL_NAME rpcmethod_RpcCollection__Interface__Nested__InByref__OutByref__IValue_GetValue))
			{
				auto target = ::vl::__vwsn::Ensure(::vl::__vwsn::SharedPtrCast<::RpcCollection::Interface::Nested::InByref::OutByref::IValue>(::vl::__vwsn::This(_lc)->RefToPtr(ref).Obj()));
				auto jsonNumber0 = ::vl::Ptr<::vl::glr::json::JsonNumber>(new ::vl::glr::json::JsonNumber());
			...
			else if ((__vwsn_switch_7 == GLOBAL_NAME rpcmethod_RpcCollection__Interface__Nested__InByref__OutByref__IService_DoList))
			{
				auto target = ::vl::__vwsn::Ensure(::vl::__vwsn::SharedPtrCast<::RpcCollection::Interface::Nested::InByref::OutByref::IService>(::vl::__vwsn::This(_lc)->RefToPtr(ref).Obj()));
