...
***********************************************************************/
	...
	::vl::Ptr<::vl::rpc_controller::IRpcObjectOps> Rpc_Collection_Interface_Nested_InByref_OutByref::rpc_IRpcObjectOps(::vl::rpc_controller::IRpcLifecycle* lc)
	{
		return ::vl::Ptr<::vl::rpc_controller::IRpcObjectOps>(new ::vl_workflow_global::__vwsnc3_Rpc_Collection_Interface_Nested_InByref_OutByref_rpc_IRpcObjectOps__vl_rpc_controller_IRpcObjectOps(lc));
	}

	::vl::Ptr<::vl::rpc_controller::IRpcObjectEventOps> Rpc_Collection_Interface_Nested_InByref_OutByref::rpc_IRpcObjectEventOps(::vl::rpc_controller::IRpcLifecycle* lc)
	{
		return ::vl::Ptr<::vl::rpc_controller::IRpcObjectEventOps>(new ::vl_workflow_global::__vwsnc4_Rpc_Collection_Interface_Nested_InByref_OutByref_rpc_IRpcObjectEventOps__vl_rpc_controller_IRpcObjectEventOps(lc));
	}
	...
	{
		return ::vl::Ptr<::rpcops_IOps_Rpc_Collection_Interface_Nested_InByref_OutByref>(new ::vl_workflow_global::__vwsnc6_Rpc_Collection_Interface_Nested_InByref_OutByref_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_Collection_Interface_Nested_InByref_OutByref(lc));
	}
	...
	{
		auto proxy = ::vl::Ptr<::RpcCollection::Interface::Nested::InByref::OutByref::IRpcWrapper_IValue>(new ::vl_workflow_global::__vwsnc7_Rpc_Collection_Interface_Nested_InByref_OutByref_rpcwrapper_RpcCollection__Interface__Nested__InByref__OutByref__IValue__RpcCollection_Interface_Nested_InByref_OutByref_IRpcWrapper_IValue(lc, ops, proxyRef));
	...
	{
		auto proxy = ::vl::Ptr<::RpcCollection::Interface::Nested::InByref::OutByref::IRpcWrapper_IService>(new ::vl_workflow_global::__vwsnc8_Rpc_Collection_Interface_Nested_InByref_OutByref_rpcwrapper_RpcCollection__Interface__Nested__InByref__OutByref__IService__RpcCollection_Interface_Nested_InByref_OutByref_IRpcWrapper_IService(lc, ops, proxyRef));
		::vl::__vwsn::This(::vl::__vwsn::This(::vl::__vwsn::This(lc)->GetDispatcher())->SendToClient_ObjectOps(proxyRef.clientId))->ObjectHold(proxyRef, ::vl::__vwsn::This(lc)->GetClientId(), true);
		return proxy;
	}
	...
	{
		{
			...
			if ((__vwsn_switch_6 == GLOBAL_NAME rpctype_RpcCollection__Interface__Nested__InByref__OutByref__IValue))
			{
			...
			else if ((__vwsn_switch_6 == GLOBAL_NAME rpctype_RpcCollection__Interface__Nested__InByref__OutByref__IService))
			{
...
***********************************************************************/
	...
	__vwsnc3_Rpc_Collection_Interface_Nested_InByref_OutByref_rpc_IRpcObjectOps__vl_rpc_controller_IRpcObjectOps::__vwsnc3_Rpc_Collection_Interface_Nested_InByref_OutByref_rpc_IRpcObjectOps__vl_rpc_controller_IRpcObjectOps(::vl::rpc_controller::IRpcLifecycle* __vwsnctor_lc)
	{
		this->_lc = __vwsnctor_lc;
	}

	::vl::reflection::description::Value __vwsnc3_Rpc_Collection_Interface_Nested_InByref_OutByref_rpc_IRpcObjectOps__vl_rpc_controller_IRpcObjectOps::InvokeMethod(::vl::rpc_controller::RpcObjectReference ref, ::vl::vint32_t methodId, ::vl::Ptr<::vl::reflection::description::IValueArray> arguments)
	{
		{
	...
	void __vwsnc3_Rpc_Collection_Interface_Nested_InByref_OutByref_rpc_IRpcObjectOps__vl_rpc_controller_IRpcObjectOps::ObjectHold(::vl::rpc_controller::RpcObjectReference ref, ::vl::vint32_t remoteClientId, bool hold)
	{
		if (hold)
		{
	...
	void __vwsnc3_Rpc_Collection_Interface_Nested_InByref_OutByref_rpc_IRpcObjectOps__vl_rpc_controller_IRpcObjectOps::RegisterService(::vl::vint32_t typeId, ::vl::Ptr<::vl::reflection::IDescriptable> service)
	{
		{
	...
	__vwsnc4_Rpc_Collection_Interface_Nested_InByref_OutByref_rpc_IRpcObjectEventOps__vl_rpc_controller_IRpcObjectEventOps::__vwsnc4_Rpc_Collection_Interface_Nested_InByref_OutByref_rpc_IRpcObjectEventOps__vl_rpc_controller_IRpcObjectEventOps(::vl::rpc_controller::IRpcLifecycle* __vwsnctor_lc)
	{
		this->_lc = __vwsnctor_lc;
	}

	void __vwsnc4_Rpc_Collection_Interface_Nested_InByref_OutByref_rpc_IRpcObjectEventOps__vl_rpc_controller_IRpcObjectEventOps::InvokeEvent(::vl::rpc_controller::RpcObjectReference ref, ::vl::vint32_t eventId, ::vl::Ptr<::vl::reflection::description::IValueArray> arguments)
	{
	...
	__vwsnc6_Rpc_Collection_Interface_Nested_InByref_OutByref_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_Collection_Interface_Nested_InByref_OutByref::__vwsnc6_Rpc_Collection_Interface_Nested_InByref_OutByref_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_Collection_Interface_Nested_InByref_OutByref(::vl::rpc_controller::IRpcLifecycle* __vwsnctor_lc)
	{
		this->_lc = __vwsnctor_lc;
	}

	::vl::vint32_t __vwsnc6_Rpc_Collection_Interface_Nested_InByref_OutByref_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_Collection_Interface_Nested_InByref_OutByref::InvokeMethod_RpcCollection__Interface__Nested__InByref__OutByref__IValue_GetValue(::vl::rpc_controller::RpcObjectReference ref)
	{
		auto arguments = ::vl::reflection::description::IValueArray::Create();
		::vl::__vwsn::This(arguments.Obj())->Resize(static_cast<::vl::vint32_t>(0));
	...
	::vl::Ptr<::vl::reflection::description::IValueDictionary> __vwsnc6_Rpc_Collection_Interface_Nested_InByref_OutByref_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_Collection_Interface_Nested_InByref_OutByref::InvokeMethod_RpcCollection__Interface__Nested__InByref__OutByref__IService_DoList(::vl::rpc_controller::RpcObjectReference ref, ::vl::Ptr<::vl::reflection::description::IValueDictionary> arg_xs)
	{
		auto arguments = ::vl::reflection::description::IValueArray::Create();
		::vl::__vwsn::This(arguments.Obj())->Resize(static_cast<::vl::vint32_t>(1));
	...
	void __vwsnc7_Rpc_Collection_Interface_Nested_InByref_OutByref_rpcwrapper_RpcCollection__Interface__Nested__InByref__OutByref__IValue__RpcCollection_Interface_Nested_InByref_OutByref_IRpcWrapper_IValue::DisconnectFromLifecycle()
	{
	...
	::vl::vint32_t __vwsnc7_Rpc_Collection_Interface_Nested_InByref_OutByref_rpcwrapper_RpcCollection__Interface__Nested__InByref__OutByref__IValue__RpcCollection_Interface_Nested_InByref_OutByref_IRpcWrapper_IValue::GetValue()
	{
		if ((_lc == nullptr))
	...
	void __vwsnc8_Rpc_Collection_Interface_Nested_InByref_OutByref_rpcwrapper_RpcCollection__Interface__Nested__InByref__OutByref__IService__RpcCollection_Interface_Nested_InByref_OutByref_IRpcWrapper_IService::DisconnectFromLifecycle()
	{
		(_lc = static_cast<::vl::rpc_controller::IRpcLifecycle*>(nullptr));
		(_ops = ::vl::Ptr<::rpcops_IOps_Rpc_Collection_Interface_Nested_InByref_OutByref>());
	}
	...
	::vl::Ptr<::vl::reflection::description::IValueDictionary> __vwsnc8_Rpc_Collection_Interface_Nested_InByref_OutByref_rpcwrapper_RpcCollection__Interface__Nested__InByref__OutByref__IService__RpcCollection_Interface_Nested_InByref_OutByref_IRpcWrapper_IService::DoList(::vl::Ptr<::vl::reflection::description::IValueDictionary> xs)
	{
		if ((_lc == nullptr))
			throw ::vl::Exception(::vl::WString::Unmanaged(L"RPC wrapper has been disconnected from lifecycle."));
