...
#ifndef VCZH_WORKFLOW_COMPILER_GENERATED_RPCNULLABLE
#define VCZH_WORKFLOW_COMPILER_GENERATED_RPCNULLABLE
...
{
	class __vwsnc10_Rpc_Nullable_rpcops_IRpcObjectEventOpsJson__vl_rpc_controller_IRpcObjectEventOps;
	class __vwsnc11_Rpc_Nullable_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_Nullable;
	...
	class __vwsnc8_Rpc_Nullable_rpcops_IRpcSerializer__vl_rpc_controller_IRpcSerializer;
	class __vwsnc9_Rpc_Nullable_rpcops_IRpcObjectOpsJson__vl_rpc_controller_IRpcObjectOps;
}
...
namespace RpcNullable
{
...
#endif
	public:
		virtual ::vl::WString Print(const ::vl::Nullable<::vl::WString>& value, ::vl::Ptr<::RpcNullable::IValue> v) = 0;
	};

	class IRpcWrapper_IService : public virtual ::RpcNullable::IService, public virtual ::vl::rpc_controller::IRpcWrapperBase, public ::vl::reflection::Description<IRpcWrapper_IService>
	{
#ifdef VCZH_DESCRIPTABLEOBJECT_WITH_METADATA
	...
	class IRpcWrapper_IValue : public virtual ::RpcNullable::IValue, public virtual ::vl::rpc_controller::IRpcWrapperBase, public ::vl::reflection::Description<IRpcWrapper_IValue>
	{
#ifdef VCZH_DESCRIPTABLEOBJECT_WITH_METADATA
...
class rpcops_IOps_Rpc_Nullable : public virtual ::vl::reflection::IDescriptable, public ::vl::reflection::Description<rpcops_IOps_Rpc_Nullable>
{
#ifdef VCZH_DESCRIPTABLEOBJECT_WITH_METADATA
	friend struct ::vl::reflection::description::CustomTypeDescriptorSelector<rpcops_IOps_Rpc_Nullable>;
#endif
public:
	virtual ::vl::WString InvokeMethod_RpcNullable__IValue_GetValue(::vl::rpc_controller::RpcObjectReference ref) = 0;
	virtual ::vl::WString InvokeMethod_RpcNullable__IService_Print(::vl::rpc_controller::RpcObjectReference ref, const ::vl::Nullable<::vl::WString>& arg_value, ::vl::Ptr<::RpcNullable::IValue> arg_v) = 0;
};
...
namespace vl_workflow_global
{
	...
	public:
		...
		::vl::WString s;
		::vl::vint32_t rpctype_RpcNullable__IService = 0;
		::vl::vint32_t rpcmethod_RpcNullable__IService_Print = 0;
		::vl::vint32_t rpctype_RpcNullable__IValue = 0;
		::vl::vint32_t rpcmethod_RpcNullable__IValue_GetValue = 0;
...
***********************************************************************/
	...
	class __vwsnc10_Rpc_Nullable_rpcops_IRpcObjectEventOpsJson__vl_rpc_controller_IRpcObjectEventOps : public ::vl::Object, public virtual ::vl::rpc_controller::IRpcObjectEventOps
	{
	public:
		__vwsnc10_Rpc_Nullable_rpcops_IRpcObjectEventOpsJson__vl_rpc_controller_IRpcObjectEventOps(::vl::rpc_controller::IRpcLifecycle* __vwsnctor_lc);
	...
	class __vwsnc11_Rpc_Nullable_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_Nullable : public ::vl::Object, public virtual ::rpcops_IOps_Rpc_Nullable
	{
	public:
		__vwsnc11_Rpc_Nullable_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_Nullable(::vl::rpc_controller::IRpcLifecycle* __vwsnctor_lc);
	...
	{
	public:
		__vwsnc1_Rpc_Nullable_serviceMain__RpcNullable_IService();

		::vl::WString Print(const ::vl::Nullable<::vl::WString>& value, ::vl::Ptr<::RpcNullable::IValue> v) override;
	};

	class __vwsnc2_Rpc_Nullable_clientMain__RpcNullable_IValue : public ::vl::Object, public virtual ::RpcNullable::IValue
	{
	public:
		__vwsnc2_Rpc_Nullable_clientMain__RpcNullable_IValue();

		::vl::WString GetValue() override;
	};

	class __vwsnc3_Rpc_Nullable_rpcops_IRpcObjectOps__vl_rpc_controller_IRpcObjectOps : public ::vl::Object, public virtual ::vl::rpc_controller::IRpcObjectOps
	{
	public:
		__vwsnc3_Rpc_Nullable_rpcops_IRpcObjectOps__vl_rpc_controller_IRpcObjectOps(::vl::rpc_controller::IRpcLifecycle* __vwsnctor_lc);
	...
	class __vwsnc4_Rpc_Nullable_rpcops_IRpcObjectEventOps__vl_rpc_controller_IRpcObjectEventOps : public ::vl::Object, public virtual ::vl::rpc_controller::IRpcObjectEventOps
	{
	public:
		__vwsnc4_Rpc_Nullable_rpcops_IRpcObjectEventOps__vl_rpc_controller_IRpcObjectEventOps(::vl::rpc_controller::IRpcLifecycle* __vwsnctor_lc);
	...
	class __vwsnc8_Rpc_Nullable_rpcops_IRpcSerializer__vl_rpc_controller_IRpcSerializer : public ::vl::Object, public virtual ::vl::rpc_controller::IRpcSerializer
	{
	public:
		__vwsnc8_Rpc_Nullable_rpcops_IRpcSerializer__vl_rpc_controller_IRpcSerializer();
	...
	class __vwsnc9_Rpc_Nullable_rpcops_IRpcObjectOpsJson__vl_rpc_controller_IRpcObjectOps : public ::vl::Object, public virtual ::vl::rpc_controller::IRpcObjectOps
	{
	public:
		__vwsnc9_Rpc_Nullable_rpcops_IRpcObjectOpsJson__vl_rpc_controller_IRpcObjectOps(::vl::rpc_controller::IRpcLifecycle* __vwsnctor_lc);
