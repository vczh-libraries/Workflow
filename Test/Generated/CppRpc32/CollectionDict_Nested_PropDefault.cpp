...
***********************************************************************/
	...
	::vl::Ptr<::vl::reflection::description::IValueList> __vwsnc4_Rpc_CollectionDict_Nested_PropDefault_rpcops_IOps_Create__rpcops_IOps_Rpc_CollectionDict_Nested_PropDefault::InvokeMethod_RpcCollectionDict__Nested__PropDefault__IService_GetList(::vl::rpc_controller::RpcObjectReference ref)
	{
		...
		return ::vl::__vwsn::Ensure(::vl::__vwsn::SharedPtrCast<::vl::reflection::description::IValueList>(::vl::rpc_controller::RpcUnboxByval(::vl::__vwsn::This(::vl::__vwsn::This(::vl::__vwsn::This(_lc)->GetDispatcher())->SendToClient_ObjectOps(ref.clientId))->InvokeMethod(ref, GLOBAL_NAME rpcmethod_RpcCollectionDict__Nested__PropDefault__IService_GetList, arguments), _lc).Obj()));
	}
