...
***********************************************************************/
	...
	::vl::Ptr<::vl::reflection::description::IValueList> __vwsnc4_Rpc_Collection_Nested_PropByref_rpcwrapper_RpcCollection__Nested__InByref__PropByref__IService__RpcCollection_Nested_InByref_PropByref_IRpcWrapper_IService::GetList()
	{
		...
		return ::vl::__vwsn::SharedPtrCast<::vl::reflection::description::IValueList>(::vl::rpc_controller::RpcUnboxByref(::vl::__vwsn::Unbox<::vl::rpc_controller::RpcObjectReference>(::vl::__vwsn::This(::vl::__vwsn::This(::vl::__vwsn::This(_lc)->GetDispatcher())->SendToClient_ObjectOps(_ref.clientId))->InvokeMethod(_ref, GLOBAL_NAME rpcmethod_RpcCollection__Nested__InByref__PropByref__IService_GetList, arguments)), _lc).Obj());
	}
