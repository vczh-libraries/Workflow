	...
	{
		{
			...
			if ((__vwsn_switch_7 == GLOBAL_NAME rpcmethod_RpcCollectionOblist__Interface__Nested__InByval__OutByval__IValue_GetValue))
			{
				auto target = ::vl::__vwsn::Ensure(::vl::__vwsn::SharedPtrCast<::RpcCollectionOblist::Interface::Nested::InByval::OutByval::IValue>(::vl::__vwsn::This(_lc)->RefToPtr(ref).Obj()));
				auto jsonNumber0 = ::vl::Ptr<::vl::glr::json::JsonNumber>(new ::vl::glr::json::JsonNumber());
			...
			else if ((__vwsn_switch_7 == GLOBAL_NAME rpcmethod_RpcCollectionOblist__Interface__Nested__InByval__OutByval__IService_DoList))
			{
				auto target = ::vl::__vwsn::Ensure(::vl::__vwsn::SharedPtrCast<::RpcCollectionOblist::Interface::Nested::InByval::OutByval::IService>(::vl::__vwsn::This(_lc)->RefToPtr(ref).Obj()));
