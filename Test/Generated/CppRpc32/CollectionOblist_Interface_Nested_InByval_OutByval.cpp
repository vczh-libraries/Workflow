...
***********************************************************************/
	...
	::vl::Ptr<::vl::reflection::description::IValueDictionary> __vwsnc11_Rpc_CollectionOblist_Interface_Nested_InByval_OutByval_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_CollectionOblist_Interface_Nested_InByval_OutByval::InvokeMethod_RpcCollectionOblist__Interface__Nested__InByval__OutByval__IService_DoList(::vl::rpc_controller::RpcObjectReference ref, ::vl::Ptr<::vl::reflection::description::IValueDictionary> arg_xs)
	{
		...
		auto jsonResult = ::vl::__vwsn::Unbox<::vl::Ptr<::vl::glr::json::JsonNode>>(::vl::__vwsn::This(::vl::__vwsn::This(::vl::__vwsn::This(_lc)->GetDispatcher())->SendToClient_ObjectOps(ref.clientId))->InvokeMethod(ref, GLOBAL_NAME rpcmethod_RpcCollectionOblist__Interface__Nested__InByval__OutByval__IService_DoList, arguments));
	...
	{
		{
			...
			else if ((__vwsn_switch_2 == GLOBAL_NAME rpcmethod_RpcCollectionOblist__Interface__Nested__InByval__OutByval__IService_DoList))
			{
				...
				return ::vl::rpc_controller::RpcBoxByval(::vl::Ptr<::vl::reflection::IDescriptable>(::vl::__vwsn::This(target.Obj())->DoList(::vl::__vwsn::Ensure(::vl::__vwsn::SharedPtrCast<::vl::reflection::description::IValueDictionary>(::vl::rpc_controller::RpcUnboxByval(::vl::__vwsn::Unbox<::vl::reflection::description::Value>(::vl::__vwsn::This(arguments.Obj())->Get(static_cast<::vl::vint32_t>(0))), _lc).Obj())))), _lc);
			}
			else
	...
	::vl::Ptr<::vl::reflection::description::IValueDictionary> __vwsnc5_Rpc_CollectionOblist_Interface_Nested_InByval_OutByval_rpcops_IOps_Create__rpcops_IOps_Rpc_CollectionOblist_Interface_Nested_InByval_OutByval::InvokeMethod_RpcCollectionOblist__Interface__Nested__InByval__OutByval__IService_DoList(::vl::rpc_controller::RpcObjectReference ref, ::vl::Ptr<::vl::reflection::description::IValueDictionary> arg_xs)
	{
		auto arguments = ::vl::reflection::description::IValueArray::Create();
		::vl::__vwsn::This(arguments.Obj())->Resize(static_cast<::vl::vint32_t>(1));
		::vl::__vwsn::This(arguments.Obj())->Set(static_cast<::vl::vint32_t>(0), ::vl::rpc_controller::RpcBoxByval(::vl::Ptr<::vl::reflection::IDescriptable>(arg_xs), _lc));
		return ::vl::__vwsn::Ensure(::vl::__vwsn::SharedPtrCast<::vl::reflection::description::IValueDictionary>(::vl::rpc_controller::RpcUnboxByval(::vl::__vwsn::This(::vl::__vwsn::This(::vl::__vwsn::This(_lc)->GetDispatcher())->SendToClient_ObjectOps(ref.clientId))->InvokeMethod(ref, GLOBAL_NAME rpcmethod_RpcCollectionOblist__Interface__Nested__InByval__OutByval__IService_DoList, arguments), _lc).Obj()));
	}
	...
	{
		{
			...
			else if ((__vwsn_switch_7 == GLOBAL_NAME rpcmethod_RpcCollectionOblist__Interface__Nested__InByval__OutByval__IService_DoList))
			{
				...
				auto jsonNode1 = GLOBAL_NAME rpcjson_Serialize(::vl::rpc_controller::RpcBoxByval(::vl::Ptr<::vl::reflection::IDescriptable>(::vl::__vwsn::This(target.Obj())->DoList(::vl::__vwsn::Ensure(::vl::__vwsn::SharedPtrCast<::vl::reflection::description::IValueDictionary>(::vl::rpc_controller::RpcUnboxByval(jsonValue0, _lc).Obj())))), _lc));
