...
***********************************************************************/
	...
	::vl::Ptr<::vl::reflection::description::IValueObservableList> __vwsnc4_Rpc_CollectionOblist_PropByref_rpcwrapper_RpcCollectionOblist__InByref__PropByref__IService__RpcCollectionOblist_InByref_PropByref_IRpcWrapper_IService::GetList()
	{
		...
		return ::vl::__vwsn::SharedPtrCast<::vl::reflection::description::IValueObservableList>(::vl::rpc_controller::RpcUnboxByref(::vl::__vwsn::Unbox<::vl::rpc_controller::RpcObjectReference>(::vl::__vwsn::This(::vl::__vwsn::This(::vl::__vwsn::This(_lc)->GetDispatcher())->SendToClient_ObjectOps(_ref.clientId))->InvokeMethod(_ref, GLOBAL_NAME rpcmethod_RpcCollectionOblist__InByref__PropByref__IService_GetList, arguments)), _lc).Obj());
	}
