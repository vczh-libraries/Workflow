...
***********************************************************************/
	...
	::vl::Ptr<::vl::glr::json::JsonNode> Rpc_CollectionOblist_PropByref::rpcjson_NewNull()
	{
	...
	::vl::glr::ParsingToken Rpc_CollectionOblist_PropByref::rpcjson_NewToken(const ::vl::WString& value)
	{
		return [&](){ ::vl::glr::ParsingToken __vwsn_temp__; __vwsn_temp__.value = value; return __vwsn_temp__; }();
	}

	::vl::Ptr<::vl::glr::json::JsonString> Rpc_CollectionOblist_PropByref::rpcjson_NewString(const ::vl::WString& content)
	{
	...
	::vl::Ptr<::vl::glr::json::JsonNumber> Rpc_CollectionOblist_PropByref::rpcjson_NewNumber(const ::vl::WString& content)
	{
	...
	::vl::Ptr<::vl::glr::json::JsonNode> Rpc_CollectionOblist_PropByref::rpcjson_NewArray2(const ::vl::WString& keyword, ::vl::Ptr<::vl::glr::json::JsonNode> value)
	{
	...
	void Rpc_CollectionOblist_PropByref::rpcjson_ObjectAdd(::vl::Ptr<::vl::glr::json::JsonObject> object, const ::vl::WString& name, ::vl::Ptr<::vl::glr::json::JsonNode> value)
	{
	...
	::vl::Ptr<::vl::glr::json::JsonObject> Rpc_CollectionOblist_PropByref::rpcjson_NewObject(const ::vl::WString& keyword)
	{
	...
	::vl::Ptr<::vl::glr::json::JsonNode> Rpc_CollectionOblist_PropByref::rpcjson_ObjectGet(::vl::Ptr<::vl::glr::json::JsonObject> object, const ::vl::WString& name)
	{
		{
	...
	::vl::Ptr<::vl::glr::json::JsonNode> Rpc_CollectionOblist_PropByref::rpcjson_SerializeCollection(const ::vl::WString& keyword, ::vl::Ptr<::vl::reflection::description::IValueEnumerable> values)
	{
	...
	::vl::Ptr<::vl::glr::json::JsonNode> Rpc_CollectionOblist_PropByref::rpcjson_SerializeMap(::vl::Ptr<::vl::reflection::description::IValueReadonlyDictionary> values)
	{
	...
	::vl::Ptr<::RpcCollectionOblist::InByref::PropByref::IRpcWrapper_IService> Rpc_CollectionOblist_PropByref::rpcwrapper_RpcCollectionOblist__InByref__PropByref__IService(::vl::rpc_controller::IRpcLifecycle* lc, ::vl::rpc_controller::RpcObjectReference proxyRef)
	{
		auto proxy = ::vl::Ptr<::RpcCollectionOblist::InByref::PropByref::IRpcWrapper_IService>(new ::vl_workflow_global::__vwsnc4_Rpc_CollectionOblist_PropByref_rpcwrapper_RpcCollectionOblist__InByref__PropByref__IService__RpcCollectionOblist_InByref_PropByref_IRpcWrapper_IService(lc, proxyRef));
	...
	::vl::Ptr<::vl::rpc_controller::IRpcWrapperBase> Rpc_CollectionOblist_PropByref::rpcwrapper_Create(::vl::rpc_controller::RpcObjectReference ref, ::vl::rpc_controller::IRpcLifecycle* lc)
	{
		{
			auto __vwsn_switch_6 = ref.typeId;
			if ((__vwsn_switch_6 == GLOBAL_NAME rpctype_RpcCollectionOblist__InByref__PropByref__IService))
			{
				return ::vl::Ptr<::vl::rpc_controller::IRpcWrapperBase>(GLOBAL_NAME rpcwrapper_RpcCollectionOblist__InByref__PropByref__IService(lc, ref));
			}
			else
...
***********************************************************************/
	...
	::vl::Ptr<::vl::reflection::description::IAsync> __vwsnc2_Rpc_CollectionOblist_PropByref_rpc_IRpcObjectOps__vl_rpc_controller_IRpcObjectOps::InvokeMethodAsync(::vl::rpc_controller::RpcObjectReference ref, ::vl::vint32_t methodId, ::vl::Ptr<::vl::reflection::description::IValueArray> arguments)
	{
	...
	void __vwsnc4_Rpc_CollectionOblist_PropByref_rpcwrapper_RpcCollectionOblist__InByref__PropByref__IService__RpcCollectionOblist_InByref_PropByref_IRpcWrapper_IService::DisconnectFromLifecycle()
	{
	...
	::vl::Ptr<::vl::reflection::description::IValueObservableList> __vwsnc4_Rpc_CollectionOblist_PropByref_rpcwrapper_RpcCollectionOblist__InByref__PropByref__IService__RpcCollectionOblist_InByref_PropByref_IRpcWrapper_IService::GetList()
	{
		if ((_lc == nullptr))
		...
		return ::vl::__vwsn::Unbox<::vl::Ptr<::vl::reflection::description::IValueObservableList>>(::vl::rpc_controller::RpcUnboxByref(::vl::__vwsn::This(::vl::__vwsn::This(::vl::__vwsn::This(_lc)->GetDispatcher())->SendToClient_ObjectOps(_ref.clientId))->InvokeMethod(_ref, GLOBAL_NAME rpcmethod_RpcCollectionOblist__InByref__PropByref__IService_GetList, arguments), _lc));
	}

	void __vwsnc4_Rpc_CollectionOblist_PropByref_rpcwrapper_RpcCollectionOblist__InByref__PropByref__IService__RpcCollectionOblist_InByref_PropByref_IRpcWrapper_IService::SetList(::vl::Ptr<::vl::reflection::description::IValueObservableList> __vwsn_value_)
	{
		if ((_lc == nullptr))
			throw ::vl::Exception(::vl::WString::Unmanaged(L"RPC wrapper has been disconnected from lifecycle."));
		auto arguments = ::vl::reflection::description::IValueArray::Create();
		...
		::vl::__vwsn::This(::vl::__vwsn::This(::vl::__vwsn::This(_lc)->GetDispatcher())->SendToClient_ObjectOps(_ref.clientId))->InvokeMethod(_ref, GLOBAL_NAME rpcmethod_RpcCollectionOblist__InByref__PropByref__IService_SetList, arguments);
	}
