...
***********************************************************************/
	...
	::vl::Ptr<::vl::glr::json::JsonNode> Rpc_CollectionDict_InByref_OutByval::rpcjson_NewNull()
	{
	...
	::vl::glr::ParsingToken Rpc_CollectionDict_InByref_OutByval::rpcjson_NewToken(const ::vl::WString& value)
	{
		return [&](){ ::vl::glr::ParsingToken __vwsn_temp__; __vwsn_temp__.value = value; return __vwsn_temp__; }();
	}

	::vl::Ptr<::vl::glr::json::JsonString> Rpc_CollectionDict_InByref_OutByval::rpcjson_NewString(const ::vl::WString& content)
	{
	...
	::vl::Ptr<::vl::glr::json::JsonNumber> Rpc_CollectionDict_InByref_OutByval::rpcjson_NewNumber(const ::vl::WString& content)
	{
	...
	::vl::Ptr<::vl::glr::json::JsonNode> Rpc_CollectionDict_InByref_OutByval::rpcjson_NewArray2(const ::vl::WString& keyword, ::vl::Ptr<::vl::glr::json::JsonNode> value)
	{
	...
	void Rpc_CollectionDict_InByref_OutByval::rpcjson_ObjectAdd(::vl::Ptr<::vl::glr::json::JsonObject> object, const ::vl::WString& name, ::vl::Ptr<::vl::glr::json::JsonNode> value)
	{
	...
	::vl::Ptr<::vl::glr::json::JsonObject> Rpc_CollectionDict_InByref_OutByval::rpcjson_NewObject(const ::vl::WString& keyword)
	{
	...
	::vl::Ptr<::vl::glr::json::JsonNode> Rpc_CollectionDict_InByref_OutByval::rpcjson_ObjectGet(::vl::Ptr<::vl::glr::json::JsonObject> object, const ::vl::WString& name)
	{
		{
	...
	::vl::Ptr<::vl::glr::json::JsonNode> Rpc_CollectionDict_InByref_OutByval::rpcjson_SerializeCollection(const ::vl::WString& keyword, ::vl::Ptr<::vl::reflection::description::IValueEnumerable> values)
	{
	...
	::vl::Ptr<::vl::glr::json::JsonNode> Rpc_CollectionDict_InByref_OutByval::rpcjson_SerializeMap(::vl::Ptr<::vl::reflection::description::IValueReadonlyDictionary> values)
	{
	...
	::vl::Ptr<::RpcCollectionDict::InByref::OutByval::IRpcWrapper_IService> Rpc_CollectionDict_InByref_OutByval::rpcwrapper_RpcCollectionDict__InByref__OutByval__IService(::vl::rpc_controller::IRpcLifecycle* lc, ::vl::rpc_controller::RpcObjectReference proxyRef)
	{
		auto proxy = ::vl::Ptr<::RpcCollectionDict::InByref::OutByval::IRpcWrapper_IService>(new ::vl_workflow_global::__vwsnc4_Rpc_CollectionDict_InByref_OutByval_rpcwrapper_RpcCollectionDict__InByref__OutByval__IService__RpcCollectionDict_InByref_OutByval_IRpcWrapper_IService(lc, proxyRef));
	...
	::vl::Ptr<::vl::rpc_controller::IRpcWrapperBase> Rpc_CollectionDict_InByref_OutByval::rpcwrapper_Create(::vl::rpc_controller::RpcObjectReference ref, ::vl::rpc_controller::IRpcLifecycle* lc)
	{
		{
			auto __vwsn_switch_6 = ref.typeId;
			if ((__vwsn_switch_6 == GLOBAL_NAME rpctype_RpcCollectionDict__InByref__OutByval__IService))
			{
				return ::vl::Ptr<::vl::rpc_controller::IRpcWrapperBase>(GLOBAL_NAME rpcwrapper_RpcCollectionDict__InByref__OutByval__IService(lc, ref));
			}
			else
...
***********************************************************************/
	...
	::vl::Ptr<::vl::reflection::description::IAsync> __vwsnc2_Rpc_CollectionDict_InByref_OutByval_rpc_IRpcObjectOps__vl_rpc_controller_IRpcObjectOps::InvokeMethodAsync(::vl::rpc_controller::RpcObjectReference ref, ::vl::vint32_t methodId, ::vl::Ptr<::vl::reflection::description::IValueArray> arguments)
	{
	...
	__vwsnc4_Rpc_CollectionDict_InByref_OutByval_rpcwrapper_RpcCollectionDict__InByref__OutByval__IService__RpcCollectionDict_InByref_OutByval_IRpcWrapper_IService::__vwsnc4_Rpc_CollectionDict_InByref_OutByval_rpcwrapper_RpcCollectionDict__InByref__OutByval__IService__RpcCollectionDict_InByref_OutByval_IRpcWrapper_IService(::vl::rpc_controller::IRpcLifecycle* __vwsnctor_lc, ::vl::rpc_controller::RpcObjectReference __vwsnctor_proxyRef)
	{
		this->_lc = __vwsnctor_lc;
		this->_ref = __vwsnctor_proxyRef;
	}

	void __vwsnc4_Rpc_CollectionDict_InByref_OutByval_rpcwrapper_RpcCollectionDict__InByref__OutByval__IService__RpcCollectionDict_InByref_OutByval_IRpcWrapper_IService::DisconnectFromLifecycle()
	{
	...
	::vl::Ptr<::vl::reflection::description::IValueDictionary> __vwsnc4_Rpc_CollectionDict_InByref_OutByval_rpcwrapper_RpcCollectionDict__InByref__OutByval__IService__RpcCollectionDict_InByref_OutByval_IRpcWrapper_IService::DoList(::vl::Ptr<::vl::reflection::description::IValueDictionary> xs)
	{
		if ((_lc == nullptr))
		...
		return ::vl::__vwsn::Unbox<::vl::Ptr<::vl::reflection::description::IValueDictionary>>(::vl::rpc_controller::RpcUnboxByval(::vl::__vwsn::This(::vl::__vwsn::This(::vl::__vwsn::This(_lc)->GetDispatcher())->SendToClient_ObjectOps(_ref.clientId))->InvokeMethod(_ref, GLOBAL_NAME rpcmethod_RpcCollectionDict__InByref__OutByval__IService_DoList, arguments), _lc));
	}
