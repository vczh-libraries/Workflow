...
***********************************************************************/
	...
	::vl::Ptr<::vl::reflection::description::IValueObservableList> __vwsnc4_Rpc_CollectionOblist_InByval_OutByval_rpcwrapper_RpcCollectionOblist__InByval__OutByval__IService__RpcCollectionOblist_InByval_OutByval_IRpcWrapper_IService::DoList(::vl::Ptr<::vl::reflection::description::IValueObservableList> xs)
	{
		...
		return ::vl::__vwsn::SharedPtrCast<::vl::reflection::description::IValueObservableList>(::vl::rpc_controller::RpcUnboxByval(::vl::__vwsn::This(::vl::__vwsn::This(::vl::__vwsn::This(_lc)->GetDispatcher())->SendToClient_ObjectOps(_ref.clientId))->InvokeMethod(_ref, GLOBAL_NAME rpcmethod_RpcCollectionOblist__InByval__OutByval__IService_DoList, arguments), _lc).Obj());
	}
