...
***********************************************************************/
	...
	::vl::WString __vwsnc5_Rpc_Collection_Interface_InByval_OutByval_rpcwrapper_RpcCollection__Interface__InByval__OutByval__IValue__RpcCollection_Interface_InByval_OutByval_IRpcWrapper_IValue::GetValue()
	{
		...
		return ::vl::__vwsn::Unbox<::vl::WString>(::vl::__vwsn::This(::vl::__vwsn::This(::vl::__vwsn::This(_lc)->GetDispatcher())->SendToClient_ObjectOps(_ref.clientId))->InvokeMethod(_ref, GLOBAL_NAME rpcmethod_RpcCollection__Interface__InByval__OutByval__IValue_GetValue, arguments));
	}
	...
	::vl::Ptr<::vl::reflection::description::IValueList> __vwsnc6_Rpc_Collection_Interface_InByval_OutByval_rpcwrapper_RpcCollection__Interface__InByval__OutByval__IService__RpcCollection_Interface_InByval_OutByval_IRpcWrapper_IService::DoList(::vl::Ptr<::vl::reflection::description::IValueList> xs)
	{
		...
		return ::vl::__vwsn::SharedPtrCast<::vl::reflection::description::IValueList>(::vl::rpc_controller::RpcUnboxByval(::vl::__vwsn::This(::vl::__vwsn::This(::vl::__vwsn::This(_lc)->GetDispatcher())->SendToClient_ObjectOps(_ref.clientId))->InvokeMethod(_ref, GLOBAL_NAME rpcmethod_RpcCollection__Interface__InByval__OutByval__IService_DoList, arguments), _lc).Obj());
	}
