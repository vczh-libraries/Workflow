...
***********************************************************************/
	...
	::vl::Ptr<::vl::reflection::description::IValueList> __vwsnc11_Rpc_Collection_Interface_InByval_OutByval_rpcops_IOps_CreateJson__rpcops_IOps_Rpc_Collection_Interface_InByval_OutByval::InvokeMethod_RpcCollection__Interface__InByval__OutByval__IService_DoList(::vl::rpc_controller::RpcObjectReference ref, ::vl::Ptr<::vl::reflection::description::IValueList> arg_xs)
	{
		...
		auto jsonResult = ::vl::__vwsn::Unbox<::vl::Ptr<::vl::glr::json::JsonNode>>(::vl::__vwsn::This(::vl::__vwsn::This(::vl::__vwsn::This(_lc)->GetDispatcher())->SendToClient_ObjectOps(ref.clientId))->InvokeMethod(ref, GLOBAL_NAME rpcmethod_RpcCollection__Interface__InByval__OutByval__IService_DoList, arguments));
	...
	::vl::Ptr<::vl::reflection::description::IValueList> __vwsnc5_Rpc_Collection_Interface_InByval_OutByval_rpcops_IOps_Create__rpcops_IOps_Rpc_Collection_Interface_InByval_OutByval::InvokeMethod_RpcCollection__Interface__InByval__OutByval__IService_DoList(::vl::rpc_controller::RpcObjectReference ref, ::vl::Ptr<::vl::reflection::description::IValueList> arg_xs)
	{
		...
		return ::vl::__vwsn::Ensure(::vl::__vwsn::SharedPtrCast<::vl::reflection::description::IValueList>(::vl::rpc_controller::RpcUnboxByval(::vl::__vwsn::This(::vl::__vwsn::This(::vl::__vwsn::This(_lc)->GetDispatcher())->SendToClient_ObjectOps(ref.clientId))->InvokeMethod(ref, GLOBAL_NAME rpcmethod_RpcCollection__Interface__InByval__OutByval__IService_DoList, arguments), _lc).Obj()));
	}
	...
	{
		{
			...
			else if ((__vwsn_switch_7 == GLOBAL_NAME rpcmethod_RpcCollection__Interface__InByval__OutByval__IService_DoList))
			{
				...
				auto jsonValue1 = ::vl::rpc_controller::RpcBoxByval(::vl::__vwsn::Box(::vl::__vwsn::This(target.Obj())->DoList(::vl::__vwsn::Ensure(::vl::__vwsn::SharedPtrCast<::vl::reflection::description::IValueList>(::vl::rpc_controller::RpcUnboxByval(jsonValue0, _lc).Obj())))), _lc);
