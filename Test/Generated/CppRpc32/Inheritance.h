...
namespace vl_workflow_global
{
	...
	public:
		...
		::vl::vint32_t rpcmethod_RpcInheritance__IDerived_GuardCrashAtClient = 0;
		::vl::vint32_t rpcmethod_RpcInheritance__IDerived_SetDerivedValue = 0;
		::vl::vint32_t rpctype_RpcInheritance__IOne = 0;
		::vl::vint32_t rpcevent_RpcInheritance__IOne_CrashAtServer = 0;
		...
		::vl::vint32_t rpcevent_RpcInheritance__ITwo_CrashAtClient = 0;
