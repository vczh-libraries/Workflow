...
***********************************************************************/
	...
	{
		return ::vl::reflection::description::GetLazyList<::vl::vint>(::vl::reflection::description::EnumerableCoroutine::Create(vl::Func(::vl_workflow_global::__vwsnf1_CoEnum2_GetNumbers_())));
	}
