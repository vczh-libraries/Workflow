...
namespace vl_workflow_global
{
	...
	public:
		...
		__vwsnc1_BindComplex_main__vl_reflection_description_IValueSubscription(::vl::Ptr<::test::ObservableValue> __vwsnctor_z, ::vl::Ptr<::test::ObservableValue> __vwsnctor_y, ::vl::Ptr<::test::ObservableValue> __vwsnctor_x);
	...
	public:
		...
		__vwsnc2_BindComplex_main_Subscribe__vl_reflection_description_IValueListener(::vl::reflection::description::IValueSubscription* __vwsnctor___vwsn_subscription_, ::vl::Ptr<::vl::reflection::description::IValueDictionary> __vwsnctor___vwsn_bind_listeners_, ::vl::reflection::description::IValueSubscription* __vwsnctorthis_0);
	...
	__vwsnc1_BindComplex_main__vl_reflection_description_IValueSubscription::__vwsnc1_BindComplex_main__vl_reflection_description_IValueSubscription(::vl::Ptr<::test::ObservableValue> __vwsnctor_z, ::vl::Ptr<::test::ObservableValue> __vwsnctor_y, ::vl::Ptr<::test::ObservableValue> __vwsnctor_x)
		:z(__vwsnctor_z)
		, y(__vwsnctor_y)
		, x(__vwsnctor_x)
	{
