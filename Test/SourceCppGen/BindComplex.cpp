...
namespace vl_workflow_global
{
	...
	{
		(::vl_workflow_global::BindComplex::Instance().s = ((((::vl::WString(L"", false) + ::vl_workflow_global::BindComplex::Instance().s) + ::vl::WString(L"[", false)) + static_cast<::vl::vint32_t>(::vl::reflection::description::UnboxValue<::vl::reflection::description::Value>(value))) + ::vl::WString(L"]", false)));
	}
	...
	::vl::WString BindComplex::main()
	{
		...
		::vl::Ptr<::vl::reflection::description::IValueSubscription> subscription = ::vl::Ptr<::vl::reflection::description::IValueSubscription>(new ::vl_workflow_global::__vwsnc1_BindComplex_main__vl_reflection_description_IValueSubscription(x, y, z));
		::vl::__vwsn::This(subscription)->Subscribe(::vl::Func<void(::vl::reflection::description::Value)>(&::vl_workflow_global::BindComplex::Instance(), &::vl_workflow_global::BindComplex::Callback));
	...
	{
		::vl::vint32_t __vwsn_bind_activator_result_ = [&](::vl::Ptr<::test::ObservableValue> _x){ return (::vl::__vwsn::This(_x)->GetValue() + [&](::vl::Ptr<::test::ObservableValue> _y){ return (::vl::__vwsn::This(_y)->GetValue() + [&](::vl::Ptr<::test::ObservableValue> _z){ return ::vl::__vwsn::This(_z)->GetValue(); }(__vwsn_bind_cache_1)); }(__vwsn_bind_cache_3)); }(__vwsn_bind_cache_2);
	...
	void __vwsnc1_BindComplex_main__vl_reflection_description_IValueSubscription::__vwsn_bind_callback_2_0(::vl::vint32_t __vwsn_bind_callback_argument_0, ::vl::vint32_t __vwsn_bind_callback_argument_1)
	{
		...
		(__vwsn_bind_cache_1 = ::vl::__vwsn::This(this)->z);
	...
	{
		(__vwsn_bind_cache_2 = ::vl::__vwsn::This(this)->x);
		(__vwsn_bind_cache_3 = ::vl::__vwsn::This(this)->y);
		(__vwsn_bind_cache_1 = ::vl::__vwsn::This(this)->z);
		(__vwsn_bind_handler_1_0 = ::vl::__vwsn::EventAttach(::vl::__vwsn::This(__vwsn_bind_cache_1)->ValueChanged, ::vl::Func<void(::vl::vint32_t, ::vl::vint32_t)>(::vl::__vwsn::This(this), &__vwsnc1_BindComplex_main__vl_reflection_description_IValueSubscription::__vwsn_bind_callback_1_0)));
	...
	::vl::Ptr<::vl::reflection::description::IValueListener> __vwsnc1_BindComplex_main__vl_reflection_description_IValueSubscription::Subscribe(const ::vl::Func<void(::vl::reflection::description::Value)>& callback)
	{
		...
		::vl::Ptr<::vl::reflection::description::IValueListener> __vwsn_listener_shared_ = ::vl::Ptr<::vl::reflection::description::IValueListener>(new ::vl_workflow_global::__vwsnc2_BindComplex_main_Subscribe__vl_reflection_description_IValueListener(__vwsn_bind_listeners_, __vwsn_subscription_, this));
