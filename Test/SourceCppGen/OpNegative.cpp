...
namespace vl_workflow_global
{
	::vl::WString OpNegative::main()
	{
				...
				return ((((((static_cast<::vl::vint8_t>((- i8)) + ::vl::WString(L", ", false)) + static_cast<::vl::vint16_t>((- i16))) + ::vl::WString(L", ", false)) + static_cast<::vl::vint32_t>((- i32))) + ::vl::WString(L", ", false)) + static_cast<::vl::vint64_t>((- i64)));
	}
