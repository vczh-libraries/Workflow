...
***********************************************************************/
	...
	::vl::WString OpNegative::main()
	{
		...
		return ((((((::vl::__vwsn::ToString((- i8)) + ::vl::WString::Unmanaged(L", ")) + ::vl::__vwsn::ToString((- i16))) + ::vl::WString::Unmanaged(L", ")) + ::vl::__vwsn::ToString((- i32))) + ::vl::WString::Unmanaged(L", ")) + ::vl::__vwsn::ToString((- i64)));
	}
