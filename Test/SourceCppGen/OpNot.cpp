...
***********************************************************************/
	...
	::vl::WString OpNot::main()
	{
		...
		return ((((((((((((((((::vl::__vwsn::ToString((! b)) + ::vl::WString::Unmanaged(L", ")) + ::vl::__vwsn::ToString(static_cast<::vl::vint8_t>(~ i8))) + ::vl::WString::Unmanaged(L", ")) + ::vl::__vwsn::ToString(static_cast<::vl::vint16_t>(~ i16))) + ::vl::WString::Unmanaged(L", ")) + ::vl::__vwsn::ToString((~ i32))) + ::vl::WString::Unmanaged(L", ")) + ::vl::__vwsn::ToString((~ i64))) + ::vl::WString::Unmanaged(L", ")) + ::vl::__vwsn::ToString(static_cast<::vl::vuint8_t>(~ u8))) + ::vl::WString::Unmanaged(L", ")) + ::vl::__vwsn::ToString(static_cast<::vl::vuint16_t>(~ u16))) + ::vl::WString::Unmanaged(L", ")) + ::vl::__vwsn::ToString((~ u32))) + ::vl::WString::Unmanaged(L", ")) + ::vl::__vwsn::ToString((~ u64)));
	}
