...
namespace vl_workflow_global
{
	...
	public:
		...
		__vwsnc1_BindSimple_main__vl_reflection_description_IValueSubscription(::vl::Ptr<::test::ObservableValue> _x, ::vl::Ptr<::test::ObservableValue> _z, ::vl::Ptr<::test::ObservableValue> _y);
	...
	public:
		...
		__vwsnc2_BindSimple_main_Subscribe__vl_reflection_description_IValueListener(::vl::reflection::description::IValueSubscription* ___vwsn_subscription_, ::vl::Ptr<::vl::reflection::description::IValueDictionary> ___vwsn_bind_listeners_);
	...
	__vwsnc1_BindSimple_main__vl_reflection_description_IValueSubscription::__vwsnc1_BindSimple_main__vl_reflection_description_IValueSubscription(::vl::Ptr<::test::ObservableValue> _x, ::vl::Ptr<::test::ObservableValue> _z, ::vl::Ptr<::test::ObservableValue> _y)
		:x(_x)
		, z(_z)
		, y(_y)
	{
	...
	void __vwsnc1_BindSimple_main__vl_reflection_description_IValueSubscription::__vwsn_bind_callback_3_0(::vl::vint32_t __vwsn_bind_callback_argument_0, ::vl::vint32_t __vwsn_bind_callback_argument_1)
	{
		throw 0;
	}
	...
	__vwsnc2_BindSimple_main_Subscribe__vl_reflection_description_IValueListener::__vwsnc2_BindSimple_main_Subscribe__vl_reflection_description_IValueListener(::vl::reflection::description::IValueSubscription* ___vwsn_subscription_, ::vl::Ptr<::vl::reflection::description::IValueDictionary> ___vwsn_bind_listeners_)
