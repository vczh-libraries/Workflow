...
namespace vl_workflow_global
{
	...
	{
		(::vl_workflow_global::BindSimple::Instance().s = ((((::vl::WString(L"", false) + ::vl_workflow_global::BindSimple::Instance().s) + ::vl::WString(L"[", false)) + ::vl::__vwsn::ToString(::vl::reflection::description::UnboxValue<::vl::vint32_t>(value))) + ::vl::WString(L"]", false)));
	}
	...
	{
		::vl::vint32_t __vwsn_bind_activator_result_ = ((::vl::__vwsn::This(__vwsn_bind_cache_0.Obj())->GetValue() + ::vl::__vwsn::This(__vwsn_bind_cache_1.Obj())->GetValue()) + ::vl::__vwsn::This(__vwsn_bind_cache_2.Obj())->GetValue());
