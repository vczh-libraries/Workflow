...
namespace vl_workflow_global
{
	...
	::vl::WString StaticMethod::main()
	{
		...
		return (((((([&](){ ::vl::WString __vwsn_temp__; ::vl::reflection::description::TypedValueSerializerProvider<::vl::vint32_t>::Serialize(::vl::__vwsn::This(o1.Obj())->GetValue(), __vwsn_temp__); return __vwsn_temp__; }() + ::vl::WString(L", ", false)) + ::vl::__vwsn::This(o1.Obj())->GetDisplayName()) + ::vl::WString(L", ", false)) + [&](){ ::vl::WString __vwsn_temp__; ::vl::reflection::description::TypedValueSerializerProvider<::vl::vint32_t>::Serialize(::vl::__vwsn::This(o2.Obj())->GetValue(), __vwsn_temp__); return __vwsn_temp__; }()) + ::vl::WString(L", ", false)) + ::vl::__vwsn::This(o2.Obj())->GetDisplayName());
	}
