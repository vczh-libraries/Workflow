...
namespace vl_workflow_global
{
	::vl::WString MapProcessing::main()
	{
		...
		::vl::__vwsn::This(xs)->Set(::vl::reflection::description::BoxValue<::vl::WString>(::vl::WString(L"f", false)), ::vl::reflection::description::BoxValue<::vl::vint32_t>(7));
