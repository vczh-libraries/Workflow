...
namespace vl_workflow_global
{
	...
	{
		(::vl_workflow_global::BindCustomInterface::Instance().s = ((((::vl::WString(L"", false) + ::vl_workflow_global::BindCustomInterface::Instance().s) + ::vl::WString(L"[", false)) + ::vl::__vwsn::ToString(::vl::reflection::description::UnboxValue<::vl::vint32_t>(value))) + ::vl::WString(L"]", false)));
	}
