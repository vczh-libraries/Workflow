...
namespace vl_workflow_global
{
	...
	{
		return ((((((((::vl::__vwsn::ToString(::vl_workflow_global::RecursiveFunction::Instance().Fib(1)) + ::vl::WString(L", ", false)) + ::vl::__vwsn::ToString(::vl_workflow_global::RecursiveFunction::Instance().Fib(2))) + ::vl::WString(L", ", false)) + ::vl::__vwsn::ToString(::vl_workflow_global::RecursiveFunction::Instance().Fib(3))) + ::vl::WString(L", ", false)) + ::vl::__vwsn::ToString(::vl_workflow_global::RecursiveFunction::Instance().Fib(4))) + ::vl::WString(L", ", false)) + ::vl::__vwsn::ToString(::vl_workflow_global::RecursiveFunction::Instance().Fib(5)));
	}
