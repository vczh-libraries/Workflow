...
***********************************************************************/
	...
	::vl::WString WorkflowHints::main()
	{
		...
		auto ct1 = [&]()->decltype(auto){ auto __vwsn_temp_x0 = ::vl::__vwsn::Box((::vl::__vwsn::CreateList().Add(static_cast<::vl::vint>(1)).Add(static_cast<::vl::vint>(2)).Add(static_cast<::vl::vint>(3)).Add(static_cast<::vl::vint>(4)).Add(static_cast<::vl::vint>(5))).list); ::vl::collections::List<::vl::vint> __vwsn_temp_0; ::vl::reflection::description::UnboxParameter(__vwsn_temp_x0, __vwsn_temp_0); return ::vl::__vwsn::This(hinters.Obj())->CountList(__vwsn_temp_0); }();
		auto ct2 = [&]()->decltype(auto){ auto __vwsn_temp_x0 = ::vl::__vwsn::Box((::vl::__vwsn::CreateArray().Resize(5).Set(0, static_cast<::vl::vint>(1)).Set(1, static_cast<::vl::vint>(2)).Set(2, static_cast<::vl::vint>(3)).Set(3, static_cast<::vl::vint>(4)).Set(4, static_cast<::vl::vint>(5))).list); ::vl::collections::Array<::vl::vint> __vwsn_temp_0; ::vl::reflection::description::UnboxParameter(__vwsn_temp_x0, __vwsn_temp_0); return ::vl::__vwsn::This(hinters.Obj())->CountArray(__vwsn_temp_0); }();
		auto ct3 = [&]()->decltype(auto){ auto __vwsn_temp_x0 = ::vl::__vwsn::Box(::vl::Ptr<::vl::reflection::description::IValueReadonlyList>((::vl::__vwsn::CreateList().Add(static_cast<::vl::vint>(1)).Add(static_cast<::vl::vint>(2)).Add(static_cast<::vl::vint>(3)).Add(static_cast<::vl::vint>(4)).Add(static_cast<::vl::vint>(5))).list)); ::vl::collections::SortedList<::vl::vint> __vwsn_temp_0; ::vl::reflection::description::UnboxParameter(__vwsn_temp_x0, __vwsn_temp_0); return ::vl::__vwsn::This(hinters.Obj())->CountSortedList(__vwsn_temp_0); }();
		auto ct4 = [&]()->decltype(auto){ auto __vwsn_temp_x0 = ::vl::__vwsn::Box((::vl::__vwsn::CreateObservableList().Add(static_cast<::vl::vint>(1)).Add(static_cast<::vl::vint>(2)).Add(static_cast<::vl::vint>(3)).Add(static_cast<::vl::vint>(4)).Add(static_cast<::vl::vint>(5))).list); ::vl::collections::ObservableList<::vl::vint> __vwsn_temp_0; ::vl::reflection::description::UnboxParameter(__vwsn_temp_x0, __vwsn_temp_0); return ::vl::__vwsn::This(hinters.Obj())->CountObservableList(__vwsn_temp_0); }();
		{
