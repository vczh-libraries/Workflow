...
namespace vl_workflow_global
{
	::vl::WString ListProcessing::main()
	{
		...
		::vl::WString s1 = (((([&](){ ::vl::WString __vwsn_temp__; ::vl::reflection::description::TypedValueSerializerProvider<::vl::vint32_t>::Serialize(::vl::__vwsn::This(xs)->GetCount(), __vwsn_temp__); return __vwsn_temp__; }() + ::vl::WString(L", ", false)) + [&](){ ::vl::WString __vwsn_temp__; ::vl::reflection::description::TypedValueSerializerProvider<::vl::vint32_t>::Serialize([&](){ ::vl::vint32_t __vwsn_temp__; ::vl::reflection::description::UnboxParameter<::vl::vint32_t>(::vl::__vwsn::This(xs)->Get(0), __vwsn_temp__); return __vwsn_temp__; }(), __vwsn_temp__); return __vwsn_temp__; }()) + ::vl::WString(L", ", false)) + [&](){ ::vl::WString __vwsn_temp__; ::vl::reflection::description::TypedValueSerializerProvider<::vl::vint32_t>::Serialize([&](){ ::vl::vint32_t __vwsn_temp__; ::vl::reflection::description::UnboxParameter<::vl::vint32_t>(::vl::__vwsn::This(xs)->Get(4), __vwsn_temp__); return __vwsn_temp__; }(), __vwsn_temp__); return __vwsn_temp__; }());
		::vl::__vwsn::This(xs)->Set(4, [&](){ ::vl::vint32_t __vwsn_temp__ = 6; return ::vl::reflection::description::BoxParameter<::vl::vint32_t>(__vwsn_temp__); }());
		::vl::__vwsn::This(xs)->Add(::vl::reflection::description::BoxValue<::vl::vint32_t>(7));
