...
namespace vl_workflow_global
{
	::vl::WString ListProcessing::main()
	{
		...
		::vl::WString s1 = ((((::vl::__vwsn::ToString(::vl::__vwsn::This(xs.Obj())->GetCount()) + ::vl::WString(L", ", false)) + ::vl::__vwsn::ToString([&](){ ::vl::vint32_t __vwsn_temp__; ::vl::reflection::description::UnboxParameter<::vl::vint32_t>(::vl::__vwsn::This(xs.Obj())->Get(0), __vwsn_temp__); return __vwsn_temp__; }())) + ::vl::WString(L", ", false)) + ::vl::__vwsn::ToString([&](){ ::vl::vint32_t __vwsn_temp__; ::vl::reflection::description::UnboxParameter<::vl::vint32_t>(::vl::__vwsn::This(xs.Obj())->Get(4), __vwsn_temp__); return __vwsn_temp__; }()));
