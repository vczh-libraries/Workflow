...
namespace vl_workflow_global
{
	::vl::WString Property::main()
	{
		...
		::vl::WString s1 = (((((((([&](){ ::vl::WString __vwsn_temp__; ::vl::reflection::description::TypedValueSerializerProvider<::vl::vint32_t>::Serialize(x.x, __vwsn_temp__); return __vwsn_temp__; }() + ::vl::WString(L", ", false)) + [&](){ ::vl::WString __vwsn_temp__; ::vl::reflection::description::TypedValueSerializerProvider<::vl::vint32_t>::Serialize(x.y, __vwsn_temp__); return __vwsn_temp__; }()) + ::vl::WString(L", ", false)) + [&](){ ::vl::WString __vwsn_temp__; ::vl::reflection::description::TypedValueSerializerProvider<::vl::vint32_t>::Serialize(::vl::__vwsn::This(y)->GetValue(), __vwsn_temp__); return __vwsn_temp__; }()) + ::vl::WString(L", ", false)) + ::vl::__vwsn::This(y)->GetName()) + ::vl::WString(L", ", false)) + ::vl::__vwsn::This(y)->GetDisplayName());
		::vl::__vwsn::This(y)->SetValue(20);
		::vl::__vwsn::This(y)->SetName(::vl::WString(L"Workflow", false));
		::vl::WString s2 = (((([&](){ ::vl::WString __vwsn_temp__; ::vl::reflection::description::TypedValueSerializerProvider<::vl::vint32_t>::Serialize(::vl::__vwsn::This(y)->GetValue(), __vwsn_temp__); return __vwsn_temp__; }() + ::vl::WString(L", ", false)) + ::vl::__vwsn::This(y)->GetName()) + ::vl::WString(L", ", false)) + ::vl::__vwsn::This(y)->GetDisplayName());
