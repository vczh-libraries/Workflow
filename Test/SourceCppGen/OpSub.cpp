...
#endif
#define GLOBAL_SYMBOL ::vl_workflow_global::OpSub::
#define GLOBAL_NAME ::vl_workflow_global::OpSub::Instance().
#define GLOBAL_OBJ &::vl_workflow_global::OpSub::Instance()
...
BEGIN_GLOBAL_STORAGE_CLASS(vl_workflow_global_OpSub)
	vl_workflow_global::OpSub instance;
	INITIALIZE_GLOBAL_STORAGE_CLASS
	FINALIZE_GLOBAL_STORAGE_CLASS
END_GLOBAL_STORAGE_CLASS(vl_workflow_global_OpSub)
