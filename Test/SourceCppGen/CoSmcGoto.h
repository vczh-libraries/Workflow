...
#ifndef VCZH_WORKFLOW_COMPILER_GENERATED_COSMCGOTO
#define VCZH_WORKFLOW_COMPILER_GENERATED_COSMCGOTO
...
{
	class __vwsnc1_CoSmcGoto_SMGoto___vwsn_state_CreateCoroutine__vl_reflection_description_ICoroutine;
}
...
***********************************************************************/
	...
	class __vwsnc1_CoSmcGoto_SMGoto___vwsn_state_CreateCoroutine__vl_reflection_description_ICoroutine : public ::vl::Object, public virtual ::vl::reflection::description::ICoroutine
	{
	public:
		::vl::Ptr<::vl::reflection::description::ICoroutine> __vwsn_state_previousCoroutine;
		::vl::vint __vwsn_state_startState;
		::SMGoto* __vwsn_state_stateMachineObject;
		::SMGoto* __vwsnthis_0;

		__vwsnc1_CoSmcGoto_SMGoto___vwsn_state_CreateCoroutine__vl_reflection_description_ICoroutine(::vl::Ptr<::vl::reflection::description::ICoroutine> __vwsnctor___vwsn_state_previousCoroutine, ::vl::vint __vwsnctor___vwsn_state_startState, ::SMGoto* __vwsnctor___vwsn_state_stateMachineObject, ::SMGoto* __vwsnctorthis_0);
