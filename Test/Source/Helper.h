...
extern WString				GetCppOutputPathRpc();
extern WString				GetCppOutputPath32Rpc();
extern WString				GetCppOutputPath64Rpc();
extern WString				GetCppMergePathRpc();
extern WString				GetAppOutputPath(const WString& appName);
extern WString				GetAppOutputPath32(const WString& appName);
extern WString				GetAppOutputPath64(const WString& appName);
extern WString				GetAppMergePath(const WString& appName);
extern WString				GetWorkflowOutputPath();
extern WString				GetWorkflowOutputPath32();
extern WString				GetWorkflowOutputPath64();
extern WString				GetRpcMetadataOutputPath();
extern WString				GetRpcMetadataOutputPath32();
extern WString				GetRpcMetadataOutputPath64();
